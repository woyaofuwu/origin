...
public class CrmDes {
	 ...
	 * @return
	 */
	public static String encryPasswd(String passwd, String serNum){
		if(StringUtils.isBlank(passwd)) return "";
		if(StringUtils.isBlank(serNum)) serNum = "123456";
		return CrmDes.strEnc(passwd, serNum, "", "");
	}
	 ...
	 * @return
	 */
	public static String decryPasswd(String passwd, String serNum){
		if(StringUtils.isBlank(passwd)) return "";
		if(StringUtils.isBlank(serNum)) serNum = "123456";
		return CrmDes.strDec(passwd, serNum, "", "");
	}
	...
	public static void main(String[] args) {
		...
		String key3 = "";
		String data = "admin";
		String str = CrmDes.strEnc(data, key1, key2, key3);
		String dec = CrmDes.strDec(str, key1, key2, key3);
	}
