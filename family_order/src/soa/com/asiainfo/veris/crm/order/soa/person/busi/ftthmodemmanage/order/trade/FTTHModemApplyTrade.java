 ...
 */
public class FTTHModemApplyTrade extends BaseTrade implements ITrade
{
	String deposit="";//押金
    public void createBusiTradeData(BusiTradeData btd) throws Exception
    { 
    	FTTHModemApplyReqData rd = (FTTHModemApplyReqData) btd.getRD();
     ...
     * @throws Exception
     */
    private void createOtherTradeInfo(BusiTradeData btd,FTTHModemApplyReqData rd) throws Exception
    {
        String serialNumber = btd.getRD().getUca().getUser().getSerialNumber();
