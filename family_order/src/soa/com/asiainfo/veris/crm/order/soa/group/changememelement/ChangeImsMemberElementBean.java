...
public class ChangeImsMemberElementBean extends GroupOrderBaseBean {
        ...
        if ("1".equals(flag)) {
        	...
        	if(StringUtils.isNotEmpty(changflag)){
        		if(onceDiscnt){	
            		...
            		param.put("ATTR_VALUE", inter.getString("pam_NOTIN_INSTALLATION_COST", ""));
            		...
            		if(Double.parseDouble(startDate) == Double.parseDouble(inserttimee)){
            			Double onceOld = Double.parseDouble(lineInfo.getString(DataLineDiscntConst.cost,"")); 
                        Double onceNew = Double.parseDouble(inter.getString("pam_NOTIN_INSTALLATION_COST", ""));
            			...
            			String  onceOld  = lineInfo.getString(DataLineDiscntConst.cost,"");
                        String  onceNew =  inter.getString("pam_NOTIN_INSTALLATION_COST", "");
                        IDataset elementInfo =  new DatasetList();
                		IData element = new DataMap();
                		element.put("ELEMENT_ID", DataLineDiscntConst.ONCEElementId);
                		element.put("MODIFY_TAG", "0");
