...
public class ChangeGprsAppCardUserElement extends ChangeUserElement
{

    public ChangeGprsAppCardUserElement()
    {
    ...
    public IData getTradeUserExtendData() throws Exception
    {
        ...
        {
            userExtenData.put("RSRV_STR4", productParams.getString("NOTIN_APN_TYPE"));
