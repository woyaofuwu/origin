...
public class Destroy800GroupUser extends DestroyGroupUser
{
    ...
    public void infoRegDataSvcState() throws Exception
    {
        ...
        if (IDataUtil.isNotEmpty(svcDatas))
        {
            for (int j = 0; j < svcDatas.size(); j++)
            {
                ...
                IDataset results = UserSvcStateInfoQry.getUserLastStateByUserSvc(user_id, service_id);// UserSvcStateQry.getUserLastStateByUserSvc(pd,
                // inparams,
                // null);
