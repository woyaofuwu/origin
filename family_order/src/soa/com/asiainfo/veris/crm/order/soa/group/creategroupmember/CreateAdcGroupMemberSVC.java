...
public class CreateAdcGroupMemberSVC extends GroupOrderService
{
    ...
    public final IDataset crtOrder(IData map) throws Exception
    {
        ...
        CreateAdcGroupMemberBean bean = new CreateAdcGroupMemberBean();

        // 规则校验传入参数
        map.put("RULE_BIZ_TYPE_CODE", "chkBeforeForGrp");
        map.put("RULE_BIZ_KIND_CODE", "GrpMebOrder");
