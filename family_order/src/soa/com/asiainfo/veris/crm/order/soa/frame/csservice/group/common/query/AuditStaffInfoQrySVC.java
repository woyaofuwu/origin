...
public class AuditStaffInfoQrySVC extends CSBizService
{
    ...
    public IDataset checkVpmnRight(IData inparam) throws Exception
    {
        ...
        return AuditStaffInfoQry.checkVpmnRight(staffId, userProdCode, rightCode);
    }
    ...
    public IDataset checkVpmnRightAll(IData inparam) throws Exception
    {
        ...
        return AuditStaffInfoQry.checkVpmnRightAll(staffId, userProdCode, rightCode, startDate);
    }
    ...
    {
        return AuditStaffInfoQry.insertVpnRight(inparam);
    }
    ...
    public IDataset qryVpmnCustMgrStaffList(IData inparam) throws Exception
    {
        ...
        String userProdCode = inparam.getString("USER_PRODUCT_CODE");
        return AuditStaffInfoQry.qryVpmnCustMgrStaffList(custMgrId, userProdCode, this.getPagination());
    }
    ...
    public IDataset qryVpmnDisInfo(IData inparam) throws Exception
    {
        ...
        return AuditStaffInfoQry.qryVpmnDisInfo(importId, dealState, impFileName, impType, startDate, endDate, this.getPagination());
    }
    ...
    public IDataset qryVpmnGroupInfo(IData inparam) throws Exception
    {
        ...
        return AuditStaffInfoQry.qryVpmnGroupInfo(groupId, vpnNo, vpnName, cityCode, this.getPagination());
    }
    ...
    public IDataset qryVpmnStaffList(IData inparam) throws Exception
    {
        String staffId = inparam.getString("STAFF_ID");
        String userProdCode = inparam.getString("USER_PRODUCT_CODE");
        return AuditStaffInfoQry.qryVpmnStaffList(staffId, userProdCode, this.getPagination());
    }
    ...
    public IDataset queryThisVpmnManagerInfo(IData inparam) throws Exception
    {
        String importId = inparam.getString("IMPORT_ID");
        String dealState = inparam.getString("DEAL_STATE");
        return AuditStaffInfoQry.queryThisVpmnManagerInfo(importId, dealState, this.getPagination());
    }
    ...
    {
        String vpnNo = inparam.getString("VPN_NO");
        return AuditStaffInfoQry.queryVpmnCityCode(vpnNo);
    }
    ...
    {
        return AuditStaffInfoQry.updateVpnInfo(inparam);
    }
    ...
    {
        return AuditStaffInfoQry.updVpnRight(inparam);
    }
     ...
     * @date 2018-7-10
     */
    public IDataset qryAuditStaffInfo(IData input) throws Exception {
    	 return AuditStaffInfoQry.qryAuditStaffInfo(input,this.getPagination());
    }
}
