...
/**
 * 功能：执行帐户变更查询的导出 作者：GongGuang
 */
public class ExportQueryAccountChgInfo extends ExportTaskExecutor
{
    @Override
    public IDataset executeExport(IData paramIData, Pagination paramPagination) throws Exception
    {
        ...
        IDataset res = CSAppCall.call("SS.QueryAccountChgInfoSVC.queryAccountChgInfo", data);
        return res;
    }
}
