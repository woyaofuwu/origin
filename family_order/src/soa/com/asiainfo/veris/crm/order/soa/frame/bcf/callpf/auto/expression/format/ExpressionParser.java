...
public class ExpressionParser
{
     ...
     * @throws Exception
     */
    public ExpressionToken changeToToken(ExpressionToken previousToken, Element ele) throws Exception
    {
        if (ele == null)
        {
        ...
        {
            java.util.Date date = SysDateMgr.string2Date(ele.getText(), SysDateMgr.PATTERN_STAND);
            token = ExpressionToken.createConstantToken(DataType.DATATYPE_DATE, date);
        }
    ...
    public List<ExpressionToken> getExpressionTokens(String expression) throws Exception
    {
