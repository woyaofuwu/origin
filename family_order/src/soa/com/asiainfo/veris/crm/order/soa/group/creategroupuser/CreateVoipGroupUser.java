...
public class CreateVoipGroupUser extends CreateGroupUser {

    protected CreateInternetGroupUserReqData reqData = null;

    public CreateVoipGroupUser() {
    ...
    private void actTradeDataline() throws Exception {
        ...
        if(dataline!=null&&!dataline.getString("REPEATERNUM","").equals("")) {//中继数
            dataline.put("RSRV_NUM3", dataline.getString("REPEATERNUM", ""));
        }
        if(dataline!=null&&!dataline.getString("TRANSFERMODE","").equals("")) {//传输接入方式
    ...
    public void regOtherInfoTrade() throws Exception {
        ...
        if(null != internet && internet.size() > 0) {
            ...
            //语音通信费（元/分钟）
            data.put("RSRV_STR22", internet.getString("pam_NOTIN_VOICE"));
    ...
    protected void makUca(IData map) throws Exception {
        ...
        UcaData uca = UcaDataFactory.getNormalUca(sn);
        		//UcaDataFactory.getNormalUcaByCustIdForGrp(map);
