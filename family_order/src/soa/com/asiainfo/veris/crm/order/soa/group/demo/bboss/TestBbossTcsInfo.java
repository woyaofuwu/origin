...
public class TestBbossTcsInfo extends BizProcess
{
    private static final Logger logger = Logger.getLogger(TestBbossTcsInfo.class);
     ...
     */
    // 
    private static String faceName = "CS.TcsGrpIntfSVC.dealBbossMemBiz";
    //CS.TcsGrpIntfSVC.getOrderInfo
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        TestBbossTcsInfo process = new TestBbossTcsInfo();
