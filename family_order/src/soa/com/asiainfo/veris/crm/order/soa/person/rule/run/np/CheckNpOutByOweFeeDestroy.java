...
public class CheckNpOutByOweFeeDestroy extends BreBase implements IBREScript
{
    ...
    public boolean run(IData dataBus, BreRuleParam paramBreRuleParam) throws Exception
    {
        ...
        IDataset userInfos = UserInfoQry.getUserInfoByMoveTagUserCodeSet(userId, "Y", "7", "90");
