...
public class CreateBBossMemberTrade extends CreateGroupMember
{
    /**
...
//        }
    ...
    public void actTradeSub() throws Exception
    {
        ...
        {
            // 登记BBOSS侧成员产品信息
            infoRegDataEntireMerchMeb(reqData.getBbossProductInfo());
    ...
    {
        IDataset merchPDatas = UserGrpMerchpInfoQry.qryMerchpInfoByUserIdMerchSpecProductSpecStatus(reqData.getGrpUca().getUser().getUserId(), null, null, null, null);
    ...
    protected void infoRegDataEntireMerchMeb(IData productInfo) throws Exception
    {
        ...
        merchMebInfo.put("MODIFY_TAG", TRADE_MODIFY_TAG.Add.getValue());
...
//        }
    ...
    protected void setTradeBase() throws Exception
    {
        ...
        else if ("6".equals(CSBizBean.getVisit().getInModeCode()) && !BbossDcrossFusionBizDealBean.isBbossDcrossBizSendPF(specProductId))
    ...
    public void infoRegOtherData() throws Exception{
    	// 创建ENUM用户报文
    	 setRegTradeOther("8173", "01", TRADE_MODIFY_TAG.Add.getValue(), "ENUM", "创建ENUM用户"); 
    }
