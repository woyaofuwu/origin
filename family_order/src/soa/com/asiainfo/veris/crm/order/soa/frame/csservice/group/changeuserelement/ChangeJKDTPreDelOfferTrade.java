...
public class ChangeJKDTPreDelOfferTrade extends ChangeUserElement {
    ...
    public void infoRegDataEntireMerch(String merchOperType) throws Exception {
        ...
        IData epData = GrpCommonBean.actEcrecepProcedure(reqData.getUca().getUser().getUserId(), SeqMgr.getInstId(), reqData.getUca().getUser().getSerialNumber(), merchInfo.getString("MERCH_ORDER_ID"), merchInfo.getString("MERCH_OFFER_ID", ""), merchOperType, "D", "D");
