...
public abstract class ActualMebWorkOrderThread extends Thread
{
	...
	public ActualMebWorkOrderThread(IData param, BizVisit visit,Object service) {
    ...
    public void run() {
    	  ...
    	  try {
    	    ...
    	    // 循环处理多个成员服务号码
            IDataset singleSerialNumberList = GrpIntf.dealserialNumberList(param);
     ...
     * @date 2013-10-11
     */
    private void dealMemInfo(IData inparam) throws Exception {
        ...
        String receptionHallMem = inparam.getString("RECEPTIONHALLMEM");//集客大厅受理标记 如果为集客大厅受理则查集客大厅表
        ...
        if (StringUtils.isNotBlank(receptionHallMem)) {
            ...
            idataOutput = ServiceFactory.call(url, "CS.UserGrpMerchpInfoQrySVC.qryMerchpInfoByProductOfferId", idataInput, null, false, true);
            userProductInfoList = idataOutput.getData();
        }
