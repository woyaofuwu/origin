...
public class BatGlobalMASBlackWhiteTrans implements ITrans
{
     ...
     * 批量全网MAS个人用户订购,MEMBERMASORDER;-->AllMASGrpMemBatBiz("MEMBERMASORDER"), //批量全网MAS个人用户订购PRODUCT_ID=9127(MAS移动OA考核版)
     * 
     * @param batData
     */
    public void InitialDataSub(IData batData) throws Exception
    {
        ...
        for (int i = 0; i < selectedElementslist.size(); i++)
        {
            ...
            if ("S".equals(elementTypeCode) && StringUtils.isNotBlank(attrParam)) // 校讯通异网用户付费号码专用套餐
            {// 网外号码用
