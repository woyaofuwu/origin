...
import com.asiainfo.veris.crm.order.soa.frame.csservice.group.destroygroupmember.DestroyAdcXxtGroupMemberReqData;

/**
 * 处理ADC校讯通成员新增信息
 */
public class DestroyAdcXxtGroupMemberBean extends MemberBean
{
    protected DestroyAdcXxtGroupMemberReqData reqData = null;

    public DestroyAdcXxtGroupMemberBean()
    {
    ...
    {
        return new DestroyAdcXxtGroupMemberReqData();
    }
    ...
    protected void initReqData() throws Exception
    {
        ...
        reqData = (DestroyAdcXxtGroupMemberReqData) getBaseReqData();
    }
    ...
    public void regTradeOutSnBlackWhite() throws Exception
    {
        ...
        data.put("USER_ID", data.getString("OUT_USER_ID")); // 用户标识
        data.put("SERIAL_NUMBER", data.getString("OUT_SN")); // 服务号码
