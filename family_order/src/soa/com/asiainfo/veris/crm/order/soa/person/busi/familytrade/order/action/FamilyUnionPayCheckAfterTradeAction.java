...
/**
 * @CREATED by gongp@2014-8-21 修改历史 Revision 2014-8-21 下午08:33:21
 */
public class FamilyUnionPayCheckAfterTradeAction implements ITradeAction
{
    ...
    public void executeAction(BusiTradeData btd) throws Exception
    {
        ...
        try
        {
            ...
            for (int i = 0, size = list.size(); i < size; i++)
            {
                ...
                member.put("RELATION_TYPE_CODE", "56");
                members.add(member);
            }
        ...
        catch (Exception e)
        {
            ...
            // common.error("14221001", "本次办理统一付费业务的成员已办理该业务，请耐心等待工单完工！");
            CSAppException.apperr(CrmCommException.CRM_COMM_103, "14221001:本次办理统一付费业务的成员已办理该业务，请耐心等待工单完工！");
        }
    }
