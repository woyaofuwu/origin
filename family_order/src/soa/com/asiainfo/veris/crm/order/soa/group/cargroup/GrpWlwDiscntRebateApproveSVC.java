...
public class GrpWlwDiscntRebateApproveSVC extends CSBizService
{
	private static final Logger logger = Logger.getLogger(GrpWlwDiscntRebateApproveSVC.class);
     ...
     * @throws Exception
     */
    public IDataset queryRebateApproveInfo(IData input) throws Exception
    {
        return  GrpWlwDiscntRebateApproveBean.queryRebateApproveInfo(input,getPagination());
    }
     ...
     * @throws Exception
     */
    public IData addCarGroupRateApprove(IData input) throws Exception
    {
    	GrpWlwDiscntRebateApproveBean bean = BeanManager.createBean(GrpWlwDiscntRebateApproveBean.class);
		boolean flag = bean.addCarGroupRateApprove(input);
    ...
    public int updateRslt(IData Rslt) throws Exception
    {
    	...
    	String oprSeq = Rslt.getString("OPR_SEQ","");
    	if(StringUtils.isBlank(oprSeq))
    	{
    		CSAppException.apperr(CrmCommException.CRM_COMM_103, "反馈流水号为空!");
    	}
     ...
     * @throws Exception
     */
    public IDataset queryRebateDetailsByOprSeq(IData input) throws Exception
    {
        return  GrpWlwDiscntRebateApproveBean.queryRebateDetailsByOprSeq(input,getPagination());
    }
