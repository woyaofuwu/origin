...
public class DaidaGrpDelBean extends MemberBean
{
    boolean ifCentrex = false; // 是否融合网

    protected DaidaGrpDelBeanReqData reqData = null;
    ...
    {
        return new DaidaGrpDelBeanReqData();
    }
    ...
    public void infoRegDataRelation() throws Exception
    {
        ...
        String user_id_b = reqData.getUca().getUserId(); // 代答组userId

        IDataset relationUUs = RelaUUInfoQry.qryUU(user_id_a, user_id_b, "DD", null);
    ...
    protected void initReqData() throws Exception
    {
        ...
        reqData = (DaidaGrpDelBeanReqData) getBaseReqData();
    }
    ...
    {
        String closeSn = map.getString("SERIAL_NUMBER_B"); // 代答组user_id
        String closeUserId = map.getString("USER_ID_B"); // 代答组sn
