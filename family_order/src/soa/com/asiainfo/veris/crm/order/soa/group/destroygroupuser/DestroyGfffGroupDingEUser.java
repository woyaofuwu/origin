 ...
 * @author 
 */
public class DestroyGfffGroupDingEUser extends DestroyGroupUser
{
    public DestroyGfffGroupDingEUser()
    {
...
//                        "73430004".equals(userDiscntData.getString("PACKAGE_ID"))
//                        && "994513".equals(userDiscntData.getString("ELEMENT_ID"))
...
//    }
    ...
    protected void setTradeDiscnt(IData map) throws Exception
    {
    	...
    	if ("994513".equals(map.getString("DISCNT_CODE")) && TRADE_MODIFY_TAG.DEL.getValue().equals(map.getString("MODIFY_TAG"))){ // 优惠
    ...
    {
    	if ("00099002".equals(map.getString("ATTR_CODE")) &&
