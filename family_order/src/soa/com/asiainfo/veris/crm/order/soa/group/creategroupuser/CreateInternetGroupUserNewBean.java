...
public class CreateInternetGroupUserNewBean extends GroupOrderBaseBean {
        ...
        if(null != dataline && dataline.size() > 0) {
            for (int j = 0; j < dataline.size(); j++) {
                ...
                if(numberCode.equals(lineNumberCode)) {
                    ...
                    //IDataset elementParam = DatalineEspUtil.saveProductParamInfoFrontData(DatalineEspUtil.getCommInfo(ibsysId));
                    //map.put("PRODUCT_PARAM", elementParam);
