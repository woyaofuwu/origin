...
public class ChangeBBossMerchUserTrade extends ChangeUserElement
{
    ...
    protected IDataset getMerchDsn() throws Exception
    {
        ...
        for (int i = 0; i < merchDiscnts.size(); i++)
        {
            ...
            {
                // 3-2-1 添加商品操作类型
                String merchSpecCode = GrpCommonBean.productToMerch(reqData.getUca().getProductId(), 0);
                ...
                String planId = GrpCommonBean.productToMerch(packageId, 1);
            ...
            else if (TRADE_MODIFY_TAG.DEL.getValue().equals(modifyTag))
            {
                ...
                String merchDiscntCode = GrpCommonBean.productToMerch(elementId, 1);// BBOSS产品优惠编码
    ...
    public void infoRegDataEntireMerch(String merchOperType) throws Exception
    {
        ...
        // 登记BBOSS侧商品表信息
        super.addTradeGrpMerch(IDataUtil.idToIds(merchInfo));
