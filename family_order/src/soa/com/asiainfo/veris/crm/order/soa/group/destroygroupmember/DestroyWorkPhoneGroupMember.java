...
public class DestroyWorkPhoneGroupMember extends DestroyGroupMember
{
    protected DestroyWorkPhoneGroupMemberReqData reqData = null;

    @Override
    protected BaseReqData getReqData() throws Exception
    {
        return new DestroyWorkPhoneGroupMemberReqData();
    }
    ...
    {
        super.initReqData();
        reqData = (DestroyWorkPhoneGroupMemberReqData) getBaseReqData();
    }
