...
public class GetRuleListByElement extends AbstractIGETRuleListRuleList
{
    private static final Logger logger = Logger.getLogger(GetRuleListByElement.class);
    ...
    public IDataset getRuleFlow(IData param) throws Exception
    {
        ...
        {
            listAllRule = Dao.qryByCode("TD_S_CPARAM", "SEL_RULE_ELEMENT", param, Route.CONN_CRM_CEN);
        }
        else
    ...
    public void orgDataBus(IData databus, String strRuleTwigCode, IData param)
    {
        ...
        if ("110".equals(strTradeTypeCode) && "TradeCheckAfter".equals(databus.getString("RULE_BIZ_TYPE_CODE")))
        {
