...
public final class BreBizLog extends LogBaseBean
{
    ...
    {
        if (LogUtil.isEnable(LogBaseBean.LOG_TYPE_BRE_BIZ))
        {
    ...
    public final static void log(IData databus, String subKey, long lStartTime) throws Exception
    {
        ...
        // 是否超过监控值
        boolean bLog = LogUtil.isThresholdEnable(LogBaseBean.LOG_TYPE_BRE_BIZ, lCostTime);
        ...
        sendLog(LOG_TYPE_BRE_BIZ, sbKey.toString(), lStartTime, lCostTime, sb);
    }
}
