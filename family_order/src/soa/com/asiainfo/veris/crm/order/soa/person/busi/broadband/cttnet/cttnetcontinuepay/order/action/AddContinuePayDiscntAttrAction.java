...
package com.asiainfo.veris.crm.order.soa.person.busi.broadband.cttnet.cttnetcontinuepay.order.action;
...
/**
 */
public class AddContinuePayDiscntAttrAction implements ITradeAction
{

    public void executeAction(BusiTradeData btd) throws Exception
    {
    	CttBroadBandContinuePayReqData cttBroadbandContinuePayRD = (CttBroadBandContinuePayReqData) btd.getRD();
        UserTradeData userData = cttBroadbandContinuePayRD.getUca().getUser();
        ...
        if(StringUtils.equals("9712", tradeTypeCode)){
