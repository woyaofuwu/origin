package com.asiainfo.veris.crm.order.soa.person.busi.createhytusertrade.order.requestdata;

import com.asiainfo.veris.crm.order.soa.person.busi.createusertrade.order.requestdata.CreateUserRequestData;

public class CreateHYTPersonUserRequestData extends CreateUserRequestData {
	...
	private String discntName;//优惠名称
	/**
