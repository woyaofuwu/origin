 ...
 * 
 * @ClassName: GetRuleListBySaleActive
 * @Description: 活动规则获取实现
 * @version: v1.0.0
 * @author: xiaocl
 */
public class GetRuleListBySaleActive extends AbstractIGETRuleListRuleList
{
    private static final Logger logger = Logger.getLogger(GetRuleListBySaleActive.class);
    ...
    public IDataset getRuleFlow(IData param) throws Exception
    {
        ...
        {
            listAllRule = Dao.qryByCode("TD_S_CPARAM", "SEL_RULE_SALEACTIVE", param, Route.CONN_CRM_CEN);
        }
        else
        ...
        for (Iterator iterator = listAllRule.iterator(); iterator.hasNext();)
        {
            ...
            /* 先判断产品和品牌 */
            /*
             * strRuleProductId = bizrule.getString("PRODUCT_ID"); strRuleBrandCode = bizrule.getString("BRAND_CODE");
    ...
    public void orgDataBus(IData databus, String strRuleTwigCode, IData param)
    {
        ...
        param.put("PACKAGE_ID", databus.getString("PACKAGE_ID"));
