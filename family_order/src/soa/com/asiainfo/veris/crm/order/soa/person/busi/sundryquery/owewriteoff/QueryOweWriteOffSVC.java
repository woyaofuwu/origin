...
public class QueryOweWriteOffSVC extends CSBizService
{
    ...
    public IDataset queryArea(IData param) throws Exception
    {
        ...
        QueryOweWriteOffBean bean = BeanManager.createBean(QueryOweWriteOffBean.class);
     ...
     */
    public IDataset queryOweWriteOff(IData data) throws Exception
    {
        QueryOweWriteOffBean bean = (QueryOweWriteOffBean) BeanManager.createBean(QueryOweWriteOffBean.class);
        return bean.queryOweWriteOff(data, getPagination());
    }
}
