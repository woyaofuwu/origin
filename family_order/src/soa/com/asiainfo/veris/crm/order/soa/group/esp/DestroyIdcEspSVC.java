...
public class DestroyIdcEspSVC extends GroupOrderService {
	public IDataset destroyUserIdcOrder(IData map) throws Exception
    {
...
//        acctInfo = transformAcctInfo(acctInfo,user,contractId);
        ...
        inparam.put("BUSI_CTRL_TYPE", BizCtrlType.DestoryUser);
...
//        	if(IdcDiscntConst.discntElementId.equals(selectedElement.getString("ELEMENT_ID", ""))){
        		selectedElement.put("MODIFY_TAG", TRADE_MODIFY_TAG.DEL.getValue());
...
//        	}
        ...
        //必选信息填入 end 
        result =CSAppCall.call("SS.DestroyGroupUserIdcSVC.crtOrder", inparam);
