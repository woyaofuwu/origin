...
public class ChangeNetinMemberElement extends ChangeUserElement {
     ...
     * @return
     */
    public ChangeNetinMemberElement() {
    ...
    private void actTradeDatalineAttr() throws Exception {
        ...
        if (DataUtils.isNotEmpty(attrDataList)) { // 没有getCommonData判空
            for (Object attrInf : attrDataList) {
                ...
                if ("PRODUCT_ID".equals(attrCode) && "7011".equals(attrValue)) {
                    attrInfo.put("ATTR_VALUE", "97011");
                }else if ("PRODUCT_ID".equals(attrCode) && "70111".equals(attrValue)) {
                    attrInfo.put("ATTR_VALUE", "970111");
                }else if ("PRODUCT_ID".equals(attrCode) && "70112".equals(attrValue)) {
                    attrInfo.put("ATTR_VALUE", "970112");
                }
            }
        }
    ...
    private void actTradeUserAttr() throws Exception {
        ...
        }else if (DataLineDiscntConst.internet1ProductIdMember.equals(productId)) {
            productId = DataLineDiscntConst.internet1ProductId;
            discntCode = DataLineDiscntConst.getElementIdToProductId(productId,userIdB);
        }else if (DataLineDiscntConst.internet2ProductIdMember.equals(productId)) {
            productId = DataLineDiscntConst.internet2ProductId;
            discntCode = DataLineDiscntConst.getElementIdToProductId(productId,userIdB);
        }
