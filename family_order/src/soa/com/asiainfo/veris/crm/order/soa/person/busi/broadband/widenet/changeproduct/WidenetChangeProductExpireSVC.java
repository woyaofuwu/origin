...
//            StringBuilder iuserSQL = new StringBuilder("INSERT INTO TI_B_USER ");
//            iuserSQL.append(" (SYNC_SEQUENCE, SYNC_DAY, MODIFY_TAG, TRADE_ID, PARTITION_ID, USER_ID, CUST_ID, USECUST_ID, ");
//            iuserSQL.append("EPARCHY_CODE, CITY_CODE, CITY_CODE_A, USER_PASSWD, USER_DIFF_CODE, USER_TYPE_CODE, ");
//            iuserSQL.append("USER_TAG_SET, USER_STATE_CODESET, NET_TYPE_CODE, SERIAL_NUMBER, CONTRACT_ID, ACCT_TAG, ");
//            iuserSQL.append("PREPAY_TAG, MPUTE_MONTH_FEE, MPUTE_DATE, FIRST_CALL_TIME, LAST_STOP_TIME, CHANGEUSER_DATE, ");
//            iuserSQL.append("IN_NET_MODE, IN_DATE, IN_STAFF_ID, IN_DEPART_ID, OPEN_MODE, OPEN_DATE, OPEN_STAFF_ID, ");
//            iuserSQL.append("OPEN_DEPART_ID, DEVELOP_STAFF_ID, DEVELOP_DATE, DEVELOP_DEPART_ID, DEVELOP_CITY_CODE, ");
//            iuserSQL.append("DEVELOP_EPARCHY_CODE, DEVELOP_NO, ASSURE_CUST_ID, ASSURE_TYPE_CODE, ASSURE_DATE, REMOVE_TAG, ");
//            iuserSQL.append("PRE_DESTROY_TIME, DESTROY_TIME, REMOVE_EPARCHY_CODE, REMOVE_CITY_CODE, REMOVE_DEPART_ID, ");
//            iuserSQL.append("REMOVE_REASON_CODE, UPDATE_TIME, UPDATE_STAFF_ID, UPDATE_DEPART_ID, REMARK, RSRV_NUM1, ");
//            iuserSQL.append("RSRV_NUM2, RSRV_NUM3, RSRV_NUM4, RSRV_NUM5, RSRV_STR1, RSRV_STR2, RSRV_STR3, RSRV_STR4, ");
//            iuserSQL.append("RSRV_STR5, RSRV_STR6, RSRV_STR7, RSRV_STR8, RSRV_STR9, RSRV_STR10, RSRV_DATE1, RSRV_DATE2, ");
//            iuserSQL.append("RSRV_DATE3, RSRV_TAG1, RSRV_TAG2, RSRV_TAG3, BRAND_CODE, PRODUCT_ID) ");
//            Dao.executeUpdate(iuserSQL, userParam);
