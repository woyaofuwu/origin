...
public class QueryOweDestroyForegiftSVC extends CSBizService
{
    ...
    public IDataset queryArea(IData param) throws Exception
    {
        ...
        QueryOweDestroyForegiftBean bean = BeanManager.createBean(QueryOweDestroyForegiftBean.class);
    ...
    {
        QueryOweDestroyForegiftBean bean = (QueryOweDestroyForegiftBean) BeanManager.createBean(QueryOweDestroyForegiftBean.class);
        return bean.queryOweDestroyForegift(data);
    }
}
