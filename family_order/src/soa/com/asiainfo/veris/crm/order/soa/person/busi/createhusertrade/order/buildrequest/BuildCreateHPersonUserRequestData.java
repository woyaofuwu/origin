package com.asiainfo.veris.crm.order.soa.person.busi.createhusertrade.order.buildrequest;
...
public class BuildCreateHPersonUserRequestData extends BaseBuilder implements IBuilder {

	public void buildBusiRequestData(IData param, BaseReqData brd) throws Exception {

		CreateHPersonUserRequestData createHPersonUserRequestData = (CreateHPersonUserRequestData) brd;

		// 基本信息
		buildElems(param, createHPersonUserRequestData);
		createHPersonUserRequestData.setMainProduct(param.getString("PRODUCT_ID"));// 设置产品信息
		createHPersonUserRequestData.getUca().setProductId(param.getString("PRODUCT_ID"));
		createHPersonUserRequestData.getUca().setBrandCode(createHPersonUserRequestData.getMainProduct().getBrandCode());
		createHPersonUserRequestData.getUca().setAcctDay(param.getString("ACCT_DAY", "1"));
	}
	...
	public UcaData buildUcaData(IData param) throws Exception {
		...
		/*
		 * 先处理全部新增情况 ，不包含已经存在情况 sunxin if (!param.getString("B_REOPEN_TAG",
		 * "").equals("1")) {
		 */
		...
		userInfo.put("SERIAL_NUMBER", "H" + param.getString("SERIAL_NUMBER"));
	 ...
	 * @date 2018-1-26 16:35:16
	 */
	public void buildElems(IData param, CreateHPersonUserRequestData brd) throws Exception {
		/* 拼装子元素 */
	...
	public BaseReqData getBlankRequestDataInstance() {
		return new CreateHPersonUserRequestData();
	}
