 ...
 * 密码卡
 */
public class SimCardPwdFinishAction implements ITradeFinishAction
{
    protected static Logger log = Logger.getLogger(SimCardPwdFinishAction.class);
        ...
        if (IDataUtil.isNotEmpty(userTradeInfos))
        {
            for (int i = 0; i < userTradeInfos.size(); i++)
            {
                ...
                {// 使用密码卡
                    ...
                    data.put("ENCRYPT_GENE", userTradeInfos.getData(i).getString("RSRV_STR3"));
