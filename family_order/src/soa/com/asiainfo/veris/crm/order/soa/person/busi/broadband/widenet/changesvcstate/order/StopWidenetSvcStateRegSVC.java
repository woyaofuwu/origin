...
public class StopWidenetSvcStateRegSVC extends OrderService
{
    ...
    public String getOrderTypeCode() throws Exception
    {
        if (this.input.getString("TRADE_TYPE_CODE", "").equals(""))
        {
            ...
            if (IDataUtil.isNotEmpty(widenetInfos))
            {
                ...
                {
                    input.put("ORDER_TYPE_CODE", "632");
                }
                else
                {
                    input.put("ORDER_TYPE_CODE", "603");
                }
            }
            else
            {
    ...
    public String getTradeTypeCode() throws Exception
    {
        if (this.input.getString("TRADE_TYPE_CODE", "").equals(""))
        {
            ...
            if (IDataUtil.isNotEmpty(widenetInfos))
            {
                ...
                if ("4".equals(wideType))
                {
                    input.put("TRADE_TYPE_CODE", "632");
                }
                else
                {
                    input.put("TRADE_TYPE_CODE", "603");
                }
