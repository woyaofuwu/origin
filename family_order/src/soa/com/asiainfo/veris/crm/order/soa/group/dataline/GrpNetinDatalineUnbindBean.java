...
public class GrpNetinDatalineUnbindBean extends GroupBean
{
    //互联网专线接入（专网专线）解绑
    
    protected GrpNetinDatalineReqData reqData = null;
    ...
    {
        return new GrpNetinDatalineReqData();
    }
    ...
    protected void initReqData() throws Exception
    {
        ...
        reqData = (GrpNetinDatalineReqData) getBaseReqData();
    }
