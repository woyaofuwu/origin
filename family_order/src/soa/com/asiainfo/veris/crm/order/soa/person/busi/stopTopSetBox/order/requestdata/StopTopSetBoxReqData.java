package com.asiainfo.veris.crm.order.soa.person.busi.stopTopSetBox.order.requestdata;

import com.asiainfo.veris.crm.order.soa.frame.bof.data.requestdata.BaseReqData;

public class StopTopSetBoxReqData extends BaseReqData {
    ...
    private String experienceTag; // 体验基础包到期标识  EXPERIENCE_CONTINUE:体验基础包到期前续订;   EXPERIENCE_STOP:体验基础包到期未续订导致报停
