...
package com.asiainfo.veris.crm.order.soa.person.busi.unitopenchangeactive.order.buildrequest;
...
public class BuildUnitOpenChangeActiveReqData extends BaseBuilder implements IBuilder
{

    public void buildBusiRequestData(IData inParam, BaseReqData brd) throws Exception
    {
        UnitOpenChangeActiveReqData reqData = (UnitOpenChangeActiveReqData) brd;
        ...
        reqData.setUse(inParam.getString("USE").contains("*") ? reqData.getUca().getCustomer().getRsrvStr8():inParam.getString("USE"));
    ...
    {
        return new UnitOpenChangeActiveReqData();
    }
