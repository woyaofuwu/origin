 ...
 */
public class SaleActiveTradeData extends BaseTradeData implements IAcctDayChangeData
{
    ...
    public SaleActiveTradeData()
    {

    }

    public SaleActiveTradeData(IData data)
    {
        this.actorName = data.getString("ACTOR_NAME");
        this.actorPhone = data.getString("ACTOR_PHONE");
        this.actorPsptId = data.getString("ACTOR_PSPT_ID");
        this.actorPsptTypeCode = data.getString("ACTOR_PSPT_TYPE_CODE");
        this.advancePay = data.getString("ADVANCE_PAY");
        this.apprStaffId = data.getString("APPR_STAFF_ID");
        this.apprTime = data.getString("APPR_TIME");
        ...
        this.outNetPhone = data.getString("OUT_NET_PHONE");
    ...
    public SaleActiveTradeData clone()
    {
        SaleActiveTradeData saleActiveTradeData = new SaleActiveTradeData();
        saleActiveTradeData.setActorName(this.getActorName());
        saleActiveTradeData.setActorPhone(this.getActorPhone());
        saleActiveTradeData.setActorPsptId(this.getActorPsptId());
        saleActiveTradeData.setActorPsptTypeCode(this.getActorPsptTypeCode());
        saleActiveTradeData.setAdvancePay(this.getAdvancePay());
        saleActiveTradeData.setApprStaffId(this.getApprStaffId());
        saleActiveTradeData.setApprTime(this.getApprTime());
        saleActiveTradeData.setCampnCode(this.getCampnCode());
        saleActiveTradeData.setCampnId(this.getCampnId());
        saleActiveTradeData.setCampnName(this.getCampnName());
        saleActiveTradeData.setCampnType(this.getCampnType());
        saleActiveTradeData.setCancelCause(this.getCancelCause());
        saleActiveTradeData.setCancelDate(this.getCancelDate());
        saleActiveTradeData.setCancelStaffId(this.getCancelStaffId());
        saleActiveTradeData.setContractId(this.getContractId());
        saleActiveTradeData.setCreditValue(this.getCreditValue());
        saleActiveTradeData.setEndDate(this.getEndDate());
        saleActiveTradeData.setEndMode(this.getEndMode());
        saleActiveTradeData.setForegift(this.getForegift());
        saleActiveTradeData.setModifyTag(this.getModifyTag());
        saleActiveTradeData.setMonths(this.getMonths());
        saleActiveTradeData.setOperFee(this.getOperFee());
        saleActiveTradeData.setOutNetPhone(this.getOutNetPhone());
        saleActiveTradeData.setPackageId(this.getPackageId());
        saleActiveTradeData.setPackageName(this.getPackageName());
        saleActiveTradeData.setProcessTag(this.getProcessTag());
        saleActiveTradeData.setProductId(this.getProductId());
        saleActiveTradeData.setProductMode(this.getProductMode());
        saleActiveTradeData.setProductName(this.getProductName());
        saleActiveTradeData.setRelationTradeId(this.getRelationTradeId());
        saleActiveTradeData.setRemark(this.getRemark());
        saleActiveTradeData.setRsrvDate1(this.getRsrvDate1());
        saleActiveTradeData.setRsrvDate2(this.getRsrvDate2());
        saleActiveTradeData.setRsrvDate3(this.getRsrvDate3());
        saleActiveTradeData.setRsrvNum1(this.getRsrvNum1());
        saleActiveTradeData.setRsrvNum2(this.getRsrvNum2());
        saleActiveTradeData.setRsrvNum3(this.getRsrvNum3());
        saleActiveTradeData.setRsrvNum4(this.getRsrvNum4());
        saleActiveTradeData.setRsrvNum5(this.getRsrvNum5());
        saleActiveTradeData.setRsrvStr1(this.getRsrvStr1());
        saleActiveTradeData.setRsrvStr10(this.getRsrvStr10());
        saleActiveTradeData.setRsrvStr11(this.getRsrvStr11());
        saleActiveTradeData.setRsrvStr12(this.getRsrvStr12());
        saleActiveTradeData.setRsrvStr13(this.getRsrvStr13());
        saleActiveTradeData.setRsrvStr14(this.getRsrvStr14());
        saleActiveTradeData.setRsrvStr15(this.getRsrvStr15());
        saleActiveTradeData.setRsrvStr16(this.getRsrvStr16());
        saleActiveTradeData.setRsrvStr17(this.getRsrvStr17());
        saleActiveTradeData.setRsrvStr18(this.getRsrvStr18());
        saleActiveTradeData.setRsrvStr19(this.getRsrvStr19());
        saleActiveTradeData.setRsrvStr2(this.getRsrvStr2());
        saleActiveTradeData.setRsrvStr20(this.getRsrvStr20());
        saleActiveTradeData.setRsrvStr21(this.getRsrvStr21());
        saleActiveTradeData.setRsrvStr22(this.getRsrvStr22());
        saleActiveTradeData.setRsrvStr23(this.getRsrvStr23());
        saleActiveTradeData.setRsrvStr24(this.getRsrvStr24());
        saleActiveTradeData.setRsrvStr25(this.getRsrvStr25());
        saleActiveTradeData.setRsrvStr3(this.getRsrvStr3());
        saleActiveTradeData.setRsrvStr4(this.getRsrvStr4());
        saleActiveTradeData.setRsrvStr5(this.getRsrvStr5());
        saleActiveTradeData.setRsrvStr6(this.getRsrvStr6());
        saleActiveTradeData.setRsrvStr7(this.getRsrvStr7());
        saleActiveTradeData.setRsrvStr8(this.getRsrvStr8());
        saleActiveTradeData.setRsrvStr9(this.getRsrvStr9());
        saleActiveTradeData.setRsrvTag1(this.getRsrvTag1());
        saleActiveTradeData.setRsrvTag2(this.getRsrvTag2());
        saleActiveTradeData.setRsrvTag3(this.getRsrvTag3());
        saleActiveTradeData.setScoreChanged(this.getScoreChanged());
        saleActiveTradeData.setSerialNumber(this.getSerialNumber());
        saleActiveTradeData.setSerialNumberB(this.getSerialNumberB());
        saleActiveTradeData.setStartDate(this.getStartDate());
        saleActiveTradeData.setUserId(this.getUserId());
        saleActiveTradeData.setInstId(this.getInstId());
        return saleActiveTradeData;
    }
    ...
    public void setOutNetPhone(String outNetPhone)
    {
        this.outNetPhone = outNetPhone;
    }
    ...
    public IData toData()
    {
        ...
        data.put("APPR_TIME", this.apprTime);
        ...
        data.put("OUT_NET_PHONE", this.outNetPhone);
