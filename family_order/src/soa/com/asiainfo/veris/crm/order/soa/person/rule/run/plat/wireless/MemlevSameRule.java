...
package com.asiainfo.veris.crm.order.soa.person.rule.run.plat.wireless;
...
public class MemlevSameRule extends BreBase implements IBREScript
{
    ...
    public boolean run(IData databus, BreRuleParam ruleParam) throws Exception
    {
        ...
        if (PlatConstants.OPER_USER_DATA_MODIFY.equals(psd.getOperCode()))
        {
            ...
            {
                if ("302".equals(attr.getAttrCode()))
                {
                    ...
                    if (userPlatSvcs != null && userPlatSvcs.size() > 0)
                    {
                        ...
                        if (attrValue.equals(attrTradeData.getAttrValue()))
                        {
                            ...
                            {
                                BreTipsHelp.addNorTipsInfo(databus, BreFactory.TIPS_TYPE_ERROR, PlatException.CRM_PLAT_0952.toString(), PlatException.CRM_PLAT_0952.getValue());
                                return false;
                            }
                            else if ("2".equals(attrValue))
                            {
                                BreTipsHelp.addNorTipsInfo(databus, BreFactory.TIPS_TYPE_ERROR, PlatException.CRM_PLAT_0953.toString(), PlatException.CRM_PLAT_0953.getValue());
                                return false;
                            }
                            else
                            {
                                BreTipsHelp.addNorTipsInfo(databus, BreFactory.TIPS_TYPE_ERROR, PlatException.CRM_PLAT_0954_1.toString(), PlatException.CRM_PLAT_0954_1.getValue());
                                return false;
                            }
                        }
                    }
