 ...
 * @date 2009-6-8
 */
public class ImsBlackWhiteGrpBean extends GroupBean
{

    boolean opbool = true; // 判断是否只有删除操作,如果为true 则发删除报文，否则发变更报文

    protected ImsBlackWhiteGrpBeanReqData reqData = null;
    ...
    public void addBlackWhite(IData data, String xTag) throws Exception
    {
        ...
        data.put("SERVICE_ID", "817"); // 服务id 集团
    ...
    public IData checkBlackWhiteForEcuserId(String operCode, IData data) throws Exception
    {
        ...
        param.put("SERVICE_ID", "817"); // 服务id 集团
    ...
    {
        return new ImsBlackWhiteGrpBeanReqData();
    }
    ...
    public void infoRegDataCentreOther() throws Exception
    {
        ...
        data.put("RSRV_STR9", "817"); // 服务id 集团

        data.put("OPER_CODE", "03"); // 操作类型
        data.put("RSRV_STR11", "03"); // 操作类型
        data.put("START_DATE", getAcceptTime());
    ...
    protected void initReqData() throws Exception
    {
        ...
        reqData = (ImsBlackWhiteGrpBeanReqData) getBaseReqData();
    }
    ...
    {
        IData userInfo = UcaInfoQry.qryUserInfoBySn(serialNumber); // 0 remove_tag
        ...
        {
            reqData.setMem_user_id(userInfo.getString("USER_ID"));
        }
    }
