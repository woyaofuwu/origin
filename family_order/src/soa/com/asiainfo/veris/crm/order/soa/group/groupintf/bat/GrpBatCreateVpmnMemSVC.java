...
public class GrpBatCreateVpmnMemSVC extends GroupBatService
{
    ...
    {
        svcData.put("BATCH_OPER_TYPE", "BATADDPOCUMEM");
        ...
        svcData.put("IF_BOOKING", condData.getString("IF_BOOKING", "false")); // j2ee IF_BOOKING后面会做公共类赋值，这里为临时处理
