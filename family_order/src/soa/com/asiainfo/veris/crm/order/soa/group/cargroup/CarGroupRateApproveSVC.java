...
public class CarGroupRateApproveSVC extends CSBizService
{
	private static final Logger logger = Logger.getLogger(CarGroupRateApproveSVC.class.getName());
    ...
    {
        return  CarGroupRateApproveBean.queryByECID(input,getPagination());
    }
    /**
     * 车联网--新增省侧审批结果
     * @param input
    ...
    {
    	CarGroupRateApproveBean bean = BeanManager.createBean(CarGroupRateApproveBean.class);
