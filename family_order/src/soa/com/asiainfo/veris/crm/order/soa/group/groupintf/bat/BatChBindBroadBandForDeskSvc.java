...
public class BatChBindBroadBandForDeskSvc extends GroupBatService
{
    private static final long serialVersionUID = 1L;

    private static final String SERVICE_NAME = "SS.BindBroadBandMgrSvc.chCrtTrade";
    ...
    public void batValidateSub(IData batData) throws Exception
    {
    	...
    	String kdSerialNumber = IDataUtil.getMandaData(batData, "DATA1");//修改的宽带账号
    ...
    public void builderSvcData(IData batData) throws Exception
    {
        ...
        svcData.put("OLDKD_SERIAL_NUMBER", oldKdSerialNumber);
    ...
    public void validateImsNumber(IData batData) throws Exception
    {
        ...
        oldKdSerialNumber = uuInfoData.getString("SERIAL_NUMBER_B","");
    ...
    {
    	String kdSerialNumber = IDataUtil.getMandaData(batData, "DATA1");//修改绑定的宽带账号
