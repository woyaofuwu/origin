 ...
 * 
 * @ClassName: ChangeSvcStateDealImpuAction.java
 * @Description: 服务状态变更处理Impu用户资料，对于老系统TradeGrpMgr::CreateGrpTradeImpu
 * @version: v1.0.0
 * @author: xiaozb
 * @date: 2014-7-25 下午10:05:29
 */
public class ChangeSvcStateDealImpuAction implements ITradeAction
{
    /**
    ...
    public void executeAction(BusiTradeData btd) throws Exception
    {
        ...
        /**** 20140819 ******/
        IDataset grpTrade = CSAppCall.call("SS.GrpCreditSVC.CreateGrpTradeImpu", params);
