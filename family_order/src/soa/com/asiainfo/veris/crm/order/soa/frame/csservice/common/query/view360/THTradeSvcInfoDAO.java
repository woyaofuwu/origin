...
public class THTradeSvcInfoDAO
{
    /**
     * 根据TRADE_ID从表tf_b_trade_svc查询服务变化信息
     * 
     * @param param
     * @param pagination
     * @return
     */
    public IDataset queryTradeSvcInfo(IData param) throws Exception
    {
