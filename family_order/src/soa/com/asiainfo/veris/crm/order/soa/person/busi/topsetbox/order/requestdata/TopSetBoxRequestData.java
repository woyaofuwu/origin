package com.asiainfo.veris.crm.order.soa.person.busi.topsetbox.order.requestdata;
 ...
 */
public class TopSetBoxRequestData extends BaseReqData
{
    ...
    private String isHasSaleActive;
    ...
    private String iptvcityCode;//宽带办理市县
    ...
    public String getIsHasSaleActive() {
		return isHasSaleActive;
	}

	public void setIsHasSaleActive(String isHasSaleActive) {
		this.isHasSaleActive = isHasSaleActive;
	}
	...
	public String getIptvCityCode() {
		return iptvcityCode;
	}


	public void setIptvCityCode(String iptvcityCode) {
		this.iptvcityCode = iptvcityCode;
	}
}
