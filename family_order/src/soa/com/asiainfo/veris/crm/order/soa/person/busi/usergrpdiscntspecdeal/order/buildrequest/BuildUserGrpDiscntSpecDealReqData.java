...
package com.asiainfo.veris.crm.order.soa.person.busi.usergrpdiscntspecdeal.order.buildrequest;
 ...
 * 
 * @ClassName: BuildUserGrpDiscntSpecDealReqData.java
 * @Description: 该类的功能描述
 * @version: v1.0.0
 * @author: maoke
 ...
 */
public class BuildUserGrpDiscntSpecDealReqData extends BaseBuilder implements IBuilder
{
    @Override
    public void buildBusiRequestData(IData param, BaseReqData brd) throws Exception
    {
        UserGrpDiscntSpecDealReqData request = (UserGrpDiscntSpecDealReqData) brd;
    ...
    {
        return new UserGrpDiscntSpecDealReqData();
    }
