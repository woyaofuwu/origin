...
public class QueryAccountChgInfoSVC extends CSBizService
{
     ...
     */
    public IDataset queryAccountChgInfo(IData data) throws Exception
    {
        QueryAccountChgInfoBean bean = (QueryAccountChgInfoBean) BeanManager.createBean(QueryAccountChgInfoBean.class);
        return bean.queryAccountChgInfo(data, getPagination());
    }
    ...
    public IDataset queryArea(IData param) throws Exception
    {
        ...
        QueryAccountChgInfoBean bean = BeanManager.createBean(QueryAccountChgInfoBean.class);
    ...
    /**
     * 功能：查询付费模式 作者：GongGuang
     */
    public IDataset queryPayModes(IData data) throws Exception
    {
        QueryAccountChgInfoBean bean = (QueryAccountChgInfoBean) BeanManager.createBean(QueryAccountChgInfoBean.class);
        return bean.queryPayModes();
    }
}
