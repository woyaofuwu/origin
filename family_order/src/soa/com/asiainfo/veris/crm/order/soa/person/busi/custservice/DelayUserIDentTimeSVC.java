...
public class DelayUserIDentTimeSVC extends CSBizService {
	...
	public IData updateUserIdentUnEffT(IData input) throws Exception{
		...
		DelayUserIDentTimeBean bean = (DelayUserIDentTimeBean) BeanManager.createBean(DelayUserIDentTimeBean.class);
