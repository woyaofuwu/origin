package com.asiainfo.veris.crm.order.soa.person.busi.nophonetopsetbox.noPhoneRenewTopSetBox.order.requestdata;

import com.asiainfo.veris.crm.order.soa.frame.bof.data.requestdata.BaseReqData;

public class NoPhoneRenewTopSetBoxReqData extends BaseReqData {
    ...
    private String topSetBoxTime;  //受理时长

    private String topSetBoxFee;  //受理时长费用
    ...
    private String topSetBoxStateTag; //魔百和状态  0：正常 ，1：主动停机 ， 2：欠费停机
	...
	public String getTopSetBoxStateTag() {
		return topSetBoxStateTag;
	}

	public void setTopSetBoxStateTag(String topSetBoxStateTag) {
		this.topSetBoxStateTag = topSetBoxStateTag;
	}
