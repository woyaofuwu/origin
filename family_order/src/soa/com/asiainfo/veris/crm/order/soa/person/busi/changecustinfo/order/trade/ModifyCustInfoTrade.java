...
package com.asiainfo.veris.crm.order.soa.person.busi.changecustinfo.order.trade;
 ...
 * @author liutt
 */
public class ModifyCustInfoTrade extends BaseTrade implements ITrade
{

	protected static final Logger log = Logger.getLogger(ModifyCustInfoTrade.class);
    ...
    private void createCustomerTradeData(BusiTradeData btd) throws Exception
    {
        ...
        customerTradeData.setRsrvStr6(custInfoRD.getDevRead()+","+custInfoRD.getReadRuslt()+","+custInfoRD.getComparisonIs()
        		+","+custInfoRD.getComparisonRuslt()+","+custInfoRD.getComparisonSeq()+","+custInfoRD.getAuthenticityIs()
        		+","+custInfoRD.getAuthenticityRuslt()+","+custInfoRD.getAuthenticitySeq()+","+custInfoRD.getProvenumIs()+","
        		+custInfoRD.getProvenumRuslt()+","+custInfoRD.getProvenumSeq());
