...
import com.asiainfo.veris.crm.order.soa.frame.csservice.group.bbossBiz.createMember.CreateBBossMemBean;
import com.asiainfo.veris.crm.order.soa.frame.csservice.group.bbossBiz.destroyMember.DestroyBBossMemBean;
import com.asiainfo.veris.crm.order.soa.frame.csservice.group.common.base.GroupOrderService;
import com.asiainfo.veris.crm.order.soa.frame.csservice.group.common.util.IntfField;

public class ChangeBBossMemSVC extends GroupOrderService
{
    ...
    public final IDataset crtOrder(IData map) throws Exception
    {
        ...
        {// 反向接口
            ...
            returnVal = changeBBossRevsMemDataBean.makeData(map);

        }
        else
        {
            returnVal = ChangeBBossMemDataBean.makeData(map);
