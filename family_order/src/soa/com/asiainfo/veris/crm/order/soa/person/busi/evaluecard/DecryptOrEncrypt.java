 ...
 */
public final class DecryptOrEncrypt {
	/**
	 * 进行MD5加密
	 * 
	 * @param String
	...
	public static void main(String[] args) {
		DecryptOrEncrypt de = new DecryptOrEncrypt();
		String oldString = "581129835009813661";
		String SPKEY = "1234";
		System.out.println("1。分配的SPKEY为: " + SPKEY);
		System.out.println("2。的内容为: " + oldString);
		String reValue = de.get3DESEncrypt(oldString, SPKEY).trim().intern();
		System.out.println("进行3-DES加密后的内容: " + reValue);
		String reValue2 = de.get3DESDecrypt(reValue, SPKEY);
