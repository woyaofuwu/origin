 ...
 * @author loyoveui
 */
public class CloseGrpDelBean extends MemberBean
{
    boolean ifCentrex = false; // 是否融合网

    protected CloseGrpDelBeanReqData reqData = null;
    ...
    public void actTradeBefore() throws Exception
    {
        ...
        // 判断是否融合V网
        checkIfCentrexVPMN(reqData.getGrpUca().getUserId()); // 集团用户userId
    }
    ...
    {
        return new CloseGrpDelBeanReqData();
    }
    ...
    {
        String user_id_a = reqData.getGrpUca().getUserId(); // 集团用户user_id
        String user_id_b = reqData.getUca().getUserId(); // 闭合群user_id

        IDataset relationUUs = RelaUUInfoQry.qryUU(user_id_a, user_id_b, "VB", null);
    ...
    protected void initReqData() throws Exception
    {
        ...
        reqData = (CloseGrpDelBeanReqData) getBaseReqData();
    }
    ...
    {
        String closeSn = map.getString("SERIAL_NUMBER_B"); // 闭合群sn
        String closeUserId = map.getString("USER_ID_B"); // 闭合群user_id
        ...
        if (ucaData == null)
        {
            ...
            userInfo.put("USER_ID", closeUserId); // 闭合群userId
            userInfo.put("SERIAL_NUMBER", closeSn); // 闭合群sn
    ...
    protected void regTrade() throws Exception
    {
        ...
        data.put("RSRV_STR3", reqData.getUca().getUserId()); // 闭合群Sn
