...
package com.asiainfo.veris.crm.order.soa.person.busi.imschangeproduct.order;

import com.ailk.common.data.IData;
import com.asiainfo.veris.crm.order.soa.frame.bof.data.orderdata.MainOrderData;
import com.asiainfo.veris.crm.order.soa.frame.bof.data.tradedata.BusiTradeData;
import com.asiainfo.veris.crm.order.soa.frame.bof.execute.service.OrderService;
public class IMSChangeProductRegSVC extends OrderService
{
    ...
    {
    	input.put("ORDER_TYPE_CODE", "6806");
        return this.input.getString("ORDER_TYPE_CODE", "");
    }

    public String getTradeTypeCode() throws Exception
    {
    	input.put("TRADE_TYPE_CODE", "6806");
