package com.asiainfo.veris.crm.order.soa.person.busi.nophonetopsetbox.noPhoneStopTopSetBox.order.buildrequest;
...
public class BuildNoPhoneStopTopSetBoxReqData extends BaseBuilder implements IBuilder{

	public void buildBusiRequestData(IData param, BaseReqData brd) throws Exception
    {
		NoPhoneStopTopSetBoxReqData tsbReqData = (NoPhoneStopTopSetBoxReqData) brd;
        ...
        tsbReqData.setStopAction(param.getString("STOP_ACTION"));
    ...
    {
        return new NoPhoneStopTopSetBoxReqData();
    }
