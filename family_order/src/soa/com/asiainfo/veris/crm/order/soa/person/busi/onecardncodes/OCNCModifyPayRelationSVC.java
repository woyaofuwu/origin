...
public class OCNCModifyPayRelationSVC extends CSBizService
{

    protected static Logger log = Logger.getLogger(OCNCModifyPayRelationSVC.class);
     ...
     * 取业务参数
     */
    public IDataset checkSn(IData inParams) throws Exception
    {

        OCNCMidifyPayRelationBean bean = (OCNCMidifyPayRelationBean) BeanManager.createBean(OCNCMidifyPayRelationBean.class);
        IDataset otherData = bean.checkSn(inParams);
