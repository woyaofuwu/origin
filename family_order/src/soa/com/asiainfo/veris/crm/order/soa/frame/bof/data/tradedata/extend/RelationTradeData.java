 ...
 */
public class RelationTradeData extends BaseTradeData
{
    ...
    public RelationTradeData()
    {

    }

    public RelationTradeData(IData data)
    {
    ...
    public RelationTradeData clone()
    {
