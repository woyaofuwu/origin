...
public class GrpMemberFileBean extends CSBizBean
{
	 ...
	 * @throws Exception
	 */
    public IDataset queryGrpMemberFiles(IData inparams, Pagination pagination) throws Exception
    {
     ...
     * @throws Exception
     */
    public IDataset delGrpMebFileByFileId(IData inparams) throws Exception
    {
            ...
            if(StringUtils.isNotBlank(fileId)){
                ...
                for(int i=0;i < fileIds.length; i++){
                    if(StringUtils.isNotBlank(fileIds[i])){
                        GrpMemberFileQry.delGrpMebFileByFileId(fileIds[i]); 
                    }
                }
            }
        }
