 ...
 *
 */
public class BuildFTTHBusiModemLoseReqData extends BaseBuilder implements IBuilder
{

    @Override
    public void buildBusiRequestData(IData param, BaseReqData brd) throws Exception
    {
    	FTTHBusiModemLoseReqData fttRd = (FTTHBusiModemLoseReqData)brd;
    ...
    {
        return new FTTHBusiModemLoseReqData();
    }
