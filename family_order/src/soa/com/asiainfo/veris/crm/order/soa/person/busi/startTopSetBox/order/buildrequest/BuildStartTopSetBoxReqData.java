package com.asiainfo.veris.crm.order.soa.person.busi.startTopSetBox.order.buildrequest;
...
public class BuildStartTopSetBoxReqData extends BaseBuilder implements IBuilder{

	public void buildBusiRequestData(IData param, BaseReqData brd) throws Exception
    {
		StartTopSetBoxReqData tsbReqData = (StartTopSetBoxReqData) brd;
    ...
    {
        return new StartTopSetBoxReqData();
    }
