 ...
 * @date 2018-04-11
 */
public class PersonGrpUserUnionPaySVC extends CSBizService
{
     ...
     * @20200220
     */
    public IDataset queryGroupProductPackage(IData inparams) throws Exception
    {
        String staffId=inparams.getString("STAFF_ID","");
        IDataset resultDate = CommparaInfoQry.getCommparaAllColByParser("CSM", "2698",staffId,"0898");
