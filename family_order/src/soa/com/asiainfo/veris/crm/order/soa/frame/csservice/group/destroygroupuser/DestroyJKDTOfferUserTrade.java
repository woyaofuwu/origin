...
public class DestroyJKDTOfferUserTrade extends DestroyGroupUser
{
    ...
    public void actTradeSub() throws Exception
    {
        ...
        this.addTradeEcrecepOffer(reqData.getMERCH());
    ...
    public void infoRegDataEntireMerch() throws Exception
    {
        ...
        IDataset results = UserEcrecepOfferfoQry.qryJKDTMerchInfoByUserIdMerchSpecStatus(userId,null,null);
        ...
        IData epData = GrpCommonBean.actEcrecepProcedure(reqData.getUca().getUser().getUserId(),
                SeqMgr.getInstId(), reqData.getUca().getUser().getSerialNumber(), reqData.getMERCH().getString("MERCH_ORDER_ID"),
                reqData.getMERCH().getString("MERCH_OFFER_ID", ""), "2", "D", "D");
