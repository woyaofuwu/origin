...
public class DestroyBBossMerchPUserTrade extends DestroyGroupUser
{
    ...
    public void actTradeSub() throws Exception
    {
        ...
        super.addTradeGrpMerchp(reqData.cd.getMerchp());
    ...
    protected IData getGrpMerchAndDiscntInfo() throws Exception
    {
        ...
        IDataset grpMerchpInfoList = UserGrpMerchpInfoQry.qryMerchpInfoByUserIdMerchSpecProductSpecStatus(userId, null, null, null, null);
