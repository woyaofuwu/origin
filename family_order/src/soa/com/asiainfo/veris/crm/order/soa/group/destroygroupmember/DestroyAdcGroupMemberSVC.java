...
public class DestroyAdcGroupMemberSVC extends GroupOrderService
{
    ...
    public final IDataset crtOrder(IData map) throws Exception
    {
        ...
        DestroyAdcGroupMemberBean bean = new DestroyAdcGroupMemberBean();

        // 规则校验传入参数
        map.put("RULE_BIZ_TYPE_CODE", "chkBeforeForGrp");
        map.put("RULE_BIZ_KIND_CODE", "GrpMebDestory");
