...
public class ExportAgentBackBillIdListQry extends CSExportTaskExecutor
{
    private static transient final Logger logger = Logger.getLogger(ExportAgentBackBillIdListQry.class);
   
    public IDataset executeExport(IData data, Pagination page) throws Exception
    {    	
    	//IData param = data.subData("cond", false);
        IDataset result = CSAppCall.call("SS.QueryInfoSVC.qryAgentUserBackListByCond", data);
        return result;
    }      
}
