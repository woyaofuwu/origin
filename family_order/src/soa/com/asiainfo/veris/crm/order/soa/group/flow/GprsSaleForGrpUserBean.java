...
public class GprsSaleForGrpUserBean extends CreateGroupUser
{
    private static final Logger log = Logger.getLogger(GprsSaleForGrpUserBean.class);
    
    private IData paramData = new DataMap();// 参数数据
	
	public final static String TIME_FORMAT ="yyyy-MM-dd'T'HH:mm:ss.SSSZ";
	
	public final static String TIME_FORMAT2 ="yyyy-MM-dd HH:mm:ss";
    
    private IDataset pckOrderset = new DatasetList();
    
    public GprsSaleForGrpUserBean()
    {
