...
public class GrpBatVpmnSaleActiveTrans implements ITrans
{
    ...
    protected void builderSvcData(IData batData) throws Exception
    {
        ...
        // 推荐号码
        String serialNumberA = batData.getString("DATA1");

        // 活动类型
        String activeType = condData.getString("ACTIVE_TYPE");
        ...
        svcData.put("STAFF_ID", batData.getString("STAFF_ID"));
        svcData.put("DEPART_ID", batData.getString("CREATE_DEPART_ID"));
        svcData.put("CITY_CODE", batData.getString("CITY_CODE"));
        svcData.put("TRADE_EPARCHY_CODE", batData.getString("USER_EPARCHY_CODE"));
        ...
        svcData.put("UPDATE_DEPART_ID", batData.getString("CREATE_DEPART_ID"));
        svcData.put("UPDATE_STAFF_ID", batData.getString("STAFF_ID"));
    ...
    protected void checkRequestDataSub(IData batData) throws Exception
    {
        ...
        // 推荐号码
        String serialNumberA = IDataUtil.getMandaData(batData, "DATA1");

        // 活动类型
        String activeType = IDataUtil.getMandaData(condData, "ACTIVE_TYPE");
