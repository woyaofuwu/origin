 ...
 * @author 
 */
public class DestroyGfffGroupQuanLiangUser extends DestroyGroupUser
{
    public DestroyGfffGroupQuanLiangUser()
    {
...
//                        "73420002".equals(userDiscntData.getString("PACKAGE_ID"))
