...
public class ChangeMDMUserElement extends ChangeUserElement
{
    private static transient Logger logger = Logger.getLogger(ChangeMDMUserElement.class);
