...
public class Op_NEQ implements IOperatorExecution
{
    ...
    public Constant execute(Constant[] args) throws IllegalExpressionException
    {
        ...
        else
        {
            ...
            else if (BaseDataMeta.DataType.DATATYPE_OBJECT == first.getDataType() && BaseDataMeta.DataType.DATATYPE_OBJECT == second.getDataType())
            {
    ...
    public Constant verify(int opPositin, BaseDataMeta[] args) throws IllegalExpressionException
    {
        ...
        else if (BaseDataMeta.DataType.DATATYPE_BOOLEAN == first.getDataType() && BaseDataMeta.DataType.DATATYPE_BOOLEAN == second.getDataType())
        {
            return new Constant(BaseDataMeta.DataType.DATATYPE_BOOLEAN, Boolean.FALSE);
