...
/**
 * 功能：未完工工单查询的导出 作者：GongGuang
 */
public class ExportBatReplySmsQuery extends ExportTaskExecutor
{
    @Override
    public IDataset executeExport(IData paramIData, Pagination paramPagination) throws Exception
    {
        ...
        IDataset res = CSAppCall.call("SS.BatReplySmsQuerySVC.batReplySmsQuery", data);
        return res;
    }
}
