...
public class CreateCentrexSuperTeleGroupUserSVC extends GroupOrderService
{
    ...
    public final IDataset crtOrder(IData map) throws Exception
    {
        ...
        CreateCentrexSuperTeleGroupUserBean bean = new CreateCentrexSuperTeleGroupUserBean();
