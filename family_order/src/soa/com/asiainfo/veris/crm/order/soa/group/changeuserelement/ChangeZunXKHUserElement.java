...
public class ChangeZunXKHUserElement extends ChangeUserElement
{
    private static transient Logger logger = Logger.getLogger(ChangeZunXKHUserElement.class);
     ...
     * 构造函数
     */
    public ChangeZunXKHUserElement()
    {
