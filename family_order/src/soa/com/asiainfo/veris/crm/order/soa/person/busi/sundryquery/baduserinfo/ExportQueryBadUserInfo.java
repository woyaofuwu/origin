...
/**
 * 功能：不良信息用户资料查询的导出 作者：GongGuang
 */
public class ExportQueryBadUserInfo extends ExportTaskExecutor
{
    @Override
    public IDataset executeExport(IData paramIData, Pagination paramPagination) throws Exception
    {
        ...
        IDataset res = CSAppCall.call("SS.QueryBadUserInfoSVC.queryBadUserInfo", data);
        return res;
    }
}
