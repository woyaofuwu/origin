...
/**
 * 功能：移动电话欠费销号清单的导出 作者：GongGuang
 */
public class ExportQueryOweWriteOff extends ExportTaskExecutor
{
    @Override
    public IDataset executeExport(IData paramIData, Pagination paramPagination) throws Exception
    {
        ...
        IDataset res = CSAppCall.call("SS.QueryOweWriteOffSVC.queryOweWriteOff", data);
        return res;
    }
}
