package com.asiainfo.veris.crm.order.soa.person.busi.nophonetopsetbox.noPhoneRenewTopSetBox.order.buildrequest;
...
public class BuildNoPhoneRenewTopSetBoxReqData extends BaseBuilder implements IBuilder{

	public void buildBusiRequestData(IData param, BaseReqData brd) throws Exception
    {
		NoPhoneRenewTopSetBoxReqData tsbReqData = (NoPhoneRenewTopSetBoxReqData) brd;
        ...
        tsbReqData.setTopSetBoxStateTag(param.getString("TOP_SET_BOX_STATE_TAG"));   
    }
	
	public BaseReqData getBlankRequestDataInstance()
    {
        return new NoPhoneRenewTopSetBoxReqData();
    }
