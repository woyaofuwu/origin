...
public abstract class BaseDataMeta
{
    ...
    public DataType getCompatibleType(BaseDataMeta another)
    {
        ...
        if (isCompatibleType(another))
        {
            ...
            else if (DataType.DATATYPE_DOUBLE == this.getDataType() || DataType.DATATYPE_DOUBLE == another.getDataType())
            {
                return DataType.DATATYPE_DOUBLE;

            }
            else if (DataType.DATATYPE_FLOAT == this.getDataType() || DataType.DATATYPE_FLOAT == another.getDataType())
            {
                return DataType.DATATYPE_FLOAT;

            }
            else if (DataType.DATATYPE_LONG == this.getDataType() || DataType.DATATYPE_LONG == another.getDataType())
            {
    ...
    public String getDataValueText()
    {
        ...
        {
            return DateFormatUtils.format((Date) dataValue, "yyyy-MM-dd HH:mm:ss");
        ...
        else if (BaseDataMeta.DataType.DATATYPE_LIST == this.dataType)
        {
            ...
            for (Object o : col)
            {
                ...
                {
                    String s = DateFormatUtils.format((Date) o, "yyyy-MM-dd HH:mm:ss");
    ...
    public boolean isCompatibleType(BaseDataMeta another)
    {
        ...
        else if (DataType.DATATYPE_INT != this.getDataType() && DataType.DATATYPE_LONG != this.getDataType() && DataType.DATATYPE_FLOAT != this.getDataType() && DataType.DATATYPE_DOUBLE != this.getDataType())
        {
            return false;

        }
        else if (DataType.DATATYPE_INT != another.getDataType() && DataType.DATATYPE_LONG != another.getDataType() && DataType.DATATYPE_FLOAT != another.getDataType() && DataType.DATATYPE_DOUBLE != another.getDataType())
        {
            return false;
