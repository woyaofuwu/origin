 ...
 * @create: 2018-09-29 14:06
 **/

public class CreateReceptionHallMemBean extends GroupOrderBaseBean {
    ...
    public void actOrderDataOther(IData map) throws Exception
    {
        ...
        if (IDataUtil.isNotEmpty(merchInfo)) { // 不为空
    ...
    protected void createMerchPTdInfo(IDataset orderInfo ,IData map) throws Exception
    {
        for (int i = 0; i < orderInfo.size(); i++)
        {
            ...
            MebCommonBean.regTradeLimitInfo(merchTradeId, merchpTradeId); //暂时使用旧版
        }
    }
