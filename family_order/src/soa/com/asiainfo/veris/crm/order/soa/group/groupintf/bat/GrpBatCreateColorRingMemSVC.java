...
public class GrpBatCreateColorRingMemSVC extends GroupBatService
{
    ...
    {
        svcData.put("BATCH_OPER_TYPE", "MUSICRINGMEM");
        ...
        // svcData.put("JOIN_IN", condData.getDataset("JOIN_IN"));
        // 构建产品参数信息
