...
public class ExpandTopSetBoxTempOccuTime implements ITradeAction {
				...
				if(isExpendTempOccuTime){
					...
					if(tradeRes!=null&&tradeRes.size()>0){
						...
						if(imsi!=null&&!imsi.trim().equals("")){
							...
							//由于当前会话的登录信息是4800工单中营业员的登录信息，而华为的预占记录是施工人员的登录信息，所以调华为的时候，不能再用营业员信息了，置为施工人员信息
