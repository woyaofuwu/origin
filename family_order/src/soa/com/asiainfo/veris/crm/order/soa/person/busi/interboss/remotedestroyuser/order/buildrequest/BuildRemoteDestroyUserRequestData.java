package com.asiainfo.veris.crm.order.soa.person.busi.interboss.remotedestroyuser.order.buildrequest;
...
public class BuildRemoteDestroyUserRequestData extends BaseBuilder implements IBuilder
{

    public void buildBusiRequestData(IData param, BaseReqData brd) throws Exception
    {
    	RemoteDestroyUserRequestData remoteDesUserRD = (RemoteDestroyUserRequestData) brd;
    	remoteDesUserRD.setContactPhone(param.getString("CONTACT_PHONE"));
    	remoteDesUserRD.setContactName(param.getString("CONTACT_NAME"));

    	remoteDesUserRD.setGiftSerialNumber(param.getString("GIFT_SERIAL_NUMBER"));
    	remoteDesUserRD.setGiftCustName(param.getString("GIFT_CUST_NAME"));
    	remoteDesUserRD.setGiftSerialNumberB(param.getString("GIFT_SERIAL_NUMBER_B"));
    	remoteDesUserRD.setGiftCustNameB(param.getString("GIFT_CUST_NAME_B"));
    	
    	remoteDesUserRD.setCreatePhone(param.getString("CREATE_PHONE"));
    	remoteDesUserRD.setCreateContact(param.getString("CREATE_CONTACT"));
    	remoteDesUserRD.setCreateOrgName(param.getString("CREATE_ORG_NAME"));

    	remoteDesUserRD.setHomeProv(param.getString("HOME_PROV"));
    	remoteDesUserRD.setHomeProvName(param.getString("HOME_PROV_NAME"));
    	remoteDesUserRD.setRemoteOrderId(param.getString("REMOTE_ORDER_ID"));
   }
	...
	public UcaData buildUcaData(IData param) throws Exception
	{
		...
		String sysDateFormat = SysDateMgr.getSysDate("yyyyMMddHHmmssS");
		String sn_Ms = param.getString("MOBILENUM")+sysDateFormat.substring(sysDateFormat.length()-5);
		String userId = sn_Ms;//虚拟id
		String custId = "-1";
		String acctId = "-1";
		...
		userData.setSerialNumber(param.getString("MOBILENUM"));
    ...
    {
        return new RemoteDestroyUserRequestData();
    }
