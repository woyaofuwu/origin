...
package com.asiainfo.veris.crm.order.soa.person.busi.onecardncodes.order.action;
...
public class StopAcctAdvPayrelaAction implements ITradeAction
{
     ...
     * @throws Exception
     */
    private boolean existValidPayRelation(ModifyPayRelationInfoReqData reqData, String oldAcctId) throws Exception
    {
