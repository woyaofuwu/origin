...
public class ChangePhoneSendsUser extends ChangeUserElement
{
    ...
    public void infoRegDataUser() throws Exception
    {
        ...
        grpUserInfo.setRsrvStr7(newMgrInfo);
        grpUserInfo.setRsrvStr8(newMgrPhone);
        grpUserInfo.setRsrvStr9(newAddress);
        grpUserInfo.setModifyTag(TRADE_MODIFY_TAG.MODI.getValue());
        super.addTradeUser(grpUserInfo.toData());
