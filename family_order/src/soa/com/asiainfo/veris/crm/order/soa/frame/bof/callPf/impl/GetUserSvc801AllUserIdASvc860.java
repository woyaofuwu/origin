...
/**
 * 拆分sql取数据
 * 对应 :TF_F_USER_SVC_801ALL_USER_ID_A_SVC860
 * duhj
 */
public class GetUserSvc801AllUserIdASvc860 implements ICallPfDeal{
	...
	public IDataset dealPfData(IData input) throws Exception
	{
		...
		IDataset userSvcs = Dao.qryByCode("TF_F_USER_SVC", "SEL_BY_SERVICE_ID_ALL_NEW", input, BizRoute.getRouteId());
