...
public class DealTopSetExperienceActiveFinishAction implements ITradeFinishAction{
	
	private static Logger logger = Logger.getLogger(DealTopSetExperienceActiveFinishAction.class);
