...
package com.asiainfo.veris.crm.order.soa.person.busi.broadband.nophonewidenet.nophonewidedestroy.order.trade;
...
public class NoPhoneWideDestroyUserTrade extends BaseTrade implements ITrade
{
    /**
     * 修改主台帐字段
     * 
...
//    				rsrv_date1--拆机时间，移机时间，，当拆机不退光猫的时候记录拆机时间，end_date就不修改了
			...
			{
				//退光猫这里就不处理OTHER表工单了，退光猫搬到了finish action，等到退成功后才终止。chenxy3
