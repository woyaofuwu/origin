...
public class BatMebPayrelationChgSVC extends GroupBatService
{

    public static final long serialVersionUID = 1L;

    public static final String SERVICE_NAME = "SS.MebPayrelationChgSVC.crtTrade";
    ...
    public void builderSvcData(IData batData) throws Exception
    {
        ...
        svcData.put("ACCT_ID", IDataUtil.getMandaData(condData, "ACCT_ID"));
        svcData.put("IF_SMS", IDataUtil.getMandaData(condData, "IF_SMS"));
