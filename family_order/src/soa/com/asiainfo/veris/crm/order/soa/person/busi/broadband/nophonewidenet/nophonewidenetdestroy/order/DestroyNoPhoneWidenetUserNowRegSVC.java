...
package com.asiainfo.veris.crm.order.soa.person.busi.broadband.nophonewidenet.nophonewidenetdestroy.order;
...
public class DestroyNoPhoneWidenetUserNowRegSVC extends OrderService
{

    private static final long serialVersionUID = 1L;
	private static transient Logger logger = Logger.getLogger(DestroyNoPhoneWidenetUserNowRegSVC.class);

    public String getOrderTypeCode() throws Exception
    {
        return this.input.getString("ORDER_TYPE_CODE", "685");
    }

    public String getTradeTypeCode() throws Exception
    {
        return this.input.getString("TRADE_TYPE_CODE", "685");
    }
