...
public class QueryChgUsInternetAttrParamBean extends QueryAttrParamBean
{
   
    public static IData queryInternetParamAttrForChgInit(IData param) throws Exception
    {
...
//                                user.put("pam_LINE_TRADE_NAME", tempLine.getString("LINE_NAME",""));//专线名称
            ...
            userVoipData.put("NOTIN_OLD_AttrInternet", JSONArray.fromObject(pageDataline).toString().replaceAll("\"", "\'"));
