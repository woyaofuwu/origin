...
public class QueryChgMbTtvpnAttrParamBean  extends QueryAttrParamBean
{
   
    public static IData queryTtvpnAttrForChgInit(IData param) throws Exception
    {
       ...
       // String offerCode = param.getString("OFFER_CODE");
        ...
        IDataset pzAttrItems = UItemAInfoQry.queryOfferChaAndValByCond("6750", "P", "1", null);
