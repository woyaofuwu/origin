...
public class QueryChgMbEnetAttrParamBean  extends QueryAttrParamBean
{
   
    public static IData queryEnetAttrForChgInit(IData param) throws Exception
    {
       ...
       // String offerCode = param.getString("OFFER_CODE");
        ...
        IDataset pzAttrItems = UItemAInfoQry.queryOfferChaAndValByCond("7500", "P", "1", null);
