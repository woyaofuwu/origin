...
public class QueryChgUsDatalineAttrParamBean extends QueryAttrParamBean
{
...
//                            userData.put("pam_LINE_TRADE_NAME", tempLine.getString("LINE_NAME",""));//专线名称
                ...
                userVoipData.put("VISP_INFO", JSONArray.fromObject(userDataset).toString().replaceAll("\"", "\'"));
                userVoipData.put("NOTIN_AttrInternet", JSONArray.fromObject(userDataset).toString().replaceAll("\"", "\'"));
            }
        }
