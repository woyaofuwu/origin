...
public abstract class QueryOpenUserInfo extends PersonBasePage
{
     ...
     * @throws Exception
     */
    public void queryOpenUserInfo(IRequestCycle cycle) throws Exception
    {
        ...
        // 服务返回结果集
        IDataOutput result = CSViewCall.callPage(this, "SS.SundryQrySVC.queryOpenUserInfo", inputData, page);
