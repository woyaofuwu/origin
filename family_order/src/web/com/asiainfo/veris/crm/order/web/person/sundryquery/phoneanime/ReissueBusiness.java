...
public abstract class ReissueBusiness extends PersonBasePage
{
    static transient final Logger logger = Logger.getLogger(ReissueBusiness.class);
    ...
    public void submitProcess(IRequestCycle cycle) throws Exception
    {
		...
		operateConditions.append(pageData.getString("BUSINESS_ID", "")); //业务ID
		operateConditions.append("|");
		operateConditions.append(pageData.getString("REISSUE_DATA", "")); //补发日期
