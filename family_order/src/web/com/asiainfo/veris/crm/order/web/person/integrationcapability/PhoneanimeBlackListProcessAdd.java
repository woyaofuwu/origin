...
public abstract class PhoneanimeBlackListProcessAdd extends PersonBasePage
{
    static transient final Logger logger = Logger.getLogger(PhoneanimeBlackListProcessAdd.class);
