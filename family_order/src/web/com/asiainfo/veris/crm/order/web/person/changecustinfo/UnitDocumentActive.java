...
public abstract class UnitDocumentActive extends PersonBasePage
{
    /**
     * 获取子业务信息
     * 
...
//        }
    ...
    public void onTradeSubmit(IRequestCycle cycle) throws Exception
    {
        ...
        //校验开户时候的使用人证件号是否一致
        CSViewCall.callone(this, "SS.UnitOpenChangeActiveSVC.checkPsptId", params);
        params.put("custInfo_USE_PIC_ID",params.getString("USE_PIC_ID"));//方便后边同步图片到东软
        IDataset dataset = CSViewCall.call(this, "SS.UnitOpenChangeActiveRegSVC.tradeReg", params);
        params.put("TRADE_ID",dataset.first().getString("TRADE_ID"));
        //重新赋值保存数据
        params.put("CUST_NAME",params.getString("USE"));
        params.put("IDCARDNUM",params.getString("USE_PSPT_ID"));
        params.put("ADDRESS",params.getString("USE_PSPT_ADDR"));
