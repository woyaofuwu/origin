...
public abstract class QueryOrderPlayRecord extends PersonQueryPage
{
    static transient final Logger logger = Logger.getLogger(QueryOrderPlayRecord.class);
    ...
    public void queryBaseRecord(IRequestCycle cycle) throws Exception
    {
        ...
        queryType = queryType.equals("")||queryType==null?" ":queryType; //默认为空格
        ...
        queryData.put("SVCTYPEID", "0103030402");// 服务请求分类编码
