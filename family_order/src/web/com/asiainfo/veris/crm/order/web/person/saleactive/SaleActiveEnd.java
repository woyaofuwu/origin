...
public abstract class SaleActiveEnd extends PersonBasePage
{
	private static final Logger log = Logger.getLogger(SaleActiveEnd.class);
        	  ...
        	  if(priv==false){ 
	              ...
	              if (commparaValue != null && commparaValue.size() > 0){
	              	for(int k=0;k<commparaValue.size();k++){
	              		...
	              		//log.info("("**************cxy++====paraCode1="+paraCode1+"======packId="+packId);
