...
public abstract class ThRelationInfo extends PersonBasePage
{
    /**
     * 业务历史信息 -- 关系变化
     * 
    ...
    public void queryInfo(IRequestCycle cycle) throws Exception
    {
        ...
        IDataset relationInfo = CSViewCall.call(this, "SS.GetUser360THViewSVC.qryThRelationInfo", data);

        setInfos(relationInfo);
    }
