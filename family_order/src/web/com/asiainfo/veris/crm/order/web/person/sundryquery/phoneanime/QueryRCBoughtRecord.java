...
public abstract class QueryRCBoughtRecord extends PersonQueryPage
{
    static transient final Logger logger = Logger.getLogger(QueryRCBoughtRecord.class);
    ...
    public void queryBaseRecord(IRequestCycle cycle) throws Exception
    {
        ...
        queryData.put("OPERATETYPEID", "01009");// 操作类型
