...
package com.asiainfo.veris.crm.order.web.group.grppaymark;
...
public abstract class BreakGrpPayMark extends GroupBasePage
{
     ...
     * @throws Throwable
     */
    public void qryBreakGrpPayMarkInfo(IRequestCycle cycle) throws Throwable
    {
    	 IData data = getData();
         ...
         IDataOutput markOutput = CSViewCall.callPage(this, 
        		 "SS.BreakGrpPayMarkSVC.qryBreakGrpPayMarkInfo", 
        		 inparam, 
     ...
     * @throws Throwable
     */
    public void delBreakGrpPayMark(IRequestCycle cycle) throws Throwable
    {
        // 调用服务数据
        IData svcData = new DataMap();
        IData condData = getData();
        ...
        // 调用服务
        IDataset retDataset = CSViewCall.call(this,
                "SS.BreakGrpPayMarkSVC.delCrtTrade", svcData);
