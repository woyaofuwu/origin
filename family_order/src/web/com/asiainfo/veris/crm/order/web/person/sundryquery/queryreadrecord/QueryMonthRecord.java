...
public abstract class QueryMonthRecord extends PersonQueryPage
{
    static transient final Logger logger = Logger.getLogger(QueryMonthRecord.class);
    ...
    public void queryBaseRecord(IRequestCycle cycle) throws Exception
    {
        ...
        queryData.put("SVCTYPEID", "0103030304");// 服务请求分类编码
