...
public abstract class Invoice extends CSBizTempComponent
{
    ...
    public void renderComponent(StringBuilder stringBuilder, IMarkupWriter writer, IRequestCycle cycle) throws Exception
    {
        ...
        if (isAjax)
        {
            includeScript(writer, "scripts/csserv/component/product/invoice/invoice.js");
        }
        else
        {
            this.getPage().addResAfterBodyBegin("scripts/csserv/component/product/invoice/invoice.js");
        }
