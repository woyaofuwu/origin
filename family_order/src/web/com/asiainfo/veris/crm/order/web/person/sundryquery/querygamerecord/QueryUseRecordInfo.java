...
public abstract class QueryUseRecordInfo extends PersonQueryPage
{
    static transient final Logger logger = Logger.getLogger(QueryUseRecordInfo.class);
    ...
    public void queryBaseRecord(IRequestCycle cycle) throws Exception
    {
        ...
        queryData.put("OPERATETYPEID", "01012");// 操作类型
