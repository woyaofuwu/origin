...
public abstract class CenpaySpecialAdd extends GroupBasePage
{
    ...
    * @throws Exception
    */
   public void addCenpaySpecial(IRequestCycle cycle) 
   	throws Exception
   {
       ...
       inputData.put("REMOVE_TAG", "0");
       
       IData userInfo = new DataMap();
       userInfo.put("USER_ID", userId);
       IDataset cenInfos = CSViewCall.call(this, 
          		"SS.CenpaySpecialMgrSVC.queryCenpaySpecialByUserId", 
          		userInfo);
       ...
       IDataset infos = CSViewCall.call(this, 
       		"SS.CenpaySpecialMgrSVC.addCenpaySpecial", 
       		inputData);
