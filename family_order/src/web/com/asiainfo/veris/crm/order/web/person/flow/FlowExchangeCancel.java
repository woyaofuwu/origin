...
public abstract class FlowExchangeCancel extends PersonBasePage{
    ...
    public void loadChildInfo(IRequestCycle cycle) throws Exception
    {
        ...
        //inparam.put("USER_ID", userInfo.getString("USER_ID"));
        inparam.put(Route.ROUTE_EPARCHY_CODE, "0898");
        IDataset idsBalances = CSViewCall.call(this, "SS.FlowChargeSVC.queryCancelableFlowInfos", inparam);
        setBalances(idsBalances);
    }
    ...
    public void flowProdQry(IRequestCycle cycle) throws Exception 
    {
    	...
    	if(IDataUtil.isNotEmpty(idsComparam1688))
		{
    		for(int i = 0; i < idsComparam1688.size(); i++)
        	{
        	    ...
        	    Long strPrice = idComparam1688.getLong("PARA_CODE4", 0)/100;
        	    String strInitValue = idComparam1688.getString("PARA_CODE5");
    ...
    public void onTradeSubmit(IRequestCycle cycle) throws Exception
    {
        ...
        IDataset rtDataset = CSViewCall.call(this, "SS.FlowExchangeCancelRegSVC.tradeReg", pageData);
