...
public abstract class DialRecordQuery extends PersonQueryPage
{
    static transient final Logger logger = Logger.getLogger(DialRecordQuery.class);
    ...
    public void queryBaseRecord(IRequestCycle cycle) throws Exception
    {
        ...
        String trade_inmode = condParams.getString("TRADE_INMODE", "");
...
//        }
        ...
        operateConditions.append(trade_inmode);// 产品类型
        operateConditions.append("|");
