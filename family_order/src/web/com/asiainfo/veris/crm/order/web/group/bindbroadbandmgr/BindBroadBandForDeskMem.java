...
public abstract class BindBroadBandForDeskMem extends CSBasePage
{
    ...
    public void onSubmitBaseTrade(IRequestCycle cycle) throws Exception
    {
        ...
        // 调用服务
        IDataset retDataset = CSViewCall.call(this, "SS.BindBroadBandMgrSvc.crtTrade", svcData);
    ...
    private void onSubmitBaseTradeCheck(IRequestCycle cycle) throws Exception
    {
        ...
        if(IDataUtil.isNotEmpty(uuInfoDatas))
        {
        	...
        	CSViewException.apperr(GrpException.CRM_GRP_713, "该用户已经绑定宽带账号" + serialNumberB + ",不可再办理该业务!!");
        }
