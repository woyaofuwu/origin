...
package com.asiainfo.veris.crm.order.web.person.sundryquery.mobilemap;
...
public abstract class MapOrderStaticQuery extends PersonQueryPage
{
    static transient final Logger logger = Logger.getLogger(MapOrderStaticQuery.class);
    ...
    public void queryBaseRecord(IRequestCycle cycle) throws Exception
    {
        ...
        operateConditions.append(startDate);// 操作开始时间
        operateConditions.append("|");
        operateConditions.append(endDate);// 操作结束时间
        operateConditions.append("|");
        // operateConditions.append(queryType);// 产品类型

        queryData.put("KIND_ID", "BIP2C092_T2002092_0_0");
        queryData.put("CALLERNO", serialNum);
        queryData.put("SVCTYPEID", "01020616");// 服务请求分类编码
        queryData.put("CONTACTCHANNEL", "08");// 受理渠道
        queryData.put("SERVICETYPEID", "54");// 业务类别
