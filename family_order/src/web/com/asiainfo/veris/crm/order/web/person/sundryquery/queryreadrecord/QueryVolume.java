...
public abstract class QueryVolume extends PersonQueryPage
{
    static transient final Logger logger = Logger.getLogger(QueryVolume.class);
    ...
    public void queryBaseRecord(IRequestCycle cycle) throws Exception
    {
        ...
        String bookName = condParams.getString("BOOK_NAME", ""); // 书券名
        String bookId = condParams.getString("BOOK_ID", ""); // 书券ID
        String startDate = condParams.getString("START_DATE", ""); // 用户消费开始时间
        String endDate = condParams.getString("END_DATE", ""); // 用户消费结束时间
...
//        }
        ...
        operateConditions.append("|");
        operateConditions.append(bookId);
        operateConditions.append("|");
        ...
        queryData.put("SVCTYPEID", "0103030303");// 服务请求分类编码
