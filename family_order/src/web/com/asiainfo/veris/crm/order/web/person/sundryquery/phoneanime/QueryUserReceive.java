...
public abstract class QueryUserReceive extends PersonQueryPage
{
    static transient final Logger logger = Logger.getLogger(QueryUserReceive.class);
    ...
    public void queryBaseRecord(IRequestCycle cycle) throws Exception
    {
        ...
        String serialNum = condParams.getString("PARA_CODE1", ""); //号码
