...
public abstract class GameBlackListProcessAdd extends PersonBasePage
{
    static transient final Logger logger = Logger.getLogger(GameBlackListProcessAdd.class);
