...
public abstract class OnNetSaleActiveEnd extends PersonBasePage
{
...
//            this.setAjax(elementTradeData.getDataset("SALE_GOODS"));
    ...
    public void loadBaseTradeInfo(IRequestCycle cycle) throws Exception
    {
        ...
        if(saleActives != null && saleActives.size() > 0){
            ...
            //boolean priv = true;//BUG20170919084822
...
//        	}
    ...
    /*public void saveContent(IRequestCycle cycle) throws Exception
    {
        ...
        IData data = submitData.getAttrData();
        IData svcParam = new DataMap();
        ...
        svcParam.put("RETURNFEE",data.getString("RETURNFEE"));
        svcParam.put("UPDATE_STAFF_ID",getVisit().getStaffId());
        svcParam.put("UPDATE_DEPART_ID",getVisit().getDepartId());
        svcParam.put("INST_ID",data.getString("INST_ID"));
        svcParam.put("USER_ID",data.getString("USER_ID"));
        ...
        IDataset saleActives = CSViewCall.call(this, "SS.SaleActiveEndSVC.closeOnNetSaleActives", svcParam);
        setAjax(saleActives);
    }*/
