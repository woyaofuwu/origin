...
public abstract class QueryFeeRecord extends PersonQueryPage
{
    static final transient Logger logger = Logger.getLogger(QueryFeeRecord.class);
    ...
    public void queryBaseRecord(IRequestCycle cycle) throws Exception
    {
        ...
        operateConditions.append(condParams.getString("PAYMENT_PHONE_NUM", ""));// 缴费手机号码
        operateConditions.append("|");
        operateConditions.append(condParams.getString("START_TIME", "").replaceAll("-", ""));// 开始时间
        operateConditions.append("|");
        operateConditions.append(condParams.getString("END_TIME", "").replaceAll("-", ""));// 结束时间
        operateConditions.append("|");
        operateConditions.append(condParams.getString("PAYMENT_NUM", ""));// 缴费金额
        operateConditions.append("|");
        operateConditions.append(condParams.getString("PAYMENT_TYPE", ""));// 缴费渠道

        queryData.put("KIND_ID", "BIP2C092_T2002092_0_0");
        queryData.put("CALLERNO", serialNum);
        queryData.put("SVCTYPEID", "0103030102");// 业务类别
