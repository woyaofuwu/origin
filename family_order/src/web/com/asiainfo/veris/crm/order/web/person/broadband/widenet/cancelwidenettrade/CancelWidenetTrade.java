...
public abstract class CancelWidenetTrade extends PersonBasePage
{
    ...
    {
        IData input = this.getData();
        IDataset dataset = CSViewCall.call(this, "SS.CancelWidenetTradeService.queryWideAcctType", input);
        setAjax(dataset);
    }
