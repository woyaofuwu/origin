...
public abstract class QueryPAMonthQuota extends PersonQueryPage
{
    static transient final Logger logger = Logger.getLogger(QueryPAMonthQuota.class);
    ...
    public void queryBaseRecord(IRequestCycle cycle) throws Exception
    {
        ...
        String QueryYear = condParams.getString("QueryYear", "");
        String QueryMonth = condParams.getString("QueryMonth", "");

        StringBuilder operateConditions = new StringBuilder();

        operateConditions.append(serialNum);// 手机号码
        operateConditions.append("|");
        operateConditions.append(QueryYear);// 查询年份
        operateConditions.append("|");
        operateConditions.append(QueryMonth);// 查询月份
