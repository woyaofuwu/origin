...
public abstract class MapDelOrderBlackList extends PersonBasePage
{
    static transient final Logger logger = Logger.getLogger(MapDelOrderBlackList.class);
    ...
    public void submitProcess(IRequestCycle cycle) throws Exception
    {
        ...
        inputData.put("SVCTYPEID", "01020616");// 服务请求分类编码
        inputData.put("CONTACTCHANNEL", "08");// 受理渠道
        inputData.put("SERVICETYPEID", "54");// 业务类别
