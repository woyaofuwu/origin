...
public abstract class QueryAccountBalance extends PersonQueryPage
{
    static final transient Logger logger = Logger.getLogger(QueryAccountBalance.class);
    ...
    public void queryBaseRecord(IRequestCycle cycle) throws Exception
    {
        ...
        // String tradeCode = condParams.getString("TRADE_CODE", "") ;//交易码

        StringBuilder operateConditions = new StringBuilder();

        // operateConditions.append(tradeCode);
