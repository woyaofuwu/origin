...
package com.asiainfo.veris.crm.order.web.person.sundryquery.base;
...
public abstract class BussinessBlackListQuery extends PersonQueryPage
{
    static transient final Logger logger = Logger.getLogger(BussinessBlackListQuery.class);
    ...
    public void queryBaseRecord(IRequestCycle cycle) throws Exception
    {
        ...
        queryData.put("SERVICETYPEID", "130");// 业务类别
