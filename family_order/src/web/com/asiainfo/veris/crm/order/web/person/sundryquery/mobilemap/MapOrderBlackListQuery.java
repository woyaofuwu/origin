...
public abstract class MapOrderBlackListQuery extends PersonQueryPage
{
    static transient final Logger logger = Logger.getLogger(MapOrderBlackListQuery.class);
