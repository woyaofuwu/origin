...
public abstract class CheckUserOrderAbnormalBehavior extends PersonQueryPage
{
    static transient final Logger logger = Logger.getLogger(CheckUserOrderAbnormalBehavior.class);
    ...
    public void queryBaseRecord(IRequestCycle cycle) throws Exception
    {
        ...
        operateConditions.append(condParams.getString("PARA_CODE3", "")+SysDateMgr.START_DATE_FOREVER);//开始时间
		operateConditions.append("|");
		operateConditions.append(condParams.getString("PARA_CODE4", "")+SysDateMgr.END_DATE);//结束时间
		operateConditions.append("|");
        operateConditions.append(condParams.getString("PARA_CODE1", ""));//手机号码
		operateConditions.append("|");
		operateConditions.append(condParams.getString("PARA_CODE2", ""));//应用名称
