...
public abstract class CommonQuery extends PersonQueryPage
{
    static transient final Logger logger = Logger.getLogger(CommonQuery.class);
    ...
    public void queryBaseRecord(IRequestCycle cycle) throws Exception
    {
        ...
        queryData.put("SVCTYPEID", svctypeId()==null?"0000000000":svctypeId());// 服务请求分类编码
        queryData.put("CONTACTCHANNEL", "0");// 受理渠道
        queryData.put("SERVICETYPEID", serviceTypeId());// 业务类别
        queryData.put("OPERATETYPEID", operateTypeId());// 操作类型
        queryData.put("OPERATECONDITIONS", operateConditions);
