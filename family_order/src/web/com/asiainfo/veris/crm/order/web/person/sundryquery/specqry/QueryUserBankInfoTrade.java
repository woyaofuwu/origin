...
public abstract class QueryUserBankInfoTrade extends PersonBasePage
{
     ...
     * @throws Exception
     */
    public void queryUserBankInfo(IRequestCycle cycle) throws Exception
    {
        ...
        // 服务返回结果集
        IDataOutput result = CSViewCall.callPage(this, "SS.SundryQrySVC.queryUserBankInfo", inputData, page);
