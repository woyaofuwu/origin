...
public abstract class SelectedElements extends CSBizTempComponent
{
    ...
    public void renderComponent(StringBuilder stringbuilder, IMarkupWriter writer, IRequestCycle cycle) throws Exception
    {
        ...
        if (isAjax)
        {
            includeScript(writer, "scripts/csserv/component/product/pkgelementlist/selectedelements.js");
        }
        else
        {
            this.getPage().addResBeforeBodyEnd("scripts/csserv/component/product/pkgelementlist/selectedelements.js");
        }
