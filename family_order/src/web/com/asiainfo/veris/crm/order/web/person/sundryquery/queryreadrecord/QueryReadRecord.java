...
public abstract class QueryReadRecord extends PersonQueryPage
{
    static transient final Logger logger = Logger.getLogger(QueryReadRecord.class);
    ...
    public void queryBaseRecord(IRequestCycle cycle) throws Exception
    {
        ...
        String readWay = condParams.getString("READ_WAY", "0"); // 阅读途径
        String readContent = condParams.getString("READ_CONTENT", "0"); // 内容类型
        String startDate = condParams.getString("START_DATE", ""); // 开始时间
        String endDate = condParams.getString("END_DATE", ""); // 结束时间
        String bookName = condParams.getString("BOOK_NAME", ""); // 书名
        String ChapterName = condParams.getString("CHAPTER_NAME", ""); // 章节名称
        
//        if (startDate!=""){
//        	startDate = startDate + SysDateMgr.START_DATE_FOREVER; // 开始时间
//        }
//        if (endDate!=""){
//        	endDate = endDate + SysDateMgr.END_DATE; // 结束时间
//        }
        ...
        operateConditions.append("|");
        operateConditions.append(readWay);
        operateConditions.append("|");
        operateConditions.append(readContent);
        operateConditions.append("|");
        ...
        queryData.put("SVCTYPEID", "0103030301");// 服务请求分类编码
