...
public abstract class QueryEPaper extends PersonQueryPage
{
    static final transient Logger logger = Logger.getLogger(QueryEPaper.class);
    ...
    public void queryBaseRecord(IRequestCycle cycle) throws Exception
    {
        ...
        operateConditions.append("|");
        operateConditions.append(condParams.getString("TOOLS_TYPE", ""));// 营销工具类型
        operateConditions.append("|");
        operateConditions.append(condParams.getString("TRADE_TYPE", ""));// 交易类型

        queryData.put("KIND_ID", "BIP2C092_T2002092_0_0");
        queryData.put("CALLERNO", serialNum);
        queryData.put("SVCTYPEID", "0103030103");// 业务类别
