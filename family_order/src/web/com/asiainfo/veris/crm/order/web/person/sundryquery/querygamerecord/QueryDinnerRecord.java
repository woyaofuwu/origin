...
public abstract class QueryDinnerRecord extends PersonQueryPage
{
    static transient final Logger logger = Logger.getLogger(QueryDinnerRecord.class);
...
//        }
        ...
        queryData.put("SVCTYPEID", "010303020202");// 服务请求分类编码
