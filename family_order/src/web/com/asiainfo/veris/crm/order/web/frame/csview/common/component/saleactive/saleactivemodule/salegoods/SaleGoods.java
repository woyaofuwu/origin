...
package com.asiainfo.veris.crm.order.web.frame.csview.common.component.saleactive.saleactivemodule.salegoods;
...
{
	private static final Logger logger = Logger.getLogger(SaleGoods.class);
    ...
    /**
		*REQ201604180021 chenxy3
		*/
    public abstract String getNetOrderId();
    ...
    private void renderComponentAction(StringBuilder informalParametersBuilder, IMarkupWriter writer, IRequestCycle cycle) throws Exception
    {
		...
		*REQ201604180021   chenxy3
		*/
        data.put("NET_ORDER_ID", getPage().getParameter("NET_ORDER_ID", ""));
