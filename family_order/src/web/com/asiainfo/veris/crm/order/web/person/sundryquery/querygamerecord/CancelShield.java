...
public abstract class CancelShield extends PersonBasePage
{
    static transient final Logger logger = Logger.getLogger(CancelShield.class);
    ...
    public void submitProcess(IRequestCycle cycle) throws Exception
    {
        ...
        inputData.put("OPERATETYPEID", "02004");// 操作类型
