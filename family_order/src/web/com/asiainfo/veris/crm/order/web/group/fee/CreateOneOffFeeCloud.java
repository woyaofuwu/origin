...
public abstract class CreateOneOffFeeCloud extends GroupBasePage
{
    /**
     * 业务提交
     * 
    ...
    public void onSubmitBaseTrade(IRequestCycle cycle) throws Exception
    {
        ...
        // 调用服务
        IDataset retDataset = CSViewCall.call(this, "SS.CreateOneOffFeeCloudSVC.crtTrade", svcData);
    ...
    public void qryOneFeeList(IRequestCycle cycle) throws Exception
    {
        ...
        IDataset feeList = CSViewCall.call(this, "CS.FeeInfoQrySVC.qryOneFeeCloudList", svcData);
