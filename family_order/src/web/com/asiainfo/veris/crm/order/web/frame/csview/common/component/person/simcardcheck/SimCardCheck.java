...
package com.asiainfo.veris.crm.order.web.frame.csview.common.component.person.simcardcheck;
...
public abstract class SimCardCheck extends CSBizTempComponent
{
    ...
    public void renderComponent(StringBuilder stringBuilder, IMarkupWriter writer, IRequestCycle cycle) throws Exception
    {
        ...
        getPage().addResAfterBodyBegin("scripts/csserv/component/person/simcardcheck/SimCardCheck.js");
