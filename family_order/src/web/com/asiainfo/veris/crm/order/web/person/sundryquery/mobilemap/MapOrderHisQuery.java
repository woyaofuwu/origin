...
public abstract class MapOrderHisQuery extends PersonQueryPage
{
    static transient final Logger logger = Logger.getLogger(MapOrderHisQuery.class);
