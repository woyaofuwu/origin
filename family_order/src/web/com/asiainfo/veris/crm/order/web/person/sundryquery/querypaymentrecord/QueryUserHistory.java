...
public abstract class QueryUserHistory extends PersonQueryPage
{
    static final transient Logger logger = Logger.getLogger(QueryUserHistory.class);
    ...
    public void queryBaseRecord(IRequestCycle cycle) throws Exception
    {
        ...
        operateConditions.append(condParams.getString("ACCOUNT_TYPE", ""));// 账户类型
        operateConditions.append("|");
        operateConditions.append(condParams.getString("START_TIME", "").replaceAll("-", ""));// 开户开始日期

        queryData.put("KIND_ID", "BIP2C092_T2002092_0_0");
        queryData.put("CALLERNO", serialNum);
        queryData.put("SVCTYPEID", "0103030106");// 业务类别
