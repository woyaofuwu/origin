...
package com.asiainfo.veris.crm.order.web.group.param.dataline;
                    ...
                    for (int j = 0; j < userAttrInfo.size(); j++)
                    {
                        ...
                        if (esopdataline.getString("PRODUCTNO").equals(userAttrData.getString("RSRV_STR7")))
                        {
                            ...
                            if(IDataUtil.isNotEmpty(userDataline)){
                                ...
                                userData.put("pam_LINE_TRADE_NAME", tradeName);//专线名称
                            } else {
                            ...
                            userData.put("pam_NOTIN_GROUP_CITY", userAttrData.get("RSRV_STR14"));
                            userData.put("pam_NOTIN_A_CITY", userAttrData.get("RSRV_STR15"));
                            userData.put("pam_NOTIN_Z_CITY", userAttrData.get("RSRV_STR16"));
                            userData.put("pam_NOTIN_GROUP_PERCENT", userAttrData.get("RSRV_STR17"));
                            userData.put("pam_NOTIN_A_PERCENT", userAttrData.get("RSRV_STR18"));
                            userData.put("pam_NOTIN_Z_PERCENT", userAttrData.get("RSRV_STR19"));
                            //add by chenzg@20180620
                            userData.put("pam_NOTIN_SOFTWARE_PRICE", userAttrData.get("RSRV_STR8"));	//软件应用服务费
                            userData.put("pam_NOTIN_NET_PRICE", userAttrData.get("RSRV_STR10"));		//网络技术支持服务费
...
//                                    userData.put("pam_LINE_TRADE_NAME", tempLine.getString("LINE_NAME",""));//专线名称
                                    ...
                                    userData.put("pam_NOTIN_GROUP_PERCENT",tempLine.getString("RSRV_STR6","20%"));//集团所在市县分成比例
                                    userData.put("pam_NOTIN_A_PERCENT",tempLine.getString("RSRV_STR7","40%"));//A端所在市县分成比例
                                    userData.put("pam_NOTIN_Z_PERCENT",tempLine.getString("RSRV_STR8","40%"));//Z端所在市县分成比例
                                    //add by chenzg@20180620
                                    userData.put("pam_NOTIN_SOFTWARE_PRICE",tempLine.getString("RSRV_STR11","0"));//软件应用服务费
                                    userData.put("pam_NOTIN_NET_PRICE",tempLine.getString("RSRV_STR12","0"));//网络技术支持服务费
                                }
                            }
                ...
                if(null != datalineData && datalineData.size() > 0){
                    ...
                    for (int i = 0; i < datalineData.size(); i++)
                    {
                        ...
                        user.put("pam_NOTIN_A_CITY", cityA);
                        user.put("pam_NOTIN_Z_CITY", cityZ);

                        user.put("pam_LINE_TRADE_NAME", dataline.getString("TRADENAME",""));//专线名称
                        //add by chenzg@20180620
                        user.put("pam_NOTIN_SOFTWARE_PRICE", "0");	//软件应用服务费
                        user.put("pam_NOTIN_NET_PRICE", "0");		//网络技术支持服务费
...
//                                user.put("pam_LINE_TRADE_NAME", tempLine.getString("LINE_NAME",""));//专线名称
                                ...
                                user.put("pam_NOTIN_GROUP_PERCENT",tempLine.getString("RSRV_STR6","20%"));//集团所在市县分成比例
                                user.put("pam_NOTIN_A_PERCENT",tempLine.getString("RSRV_STR7","40%"));//A端所在市县分成比例
                                user.put("pam_NOTIN_Z_PERCENT",tempLine.getString("RSRV_STR8","40%"));//Z端所在市县分成比例
                                //add by chenzg@20180620
                                user.put("pam_NOTIN_SOFTWARE_PRICE",tempLine.getString("RSRV_STR11","0"));//软件应用服务费
                                user.put("pam_NOTIN_NET_PRICE",tempLine.getString("RSRV_STR12","0"));//网络技术支持服务费
                            }
                        }
