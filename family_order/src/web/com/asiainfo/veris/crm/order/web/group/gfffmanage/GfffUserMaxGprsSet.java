...
public abstract class GfffUserMaxGprsSet extends GroupBasePage
{
     ...
     * @Date:2017-8-29
     */
    public void queryGfffMaxGprsSetting(IRequestCycle cycle) throws Throwable
    {
    	 IData data = getData();
         ...
         IDataOutput markOutput = CSViewCall.callPage(this, "SS.GfffUserMaxGprsSetSVC.qryGfffUserMaxGprsSetInfo", inparam, getPagination("ratioNavBar"));
     ...
     * @Date:2017-8-29
     */
    public void submitSetting(IRequestCycle cycle) throws Throwable
    {
        // 调用服务数据
        IData svcData = new DataMap();
        IData condData = getData();
        ...
        // 调用服务
        IDataset retDataset = CSViewCall.call(this, "SS.GfffUserMaxGprsSetSVC.crtTrade", svcData);
