package com.asiainfo.veris.crm.order.web.person.unpaidorderdeal;
...
public abstract class UnPaidOrderDeal extends PersonBasePage
{
	...
	public void init(IRequestCycle cycle)throws Exception
	{
		...
		condition.put("cond_START_DATE", SysDateMgr.getAddHoursDate(SysDateMgr.getSysDate(), -72));
