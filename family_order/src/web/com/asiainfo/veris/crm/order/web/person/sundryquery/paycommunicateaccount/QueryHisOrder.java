package com.asiainfo.veris.crm.order.web.person.sundryquery.paycommunicateaccount;
...
public abstract class QueryHisOrder extends PersonQueryPage
{
    static transient final Logger logger = Logger.getLogger(QueryHisOrder.class);
    ...
    public void queryBaseRecord(IRequestCycle cycle) throws Exception
    {
        ...
        operateConditions.append(startDate + " 00:00:00");
        operateConditions.append("|");
        operateConditions.append(endDate + " 23:59:59");
        ...
        queryData.put("SERVICETYPEID", "70");// 业务类别
