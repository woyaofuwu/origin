...
public abstract class QueryOrderRecord extends PersonQueryPage
{
    ...
    public void queryBaseRecord(IRequestCycle cycle) throws Exception
    {
		...
		operateConditions.append("|");
		operateConditions.append(condParams.getString("PARA_CODE3", ""));//企业代码
		operateConditions.append("|");
		operateConditions.append(condParams.getString("PARA_CODE4", "")+SysDateMgr.START_DATE_FOREVER);//开始时间
		operateConditions.append("|");
		operateConditions.append(condParams.getString("PARA_CODE5", "")+SysDateMgr.END_DATE);//结束时间
