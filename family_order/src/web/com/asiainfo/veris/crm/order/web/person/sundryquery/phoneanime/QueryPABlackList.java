...
public abstract class QueryPABlackList extends PersonQueryPage
{
    static transient final Logger logger = Logger.getLogger(QueryPABlackList.class);
    ...
    public void queryBaseRecord(IRequestCycle cycle) throws Exception
    {
        ...
        String blackType = condParams.getString("PARA_CODE2", ""); // 类型
