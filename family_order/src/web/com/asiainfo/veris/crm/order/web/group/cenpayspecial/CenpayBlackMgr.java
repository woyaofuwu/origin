...
public abstract class CenpayBlackMgr extends GroupBasePage
{
     ...
     * @throws Exception
     */
    public void queryCenpayBlackList(IRequestCycle cycle) throws Exception
    {
        ...
        data.put("BLACK_TAG", condData.getString("STATUS"));
        
        IDataOutput outPut = CSViewCall.callPage(this, 
        		"SS.CenpayBlackMgrSVC.queryCenpayBlackList", 
        		data, 
     ...
     * @throws Exception
     */
    public void delCenpayBlackByUserId(IRequestCycle cycle) 
    	throws Exception
    {
    	IData data = getData();
        ...
        IDataset infos = CSViewCall.call(this, 
        		"SS.CenpayBlackMgrSVC.delCenpayBlackByUserId", 
        		inputData);
        setCondition(data);
        setAjax(infos);
    }
     ...
     * @throws Exception
     */
    public void updateCenpayBlackByUserId(IRequestCycle cycle) 
    	throws Exception
    {
        ...
        String blackTag = pageData.getString("EBLACK_TAG","");
        inputData.put("USER_ID", userId);
        inputData.put("BLACK_TAG", blackTag);
        
        IDataset infos = CSViewCall.call(this, 
        		"SS.CenpayBlackMgrSVC.updateCenpayBlackByUserId", 
        		inputData);
