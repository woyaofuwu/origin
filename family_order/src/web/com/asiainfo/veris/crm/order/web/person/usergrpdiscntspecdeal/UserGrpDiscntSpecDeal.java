...
package com.asiainfo.veris.crm.order.web.person.usergrpdiscntspecdeal;
 ...
 */
public abstract class UserGrpDiscntSpecDeal extends PersonBasePage
{
    /**
    ...
    public void getUserDiscntList(IRequestCycle cycle) throws Exception
    {
        ...
        IData discntData = CSViewCall.call(this, "SS.UserGrpDiscntSpecDealSVC.getUserDiscntList", data).getData(0);
    ...
    public void onTradeSubmit(IRequestCycle cycle) throws Exception
    {
        ...
        data.put(Route.ROUTE_EPARCHY_CODE, data.getString("EPARCHY_CODE", getTradeEparchyCode()));
        CSViewCall.call(this, "SS.UserGrpDiscntSpecDealSVC.isExistsMainDiscntPriv", data);
        ...
        if (IDataUtil.isNotEmpty(specDiscntList))
        {
            ...
            IDataset result = CSViewCall.call(this, "SS.UserGrpDiscntSpecDealRegSVC.tradeReg", input);
