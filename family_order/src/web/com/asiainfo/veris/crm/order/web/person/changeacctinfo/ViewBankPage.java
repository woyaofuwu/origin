...
public abstract class ViewBankPage extends PersonBasePage
{
    ...
    public void queryBank(IRequestCycle cycle) throws Exception
    {
        ...
        data.putAll(temp);
        IDataset dataset = CSViewCall.call(this, "SS.ModifyAcctInfoSVC.queryBankInfoBySup", data);
    ...
    public void queryBankInfo(IRequestCycle cycle) throws Exception
    {
        ...
        IDataset dataset = CSViewCall.call(this, "SS.ModifyAcctInfoSVC.queryBurBankInfo", data);
        if (IDataUtil.isNotEmpty(dataset))
        {
            setInfos(dataset);
        }
