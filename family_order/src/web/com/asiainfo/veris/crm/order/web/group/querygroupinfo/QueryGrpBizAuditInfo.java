...
public abstract class QueryGrpBizAuditInfo extends GroupBasePage
{
    ...
    {
        IData data = getData();
        data.put("AUDIT_STAFF_ID", this.getVisit().getStaffId());
    ...
    public void submitAudit(IRequestCycle cycle) throws Throwable
    {
        ...
        CSViewCall.call(this, "SS.QueryGrpBizAuditInfoSVC.dealSubmitAudit", inparams);
     ...
     * @date 2018-10-25
     */
    public void submitTransfer(IRequestCycle cycle) throws Throwable
    {
    	IData pgData = this.getData();
        IData inparams = new DataMap();
        inparams.put("AUDIT_INFOS", pgData.getString("AUDIT_INFOS", "[]"));      
        ...
        inparams.put("TRADE_EPARCHY_CODE", "0898");
        inparams.put("ROUTE_EPARCHY_CODE", "0898");
        CSViewCall.call(this, "SS.QueryGrpBizAuditInfoSVC.submitTransfer", inparams);
