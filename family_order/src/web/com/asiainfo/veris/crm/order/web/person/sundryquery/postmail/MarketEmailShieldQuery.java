...
package com.asiainfo.veris.crm.order.web.person.sundryquery.postmail;
...
public abstract class MarketEmailShieldQuery extends PersonQueryPage
{
    static transient final Logger logger = Logger.getLogger(MarketEmailShieldQuery.class);
    ...
    public void queryBaseRecord(IRequestCycle cycle) throws Exception
    {
        ...
        operateConditions.append(serialNum);// 邮箱账号

        queryData.put("KIND_ID", "BIP2C092_T2002092_0_0");
        queryData.put("CALLERNO", serialNum);
        queryData.put("SVCTYPEID", "01020601");// 服务请求分类编码
