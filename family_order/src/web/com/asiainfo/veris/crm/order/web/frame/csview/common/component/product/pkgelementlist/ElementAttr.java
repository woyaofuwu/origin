...
public abstract class ElementAttr extends CSBizTempComponent 
{
    ...
    public void renderComponent(StringBuilder builder, IMarkupWriter writer, IRequestCycle cycle) throws Exception
    {
        ...
        if (isAjax)
        {
            includeScript(writer, "scripts/csserv/component/product/pkgelementlist/elementattr.js");
        }
        else
        {
            this.getPage().addResBeforeBodyEnd("scripts/csserv/component/product/pkgelementlist/elementattr.js");
        }
