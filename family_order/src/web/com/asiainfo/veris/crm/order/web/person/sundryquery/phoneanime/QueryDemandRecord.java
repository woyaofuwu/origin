...
public abstract class QueryDemandRecord extends PersonQueryPage
{
    static transient final Logger logger = Logger.getLogger(QueryDemandRecord.class);
    ...
    public void queryBaseRecord(IRequestCycle cycle) throws Exception
    {
        ...
        // BIP2B322_T2001322_0_0
        // BIP2C092_T2002092_0_0
