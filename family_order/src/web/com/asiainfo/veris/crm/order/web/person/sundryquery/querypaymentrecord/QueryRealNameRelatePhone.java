...
public abstract class QueryRealNameRelatePhone extends PersonQueryPage
{
    static final transient Logger logger = Logger.getLogger(QueryRealNameRelatePhone.class);
    ...
    public void queryBaseRecord(IRequestCycle cycle) throws Exception
    {
        ...
        result.put("CALLERNO", idCardNo);// 用户身份证号
