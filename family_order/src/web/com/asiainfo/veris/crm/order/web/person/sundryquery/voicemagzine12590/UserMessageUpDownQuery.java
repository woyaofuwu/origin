...
public abstract class UserMessageUpDownQuery extends PersonQueryPage
{
    static transient final Logger logger = Logger.getLogger(UserMessageUpDownQuery.class);
