package com.asiainfo.veris.crm.order.web.group.bat.batchangegfffmember;
...
public abstract class BatChangeGfffMember extends GroupBasePage
{
    ...
    public void queryGroupOrderProduct(IRequestCycle cycle) throws Throwable
    {
        ...
        //流量自由充叠加包办理设置为立即生效
        if ("DJBGFFFDINGEMEMBER".equals(batchOperType) || "DJBGFFFLIMITAIONMEM".equals(batchOperType))
        {
