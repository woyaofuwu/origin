...
public abstract class BussinessBlackListProcess extends PersonQueryPage {

	static transient final Logger logger = Logger.getLogger(BussinessBlackListProcess.class);
	...
	public void submitProcess(IRequestCycle cycle) throws Exception {
		...
		operateConditions.append(pageData.getString("SUBMIT_MODE2", "")); //黑名单有效期
		operateConditions.append("|");
		...
		inputData.put("SUBMIT_MODE2", operBusi);// 此参数记录操作日志
