...
public abstract class QueryOrderRecord extends PersonQueryPage
{
    static transient final Logger logger = Logger.getLogger(QueryOrderRecord.class);
    ...
    public void queryBaseRecord(IRequestCycle cycle) throws Exception
    {
		...
		operateConditions.append("|");
		operateConditions.append(condParams.getString("PARA_CODE3", ""));//开始时间
		operateConditions.append("|");
		operateConditions.append(condParams.getString("PARA_CODE4", ""));//结束时间
		operateConditions.append("|");
        operateConditions.append(condParams.getString("PARA_CODE5", ""));//业务线
