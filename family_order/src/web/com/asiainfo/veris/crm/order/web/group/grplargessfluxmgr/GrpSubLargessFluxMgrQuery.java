...
public abstract class GrpSubLargessFluxMgrQuery extends GroupBasePage
{
    ...
    public void queryInfos(IRequestCycle cycle) throws Exception
    {
        ...
        param.put("SERIAL_NUMBER_A", inputParam.getString("SERIAL_NUMBER_A"));
        param.put("SERIAL_NUMBER_B", inputParam.getString("SERIAL_NUMBER_B"));
        ...
        IDataOutput dataOutput = CSViewCall.callPage(this, 
                   "SS.LargessFluxGrpMainSVC.qryUserGrpSubGfffInfo", param, getPagination("PageNav"));
