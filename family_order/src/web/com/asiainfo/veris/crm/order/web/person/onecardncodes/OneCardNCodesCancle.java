...
public abstract class OneCardNCodesCancle extends PersonBasePage
{
    ...
    public void loadChildInfo(IRequestCycle cycle) throws Exception
    {
        ...
        IDataset output = CSViewCall.call(this, "SS.OneCardNCodesCancleSVC.checkInfos", userInfo);
    ...
    public void onTradeSubmit(IRequestCycle cycle) throws Exception
    {
        ...
        data.put("SIM_CARD_NO_O", data.getString("SIM_CARD_NO_O"));
        data.put("SIM_CARD_NO_M", data.getString("SIM_CARD_NO_M"));

        IDataset dataset = CSViewCall.call(this, "SS.OneCardNCodesCancleSVC.tradeReg", data);
        setAjax(dataset);
    }
