...
package com.asiainfo.veris.crm.order.web.frame.csview.common.component.saleactive.saleactivemodule.saledeposit;
...
{
	private static final Logger logger = Logger.getLogger(SaleDeposit.class);
