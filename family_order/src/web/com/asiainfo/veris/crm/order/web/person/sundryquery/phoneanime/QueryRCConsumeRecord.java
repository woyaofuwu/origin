...
public abstract class QueryRCConsumeRecord extends PersonQueryPage
{
    static transient final Logger logger = Logger.getLogger(QueryRCConsumeRecord.class);
    ...
    public void queryBaseRecord(IRequestCycle cycle) throws Exception
    {
        ...
        String userAccount = condParams.getString("PARA_CODE1", "");
        String accountType = condParams.getString("ACCOUNT_TYPE", "");
        ...
        operateConditions.append(userAccount);// 用户账户
        operateConditions.append("|");
        operateConditions.append(accountType);// 账户类型
        operateConditions.append("|");
        ...
        queryData.put("CALLERNO", userAccount);
        queryData.put("SVCTYPEID", "0103030704");// 服务请求分类编码
        ...
        result.put("CALLERNO", userAccount);
