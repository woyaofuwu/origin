...
public abstract class FamilyBusiManage extends PersonBasePage
{
    ...
    public void onTradeSubmit(IRequestCycle cycle) throws Exception
    {
        ...
        if(tradeOption.contains("CREATE")){
