...
public abstract class CttQryBankFeeReg extends PersonBasePage
{
     ...
     * @throws Exception
     */
    public void initQryBankFeeRegCTT(IRequestCycle cycle) throws Exception
    {
     ...
     * 查询后设置页面信息
     */
    public void qryBankFeeRegCTT(IRequestCycle cycle) throws Exception
    {
        ...
        result = CSViewCall.callPage(this, "SS.CttQryBankFeeRegSVC.qryBankFeeRegCTT", param, getPagination("cttinfo"));
     ...
     * 查询后设置页面信息
     */
    public void qryBankFeeRegMCtt(IRequestCycle cycle) throws Exception
    {
