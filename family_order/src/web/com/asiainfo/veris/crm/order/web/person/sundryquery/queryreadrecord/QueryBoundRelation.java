...
public abstract class QueryBoundRelation extends PersonQueryPage
{
    static transient final Logger logger = Logger.getLogger(QueryBoundRelation.class);
    ...
    public void initPage(IRequestCycle cycle) throws Exception
    {
        ...
        data.put("PARA_CODE", data.getString("SERIAL_NUMBER", ""));
    ...
    public void queryBaseRecord(IRequestCycle cycle) throws Exception
    {
        ...
        String serialNum = condParams.getString("PARA_CODE", "");// 计费卡号
        ...
        queryData.put("SVCTYPEID", "0103030306");// 服务请求分类编码
