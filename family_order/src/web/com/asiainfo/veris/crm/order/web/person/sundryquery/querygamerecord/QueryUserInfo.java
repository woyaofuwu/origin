...
public abstract class QueryUserInfo extends PersonQueryPage
{
    static transient final Logger logger = Logger.getLogger(QueryUserInfo.class);
    ...
    public void queryBaseRecord(IRequestCycle cycle) throws Exception
    {
      ...
      //用户手机号码|类型  例如:15116387719|0
        ...
        queryData.put("SVCTYPEID", "010303020402");// 服务请求分类编码
        ...
        result.put("CALLERNO", condParams.getString("PHONE_NUM", ""));
