...
package com.asiainfo.veris.crm.order.web.group.bat.importblackwhitebat;
...
public abstract class BlackWhiteBatCond extends GroupBasePage
{
    ...
    public void refreshProduct(IRequestCycle cycle) throws Exception
    {
        ...
        condition.put("MEB_PRODUCT_ID", mebProductId);// 
