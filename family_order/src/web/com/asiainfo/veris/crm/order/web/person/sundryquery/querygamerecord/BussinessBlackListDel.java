...
public abstract class BussinessBlackListDel extends PersonBasePage
{
    static transient final Logger logger = Logger.getLogger(BussinessBlackListDel.class);
    ...
    public void submitProcess(IRequestCycle cycle) throws Exception
    {
        ...
        String reason = pageData.getString("REASON", "");// 删除原因
