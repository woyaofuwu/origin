...
public abstract class GrpCautionFeeCancel extends GroupBasePage
{
    ...
    public abstract void setDepositInfos(IDataset depositInfos);
    ...
    * @throws Exception
    */
   public void cancelGrpCautionFee(IRequestCycle cycle) throws Exception
   {
       ...
       if(feeInfos.size() > 0){
    	   for(int i=0; i < feeInfos.size(); i++){
    		   ...
    		   if(depositType.equals(feeInfo.getString("DEPOSIT_TYPE"))){
        	       ...
        	       {
        	    	   CSViewException.apperr(GrpException.CRM_GRP_713,"请输入正确的保证金清退金额!");
        	       }
    		   }
    	   }
       }
       ...
       IDataset infos = CSViewCall.call(this, 
    		   "SS.GrpCautionFeeMgrSVC.crtTradeCancel", 
    		   svcData);
