...
public abstract class QueryOneOffFeeCloud extends GroupBasePage
{
    /**
     * 查询费用信息
     * 
    ...
    public void qryOneFeeList(IRequestCycle cycle) throws Exception
    {
        ...
        IDataOutput dataOutput = CSViewCall.callPage(this, "CS.FeeInfoQrySVC.qryOneFeeCloudList", svcData, getPagination("pageNavTrade"));
