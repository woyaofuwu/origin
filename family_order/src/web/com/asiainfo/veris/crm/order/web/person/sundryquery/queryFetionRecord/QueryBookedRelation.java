...
public abstract class QueryBookedRelation extends PersonQueryPage
{
    static transient final Logger logger = Logger.getLogger(QueryBookedRelation.class);
    ...
    public void queryBaseRecord(IRequestCycle cycle) throws Exception
    {
        ...
        queryData.put("SERVICETYPEID", "135");// 业务类别:135融合通信业务客服系统(和飞信)
