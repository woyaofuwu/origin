 ...
 * 用户动态策略计费控制信息导入
 */
public abstract class InformationManage extends PersonBasePage
{
    private static Logger logger = Logger.getLogger(InformationManage.class);
    ...
    public void loadChildInfo(IRequestCycle cycle) throws Exception
    {
        ...
        IDataset infos = CSViewCall.call(this, "SS.InformationManageSVC.getInformationByUserId", pageData);
    ...
    public void onTradeSubmit(IRequestCycle cycle) throws Exception
    {
        ...
        IDataset dataset = CSViewCall.call(this, "SS.InformationManageRegSVC.tradeReg", data);
        setAjax(dataset);
    }
