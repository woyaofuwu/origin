...
package com.asiainfo.veris.crm.order.web.person.broadband.nophonewidenet.nophonewidedestroy;
 ...
 * 用户立即销户
 */
public abstract class NoPhoneWideDestroySpe extends PersonBasePage
{
...
//        setAjax(param);
        ...
        //CSViewCall.callone(this, "SS.NoPhoneTopSetBoxSVC.queryTopSetBoxInfoByWsn", data);
        ...
        if( installFeeTag ){
        		if(IDataUtil.isNotEmpty(topsetboxInfo))
        	    {
	        		...
	        		topsetboxInfo.put("FEE_TYPE_CODE", "510");
