...
public abstract class QueryBussinessBlack extends PersonQueryPage
{
    static transient final Logger logger = Logger.getLogger(QueryBussinessBlack.class);
    ...
    public void queryBaseRecord(IRequestCycle cycle) throws Exception
    {
        ...
        queryData.put("SVCTYPEID", "0103030404");// 服务请求分类编码
