...
public abstract class VideoBlackListProcess extends PersonBasePage
{
    static transient final Logger logger = Logger.getLogger(VideoBlackListProcess.class);
    ...
    {   	
        ...
        inputData.put("SUBMIT_MODE3", operType);// 此参数记录操作日志
