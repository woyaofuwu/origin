...
public abstract class DeleteBlacklist extends PersonBasePage {
	static transient final Logger logger = Logger.getLogger(DeleteBlacklist.class);
	...
	public void submitProcess(IRequestCycle cycle) throws Exception {
		...
		String delCause = pageData.getString("DEL_CAUSE", "");//解除原因
		...
		operateConditions.append(delCause); //解除原因
		...
		inputData.put("SERVICETYPEID", "70");// 业务类别
