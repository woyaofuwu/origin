...
public abstract class QueryMdoOrderRelate extends PersonQueryPage
{
    static transient final Logger logger = Logger.getLogger(QueryMdoOrderRelate.class);
    ...
    public void queryBaseRecord(IRequestCycle cycle) throws Exception
    {
        ...
        String startDate = condParams.getString("START_DATE", ""); // 查询开始时间
        String endDate = condParams.getString("END_DATE", ""); // 查询结束时间
        String queryType = condParams.getString("QUERY_TYPE", ""); // 查询类型
        ...
        operateConditions.append("|");
        operateConditions.append(queryType);
        ...
        queryData.put("SERVICETYPEID", queryType.equals("3")?"56":"47");// 业务类别
