...
public abstract class SetOrderBlackList extends PersonBasePage{
	...
	public void submitProcess(IRequestCycle cycle) throws Exception {
		...
		operateConditions.append(pageData.getString("SUBMIT_MODE2", "1")); //动作标志
		operateConditions.append("|");
		operateConditions.append(pageData.getString("SUBMIT_MODE3", "20991231235959")); //黑名单有效期
		...
		inputData.put("SVCTYPEID", "01010557");// 服务请求分类编码
		inputData.put("CONTACTCHANNEL", "08");// 受理渠道
		inputData.put("SERVICETYPEID", "163");// 业务类别
	...
	public abstract void setCond(IData pageData);
}
