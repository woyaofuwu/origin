 ...
 * 无手机魔百合报停
 */
public abstract class NoPhoneStopTopSetBox extends PersonBasePage {
	...
	public void loadPageInfo(IRequestCycle cycle) throws Exception {
		...
		IDataset dataset = CSViewCall.call(this,
				"SS.NoPhoneTopSetBoxSVC.checkUserValidForStopTopsetbox", data);
	...
	public void onTradeSubmit(IRequestCycle cycle) throws Exception {
		...
		data.put("STOP_ACTION", "0");   // 报停标记； 0：主动报停  ，1：欠费报停
		data.put(Route.ROUTE_EPARCHY_CODE, getTradeEparchyCode());
		IDataset dataset = CSViewCall.call(this,
				"SS.NoPhoneStopTopSetBoxRegSVC.tradeReg", data);
		setAjax(dataset);
