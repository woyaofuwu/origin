...
public abstract class QueryGreyList extends PersonQueryPage {

	static transient final Logger logger = Logger.getLogger(QueryGreyList.class);
	...
	public void closePage(IRequestCycle cycle) throws Exception {
		...
		if (indictSeq != null && ("0".equals(pageData.getString("PIGEONHOLE")))) {
			infos = CSViewCall.call(this, "SS.BaseCommRecordSVC.subClosePage",
					pageData);
		}
		setAjax(infos);
	}
	...
	public void queryBaseRecord(IRequestCycle cycle) throws Exception {
		...
		IDataset infos = CSViewCall.call(this,
				"SS.BaseCommRecordSVC.subBussQureySerive", queryData);
	...
	public void queryOtherRecord(IRequestCycle cycle) throws Exception {
		...
		IDataset infos = CSViewCall.call(this,
				"SS.BaseCommRecordSVC.subUnfinishBussQureySerive", pageData);
