...
public abstract class ADCPersonalOrderQuery extends CSBasePage
{
    ...
    public void queryInfos(IRequestCycle cycle) throws Exception
    {
        ...
        String bizCode = condData.getString("cond_BIZ_CODE");
        ...
        IDataOutput dataOutput = CSViewCall.callPage(this, "SS.GroupInfoQuerySVC.qryADCPersonalOrderInfo", param, getPagination());
