...
public abstract class QueryAdapterTypeRecord extends PersonQueryPage
{
    static transient final Logger logger = Logger.getLogger(QueryAdapterTypeRecord.class);
    ...
    public void queryBaseRecord(IRequestCycle cycle) throws Exception
    {
        ...
        queryData.put("SVCTYPEID", "0103030403");// 服务请求分类编码
