...
public abstract class QueryChargeRecord extends PersonQueryPage
{
    static transient final Logger logger = Logger.getLogger(QueryChargeRecord.class);
    ...
    public void queryBaseRecord(IRequestCycle cycle) throws Exception
    {
        ...
        queryData.put("SVCTYPEID", "01030302020401");// 服务请求分类编码
