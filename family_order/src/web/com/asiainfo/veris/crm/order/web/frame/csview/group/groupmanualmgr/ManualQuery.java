...
/**
 * @author chenkh 2014-8-4
 */

public abstract class ManualQuery extends CSBasePage
{
    ...
    public void pageBeginRender(PageEvent event)
    {
        ...
        try
        {
            IData param = getData();
            // 初始化时间
            String time = SysDateMgr.getDateByTimeMillis(System.currentTimeMillis(), "yyyy-MM-dd");
            param.put("cond_START_DATE", time);
            param.put("cond_END_DATE", time);
            setCondition(param);
        }
        catch (Exception e)
        {
