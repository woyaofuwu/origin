...
public abstract class QueryBlackLogRecord extends PersonQueryPage
{
    static transient final Logger logger = Logger.getLogger(QueryBlackLogRecord.class);
    ...
    public void queryBaseRecord(IRequestCycle cycle) throws Exception
    {
        ...
        queryData.put("SVCTYPEID", "0103030502");// 服务请求分类编码
