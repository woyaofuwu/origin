...
public class ProductExplain extends BaseTempComponent
{
    ...
    protected void renderComponent(IMarkupWriter writer, IRequestCycle cycle)
    {
        ...
        if (cycle.isRewinding())
            return;
        cycle.getPage().addResAfterBodyBegin("scripts/csserv/component/group/product/productexplain/ProductExplain.js");
