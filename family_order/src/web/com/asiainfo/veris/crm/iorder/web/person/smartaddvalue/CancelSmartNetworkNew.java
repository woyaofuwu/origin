...
public abstract class CancelSmartNetworkNew extends PersonBasePage {
    /**
     * 初始化方法
     *
     * @param cycle
...
//        setCancelTradeTypeList(cancelTradeTypes);
   ...
   /* public void queryAcctType(IRequestCycle cycle) throws Exception{
    ...
    public void queryCancelTradeList(IRequestCycle cycle) throws Exception {
        ...
        IDataset results = CSViewCall.call(this, "SS.CancelSmartNetworkRegSVC.queryUserCancelTradeMerge", pagedata);
    ...
    public abstract void setCancelTradeList(IDataset list);
