...
package com.asiainfo.veris.crm.iorder.web.merch.component.auth;
...
public abstract class MerchAuth extends CSBizTempComponent
{
...
//        }
       //根据TRADE_TYPE_CODE进行拦截配置 0 不拦截  默认   1拦截，
		...
		userInfo.put("USER_STATE_CODESET_NAME", StaticUtil.getStaticValue("USER_STATE_CODESET",userInfo.getString("USER_STATE_CODESET")));
        String userId=userInfo.getString("USER_ID");
        String custId=userInfo.getString("CUST_ID");
    ...
    public void renderComponent(StringBuilder infoParamsBuilder, IMarkupWriter writer, IRequestCycle cycle) throws Exception
    {
        ...
        if (null == action || "".equals(action))
        {
             ...
             * 组件初始化载入认证的脚本
             */
            getPage().addResAfterBodyBegin("scripts/merch/auth/MerchAuth.js");
            getPage().addResAfterBodyBegin("scripts/iorder/icsserv/component/person/CommLib.js");
            getPage().addResAfterBodyBegin("scripts/merch/tradecheck/MerchTradeCheck.js");
