...
public abstract class FamilyUpdateNew extends PersonBasePage
{
    ...
    public void loadInfo(IRequestCycle cycle) throws Exception
    {
        ...
        IData loadInfo = CSViewCall.call(this, "SS.FamilyCreateSVC.loadUpdateFamilyInfo", pageData).getData(0);
    ...
    public void onTradeSubmit(IRequestCycle cycle) throws Exception
    {
        ...
        IDataset rtDataset = CSViewCall.call(this, "SS.UpdateFamilyRegSVC.tradeReg", pageData);
