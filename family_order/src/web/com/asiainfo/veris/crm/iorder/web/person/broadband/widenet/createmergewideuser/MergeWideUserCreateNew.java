...
package com.asiainfo.veris.crm.iorder.web.person.broadband.widenet.createmergewideuser;
...
public abstract class MergeWideUserCreateNew extends PersonBasePage
{
    /**
     * 初始化方法
     * 
    ...
    public void onInitTrade(IRequestCycle clcle) throws Exception
    {
        ...
        //获取宽带预约页面传值预约订单号
        param.put("BOOK_ID", data.getString("book_id", ""));
  ...
  //add by zhangxing3 for BUS201907310012关于开发家庭终端调测费的需求     
    ...
    public void onTradeSubmit(IRequestCycle cycle) throws Exception
    {
        ...
        String bookid = data.getString("BOOK_ID");
