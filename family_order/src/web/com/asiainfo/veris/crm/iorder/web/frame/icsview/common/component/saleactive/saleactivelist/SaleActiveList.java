...
package com.asiainfo.veris.crm.iorder.web.frame.icsview.common.component.saleactive.saleactivelist;
...
public abstract class SaleActiveList extends CSBizTempComponent
{
    ...
    {
        getPage().addResAfterBodyBegin("scripts/iorder/icsserv/component/saleactive/saleactivelist/saleactivelist.js");
    ...
    private void renderComponentAction(String productId, String newImei, String searchContent, String isIphone6, String iphone6Imei) throws Exception
    {
        ...
        if (StringUtils.isNotBlank(productId) || StringUtils.isNotBlank(newImei) || StringUtils.isNotBlank(searchContent) ||
                StringUtils.isNotBlank(isIphone6)|| StringUtils.isNotBlank(iphone6Imei)) {
            IData data = getPage().getData();
            String mulChannelTag = getPage().getParameter("MUL_CHANNEL_TAG", "0");
            String querySaleActivesSvc ;
            if("1".equals(mulChannelTag)){
                querySaleActivesSvc = "CS.SaleActiveQuerySVC.queryCreditPurchasesSaleActives";
                if (StringUtils.isNotBlank(newImei)) {
                    querySaleActivesSvc = "CS.SaleActiveQuerySVC.queryCreditPurchasesSaleActivesByImei";
                }
            }else{
                querySaleActivesSvc = "CS.SaleActiveQuerySVC.querySaleActives";
                if (StringUtils.isNotBlank(newImei)) {
    ...
    private void checkByPkgId() throws Exception
    {
