...
package com.asiainfo.veris.crm.iorder.web.person.sundryquery.userinfo;
...
public abstract class QuerySnByUsrpidNew extends PersonQueryPage
{
    // 用户资料模糊查询
    public void querySnByUsrpid(IRequestCycle cycle) throws Exception
    {
        ...
        IDataOutput results = CSViewCall.callPage(this, "SS.QuerySnByUsrpidSVC.querySnByUsrpid", condPrams, getPagination("navBar"));
        if (results == null)
        {
