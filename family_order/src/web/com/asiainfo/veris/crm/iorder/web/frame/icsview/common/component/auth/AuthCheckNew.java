...
public abstract class AuthCheckNew extends PersonBasePage
{
        ...
        else if (identity.length() > 4)
        {
            ...
            if (identity.length() > 7){
                ...
                if ("1".equals(tmp) && !("110".equals(tradeTypeCode))) {
                    //宽带开户、魔百和开户和IMS固话开户要做权限判断
                    if ("600".equals(tradeTypeCode) || "4800".equals(tradeTypeCode) || "6800".equals(tradeTypeCode)) {
                        //是否有短信确认码权限
