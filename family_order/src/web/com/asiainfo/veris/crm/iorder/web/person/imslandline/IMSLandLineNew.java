 ...
 */
public abstract class IMSLandLineNew extends PersonBasePage
{
    ...
    public void setPageInfo(IRequestCycle cycle) throws Exception
    {
    	...
    	if(productList!=null&&productList.size()>0){
    		info.put("PRODUCT_TYPE_CODE", productList.getData(0).get("PRODUCT_TYPE_CODE"));
    	}
    	setInfo(info);
    ...
    public void onTradeSubmit(IRequestCycle cycle) throws Exception
    {
        ...
        data.put("HAS_REAL_NAME_INFO", "HAS_REAL_NAME_INFO");
     ...
     * @author wangsc10
     */
    public void checkZnyxFee(IRequestCycle cycle) throws Exception
    {
        IData data = getData();
        IData result = CSViewCall.callone(this, "SS.IMSLandLineSVC.checkZnyxFee", data);
        this.setAjax(result);
    }
    /**
     ...
     * @version: v1.0.0
     * @author: wangsc10
     * @date: 2019-6-26 下午10:58:49 Modification History: Date Author Version Description
     */
    public void checkTerminal(IRequestCycle cycle) throws Exception
    {
        IData data = getData();
        IDataset dataset = CSViewCall.call(this, "SS.IMSLandLineSVC.checkTerminal", data);
        if (null != dataset && dataset.size() > 0) {
			this.setAjax(dataset.first());
		}
	}
