...
package com.asiainfo.veris.crm.iorder.web.frame.icsview.common.component.plat;
...
public abstract class UserPlatSvcsList extends CSBizTempComponent
{
    ...
    {
        this.getPage().addResBeforeBodyEnd("scripts/iorder/icsserv/component/plat/userplatsvcslist.js");
            ...
            else
            {
                ...
                if (result != null && result.size() > 0)
                {
                	...
                	for (int j = 0; j < result.size(); j++){
                		IData svcData = result.getData(j);
                		String rsrvSrt1 = svcData.getString("RSRV_STR1");
                		if(StringUtils.isNotBlank(rsrvSrt1) && "Q".equals(rsrvSrt1)){
                			result.remove(j);
                			j--;
                		}
                	}
