...
package com.asiainfo.veris.crm.iorder.web.igroup.modifypayrelation;
...
public abstract class PayrelaAdvChg extends GroupBasePage
{
    ...
    public void confirm(IRequestCycle cycle) throws Exception
    {
        ...
        idata.put("crmSmsOrder", "on".equals(data.getString("crmSmsOrder"))?"1":"0");// 订购短信提醒
        idata.put("acctSmsOrder", "on".equals(data.getString("acctSmsOrder"))?"1":"0");// 订购短信提醒
    ...
    public void getAdvChgNewSnInfo(IRequestCycle cycle) throws Exception
    {
        ...
        {
            // startCycleId为本账期第一天
            startCycleId = idAcctDayInfo.getString("FIRST_DAY_THISACCT").replaceAll("-", "");
        ...
        else if (GroupBaseConst.UserDaysDistribute.FALSE_TRUE.getValue().equals(userAcctDayDistribution))
        {
            ...
            startCycleId = idAcctDayInfo.getString("FIRST_DAY_NEXTACCT").replaceAll("-", "");
            endCycleId = SysDateMgr.getEndCycle20501231();
            ifBooking = "true";
        }
