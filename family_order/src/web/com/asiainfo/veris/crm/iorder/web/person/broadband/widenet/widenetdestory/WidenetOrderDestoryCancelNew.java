 ...
 * 用户立即销户
 */
public abstract class WidenetOrderDestoryCancelNew extends PersonBasePage
{ 
    ...
    public void loadChildInfo(IRequestCycle cycle) throws Exception
    {
      ...
      //欠费信息
        ...
        //将参数参入前台
        //param.put("TRADE_TYPE_CODE", "1606");//
    ...
    public void onTradeSubmit(IRequestCycle cycle) throws Exception
    {
        ...
        IDataset dataset = CSViewCall.call(this, "SS.OrderDestoryCancelRegSVC.tradeReg", data);
