...
package com.asiainfo.veris.crm.iorder.web.frame.icsview.common.component.person.writecard;
...
public abstract class WriteCard extends CSBizTempComponent
{
    ...
    public void renderComponent(StringBuilder stringBuilder, IMarkupWriter writer, IRequestCycle cycle) throws Exception
    {
        ...
        getPage().addResAfterBodyBegin("scripts/iorder/icsserv/component/person/simcard/SimCard.js");
        getPage().addResAfterBodyBegin("scripts/iorder/icsserv/component/person/writecard/WriteCard.js");
        getPage().addResAfterBodyBegin("scripts/iorder/icsserv/component/person/writecard/WriteCardPhone.js");
        writer.printRaw("<script language=\"javascript\">\n");
        writer.printRaw("$(function(){\n");
        writer.printRaw("if($.os.phone){$.simcardPhone.init();}else{$.simcard.init();}\n");
        writer.printRaw("});\n");
