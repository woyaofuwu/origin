package com.asiainfo.veris.crm.iorder.web.igroup.esop.acceptanceListReportClear;
...
public abstract class AcceptanceListReportClear extends EopBasePage {
     ...
     * @throws Exception
     */
    public void queryClearList(IRequestCycle cycle) throws Exception {

        IData data = this.getData();
        IDataOutput output = CSViewCall.callPage(this, "SS.WorkFormSVC.queryClearList", data, this.getPagination("olcomnav"));
