...
public abstract class GroupAttrChangeProcedure extends EopBasePage {
	...
	public void submitChange(IRequestCycle cycle) throws Exception {
		...
		nodeInfo.put("NODE_ID", data.getString("NODE_ID",""));
		// 受理集团信息
...
//		commData.put("GROUP_ID", custData.getString("GROUP_ID"));
		...
		otherInfo.put("ATTR_CODE", "EOS_ATTR_CONFIRM");
		otherInfo.put("ATTR_VALUE", data.getString("PROCEDURE_GRP_ATTRS"));
