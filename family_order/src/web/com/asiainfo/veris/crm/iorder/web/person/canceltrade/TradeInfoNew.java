...
package com.asiainfo.veris.crm.iorder.web.person.canceltrade;
...
public abstract class TradeInfoNew extends PersonBasePage
{
    ...
    public void initQueryTrade(IRequestCycle cycle) throws Exception {
        ...
        if (IDataUtil.isNotEmpty(tradeInfos)) {
            ...
            if (tradeTypeCode.equals("230") || tradeTypeCode.equals("240")
                    || tradeTypeCode.equals("330") || tradeTypeCode.equals("3301")
                    || tradeTypeCode.equals("142")) {
                re.put("TRADE_TYPE_CODE", tradeTypeCode);
            } else {
                re.put("TRADE_TYPE_CODE", "");
                re.put("PRODUCT_NAME", UpcViewCall.queryOfferNameByOfferId(this, IUpcConst.ELEMENT_TYPE_CODE_PRODUCT, re.getString("PRODUCT_ID")));
