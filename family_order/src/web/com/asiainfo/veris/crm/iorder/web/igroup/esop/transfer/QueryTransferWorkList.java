...
public abstract class QueryTransferWorkList extends EopBasePage
{
    ...
    public void qryTransferInfosRecords(IRequestCycle cycle) throws Exception {
        ...
        IDataOutput output = CSViewCall.callPage(this, "SS.QueryTransferWorkListSVC.qryTransferInfosRecords", data, this.getPagination("navbar"));
