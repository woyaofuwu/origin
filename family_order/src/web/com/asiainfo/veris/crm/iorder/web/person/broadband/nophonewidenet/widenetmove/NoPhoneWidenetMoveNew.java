package com.asiainfo.veris.crm.iorder.web.person.broadband.nophonewidenet.widenetmove;
...
public abstract class NoPhoneWidenetMoveNew extends PersonBasePage
{
    ...
    public void loadChildInfo(IRequestCycle cycle) throws Exception
    {
        ...
        {
            result.put("TOPSETBOX_SERIAL_NUMBER", topsetboxInfo.get("SERIAL_NUMBER"));
            result.put("TOPSETBOX_USER_ID", topsetboxInfo.get("USER_ID"));
        }
...
/*    public void getProductRateByProductId(IRequestCycle cycle) throws Exception
    {
        IData data = getData();    
        data.put(Route.ROUTE_EPARCHY_CODE, "0898");
        IData resultData = CSViewCall.callone(this, "SS.NoPhoneWideUserCreateSVC.getProductRateByProductId", data);
        //System.out.println("-------------getProductRateByProductId------------------resultData:"+resultData);
        setAjax(resultData);
    }*/
    ...
    public void initProductChg(IRequestCycle cycle) throws Exception
    {
        ...
        data.put("IS_FTTH", isFtth);
        String strIsOneSnManyWide = "FALSE";
        //REQ201903080003一机多宽优惠活动开发需求调整
        ...
        if(products!=null&&products.size()>0){
        	for(int i=0;i<products.size();i++){
        		...
        		//REQ201903080003一机多宽优惠活动开发需求调整
        		String isOneSnManyWide = products.getData(i).getString("IS_ONESNMANYWIDE","");
        		String newProductId = products.getData(i).getString("PRODUCT_ID","");
        		//System.out.println("----------------------tempWideRate:"+tempWideRate);
        		//System.out.println("----------------------isOneSnManyWide:"+isOneSnManyWide);
        		//System.out.println("----------------------newProductId:"+newProductId);

        		if("1".equals(isOneSnManyWide))
        		{        			
                	//System.out.println("----------------------isOneSnManyWide1:"+isOneSnManyWide);

        			if(( tempWideRate == 102400 && "84011648" .equals(newProductId)) || (tempWideRate == 204800 && "84011650".equals(newProductId)))
        			{
	        			...
	        			strIsOneSnManyWide = "TRUE";
	        			oldProductToNewProduct = true;//匹配到相同速率的新产品
	                	//System.out.println("----------------------strIsOneSnManyWide:"+strIsOneSnManyWide);
        			}
        	...
        	result.put("CHANGE_PRODUCT_TAG", strIsOneSnManyWide);
    ...
    public void onTradeSubmit(IRequestCycle cycle) throws Exception
    {
        ...
        if(IDataUtil.isNotEmpty(topsetboxInfo))
        {
            data.put("TOPSETBOX_SERIAL_NUMBER", topsetboxInfo.get("SERIAL_NUMBER"));
            data.put("TOPSETBOX_USER_ID", topsetboxInfo.get("USER_ID"));
        }
    ...
    public void checkIsTwoCityNum(IRequestCycle cycle) throws Exception{
        IData data = getData();
        String serialNumber = data.getString("SERIAL_NUMBER");
        if(!"".equals(serialNumber)) {
            //查询是否两城两宽号码
            IDataset dataset = CSViewCall.call(this,"SS.NoPhoneWidenetMoveSVC.checkTwoCityNum",data);
