...
public abstract class SecDistrictSelect extends BaseComponent {
	...
	public void setInitValue() throws Exception{
		...
		String popupPage = "igroup.elecagreement.SecDistrictSelect";
		String title = "业务区选择";
	...
	public void renderComponent(IMarkupWriter writer, IRequestCycle cycle){
		try{
			...
			BizVisit v = (BizVisit) getVisit();
	        if(name == null)
	            throw new ApplicationRuntimeException(Tapestry.format("invalid-field-name", "Popup"), this, null, null);

	        String open = (getOpen()==null||getOpen()=="")?"false":"true";
	        if(("false".equals(open)) && (OrgFactory.getRootAreaByGrant(v) == null)){
	        	readOnly = "true";
	        }
