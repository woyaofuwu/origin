package com.asiainfo.veris.crm.iorder.web.person.broadband.nophonewidenet.cancelwidenettrade;
...
public abstract class CancelNoPhoneWidenetTradeNew extends PersonBasePage {
    ...
    {    	 
        ...
        IDataset results = CSViewCall.call(this, "SS.CancelNoPhoneWidenetTradeService.queryUserCancelTradeNoPhone", pagedata); 
    ...
    public void queryTradeBackFee(IRequestCycle cycle) throws Exception
    {
        ...
        IDataset dataset = CSViewCall.call(this, "SS.CancelNoPhoneWidenetTradeService.queryTradeBackFee", input);
        setAjax(dataset);
    }
    ...
    {
        IData input = this.getData();
        IDataset dataset = CSViewCall.call(this, "SS.CancelNoPhoneWidenetTradeService.cancelTradeReg", input);
        setAjax(dataset);
    }
