...
package com.asiainfo.veris.crm.iorder.web.merch.component.marketingActivity.marketactivitymodule.salecombine;
...
public abstract class MarketActivitySaleCombine extends CSBizTempComponent
{
    @Override
    ...
    public void renderComponent(StringBuilder informalParametersBuilder, IMarkupWriter writer, IRequestCycle cycle) throws Exception
    {
        ...
        infos = CSViewCall.call(this, "CS.SaleActiveQuerySVC.querySaleCombineByPackageId", data);
        setInfos(infos);
    }
