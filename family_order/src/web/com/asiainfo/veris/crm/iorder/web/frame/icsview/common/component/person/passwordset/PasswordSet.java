...
package com.asiainfo.veris.crm.iorder.web.frame.icsview.common.component.person.passwordset;
...
public abstract class PasswordSet extends CSBizTempComponent
{
    ...
    public void renderComponent(StringBuilder stringBuilder, IMarkupWriter writer, IRequestCycle cycle) throws Exception
    {
        ...
        if (null == action || "".equals(action))
        {
             ...
             * 组件初始化载入认证的脚本
             */
            getPage().addResAfterBodyBegin("v5/jcl/ui/component/base/popup.js");
            getPage().addResAfterBodyBegin("scripts/iorder/icsserv/component/person/CommLib.js");
            getPage().addResAfterBodyBegin("scripts/iorder/icsserv/component/person/passwordset/PasswordSet.js");
