...
public abstract class AcceptanceperiodAudit extends EopBasePage {
    ...
    public void initPage(IRequestCycle cycle) throws Exception {
        ...
        if (IDataUtil.isNotEmpty(attrOtherList)) {
            ...
            info.put("TEMPLET_ID", param.getString("TEMPLET_ID"));
    ...
    public void submit(IRequestCycle cycle) throws Exception {
        ...
        if (!"1".equals(adultResult)) {
            ...
            IData submitResult = new DataMap();
            submitResult.put("OFFER_LIST", eopDataList);
            submitResult.put("CUST_INFO", custInfo);
            submitResult.putAll(submitData);

            getData().clear();
            getData().put("SUBMIT_PARAM", submitResult);
        }
    ...
    public abstract void setContractNameList(IDataset contractNameList) throws Exception;
