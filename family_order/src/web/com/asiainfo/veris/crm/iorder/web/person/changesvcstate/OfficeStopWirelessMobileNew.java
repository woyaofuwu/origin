 ...
 */
public abstract class OfficeStopWirelessMobileNew extends PersonBasePage {
    ...
    public void onInitTrade(IRequestCycle cycle) throws Exception {
        String code = getRequest().getParameter("TYPE_CODE");
        IData data = this.getData();
        String tradeTypeCode = data.getString("TRADE_TYPE_CODE", "136"); // 默认打开停机菜单
