package com.asiainfo.veris.crm.iorder.web.merch.component.submit;
...
public abstract class MerchSubmit extends CSBizTempComponent
{
	private static Logger logger = Logger.getLogger(MerchSubmit.class);
	...
	public void renderComponent(StringBuilder infoParamsBuilder, IMarkupWriter writer, IRequestCycle cycle) throws Exception
	{
		...
		{
			getPage().addResAfterBodyBegin("scripts/merch/submit/MerchSubmit.js");
			getPage().addResAfterBodyBegin("scripts/merch/print/MerchPrintMgr.js");
