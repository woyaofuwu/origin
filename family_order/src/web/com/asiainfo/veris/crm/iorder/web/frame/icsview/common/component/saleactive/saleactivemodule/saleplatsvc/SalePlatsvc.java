...
package com.asiainfo.veris.crm.iorder.web.frame.icsview.common.component.saleactive.saleactivemodule.saleplatsvc;
...
public abstract class SalePlatsvc extends CSBizTempComponent
{
    ...
    public void renderComponent(StringBuilder builder, IMarkupWriter writer, IRequestCycle cycle) throws Exception
    {
        ...
        IDataset infos = CSViewCall.call(this, "CS.SaleActiveQuerySVC.querySalePlatSvcsByPackageId", data);
