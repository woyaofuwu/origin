...
package com.asiainfo.veris.crm.iorder.web.person.createtduser;
 ...
 */
public abstract class CreateTDPersonUserNew extends PersonBasePage
{
    /**
    ...
    public void onInitTrade(IRequestCycle clcle) throws Exception
    {
        ...
        if(dataset!=null && dataset.size()>0){
        	for (int i = 0; i < dataset.size(); i++) {
        		IData tempData = (IData) dataset.getData(i);
        		productType += tempData.get("PRODUCT_TYPE_CODE")+",";
			}
        ...
        editInfo.put("PRODUCT_TYPE", productType);
