...
package com.asiainfo.veris.crm.iorder.web.frame.icsview.common.component.person.usercheck;
	...
	public void queryUser() throws Exception {
		...
		if (null == users || users.isEmpty()) {
			...
			if (null == userInfo || userInfo.isEmpty()) {
				...
				if (!tradeEparchyCode.equals(userInfo.getString("EPARCHY_CODE"))
						&& "true".equalsIgnoreCase(data.getString("IS_LOCAL", "false"))) {
