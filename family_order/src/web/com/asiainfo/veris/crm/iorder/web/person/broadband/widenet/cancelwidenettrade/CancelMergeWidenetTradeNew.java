...
import com.asiainfo.veris.crm.order.web.person.broadband.widenet.cancelwidenettrade.CancelWidenetTrade;

public abstract class CancelMergeWidenetTradeNew extends CancelWidenetTrade {
    ...
    {    	 
        ...
        IDataset results = CSViewCall.call(this, "SS.CancelWidenetTradeService.queryUserCancelTradeMerge", pagedata); 
    ...
    public void submitCancelTrade(IRequestCycle cycle) throws Exception
    {
        ...
        IDataset dataset = CSViewCall.call(this, "SS.CancelWidenetTradeService.cancelTradeReg", input);
        setAjax(dataset);
    }
