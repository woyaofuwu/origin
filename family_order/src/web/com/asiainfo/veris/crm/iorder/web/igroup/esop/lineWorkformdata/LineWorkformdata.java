package com.asiainfo.veris.crm.iorder.web.igroup.esop.lineWorkformdata;
...
public abstract class LineWorkformdata extends EopBasePage {
    ...
    public void qryLineWorkformdata(IRequestCycle cycle) throws Exception {
        
        IData data = getData("cond");
        IDataOutput output = CSViewCall.callPage(this, "SS.LineWorkformdataSVC.qryLineWorkformdata", data, this.getPagination("navbar1"));
