...
public class Des {
    ...
    //解密
    public String getDesPwd(String password){
    	String value=password.substring(0,password.indexOf("xxyy"));
    	String key1 = "c";
        String key2 = "x";
        String key3 = "y";
        String data = value;
        //String str = desObj.strEnc(data, key1, key2, key3);//加密
        String dec = this.strDec(value, key1, key2, key3);//解密
        return dec;
    }
    //加密
    public String setEncPwd(String encObj){ 
    	String key1 = "c";
        String key2 = "x";
        String key3 = "y"; 
        return this.strEnc(encObj, key1, key2, key3);//加密  
    }
}