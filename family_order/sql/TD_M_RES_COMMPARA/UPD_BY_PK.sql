UPDATE /*+INDEX(a PK_TD_M_RES_COMMPARA)*/ td_m_res_commpara a
   SET para_name=:PARA_NAME,
       para_value1=:PARA_VALUE1,para_value2=:PARA_VALUE2,para_value3=:PARA_VALUE3,
       para_value4=:PARA_VALUE4,para_value5=:PARA_VALUE5,para_value6=:PARA_VALUE6,
       ...
       rdvalue1=DECODE(:CHECK_TAG,'1',SYSDATE,'4',SYSDATE,rdvalue1),
