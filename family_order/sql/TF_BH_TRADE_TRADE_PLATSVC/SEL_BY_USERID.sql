select 
        ...
        A.TRADE_STAFF_ID,
        B.OPER_CODE
 from   ucr_crm1.tf_bh_trade a,ucr_crm1.tf_b_trade_platsvc b
where a.trade_id=b.trade_id
and  a.accept_month=b.accept_month
and b.service_id=:SERVICE_ID
and a.serial_number=:SERIAL_NUMBER
and a.accept_date=(select  max(a1.accept_date) from   ucr_crm1.tf_bh_trade a1,ucr_crm1.tf_b_trade_platsvc b1
