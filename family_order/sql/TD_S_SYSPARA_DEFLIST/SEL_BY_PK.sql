--IS_CACHE=Y
SELECT /*+INDEX(A PK_TD_S_SYSPARA_DEFLIST)*/ EPARCHY_CODE,PARA_ATTR,PARA_CODE1,PARA_CODE2,PARA_NAME,PARA_VALUE1,PARA_VALUE2,PARA_VALUE3,PARA_VALUE4,PARA_VALUE5,PARA_VALUE6,PARA_VALUE7,PARA_VALUE8,TO_CHAR(PARA_VALUE9) PARA_VALUE9,TO_CHAR(PARA_VALUE10) PARA_VALUE10,TO_CHAR(PARA_VALUE11) PARA_VALUE11,TO_CHAR(PARA_VALUE12) PARA_VALUE12,TO_CHAR(RDVALUE1,'YYYY-MM-DD HH24:MI:SS') RDVALUE1,TO_CHAR(RDVALUE2,'YYYY-MM-DD HH24:MI:SS') RDVALUE2,REMARK,TO_CHAR(UPDATE_TIME,'YYYY-MM-DD HH24:MI:SS') UPDATE_TIME,UPDATE_STAFF_ID,UPDATE_DEPART_ID, 0 X_TAG 
  FROM TD_S_SYSPARA_DEFLIST A
 WHERE 1=1
