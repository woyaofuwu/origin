    ...
    and exists
      ( select 1
        ...
        and d.depart_frame like (
         ...
         and (d.parent_depart_id = :PARENT_DEPART_ID OR :PARENT_DEPART_ID IS NULL ) ) 
) a
