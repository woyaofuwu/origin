...
from
    ( select a.serial_number,rownum tmpnum
      ...
      and a.backmonth = :PARAM5 and b.backmonth = :PARAM5
      and b.prevalued2 between to_date(:PARAM0,'yyyy-mm-dd hh24:mi:ss') and
...
union all
      select a.serial_number,rownum tmpnum
      from tf_fh_cust_groupmember_other a,tf_fh_cust_group b,td_m_staff c,td_m_depart d
      where a.group_id=b.group_id and b.manager_staff_id=c.staff_id
      and c.depart_id = d.depart_id
      and a.backmonth = :PARAM5  and b.backmonth = :PARAM5
      and b.prevalued2 between to_date(:PARAM0,'yyyy-mm-dd hh24:mi:ss') and
