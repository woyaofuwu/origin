SELECT count(1) recordcount
 FROM tf_fh_cust_groupmember_other a
 where a.backmonth = :PARAM0
        and  a.remove_tag = '0'
        AND (a.vip_tag=:PARAM16 OR :PARAM16 IS NULL)
	...
	AND (a.score_level=:PARAM9 OR :PARAM9 IS NULL)
	AND (a.class_id=:PARAM10 OR :PARAM10 IS NULL)
        AND (a.rsrv_2=:PARAM17 OR :PARAM16 IS NULL)
        AND (a.prevaluec1=:PARAM18 OR :PARAM17 IS NULL)
       AND (a.credit_value>=:PARAM19 OR :PARAM18 IS NULL)
