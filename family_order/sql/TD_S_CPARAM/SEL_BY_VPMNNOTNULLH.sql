SELECT count(1) recordcount
 FROM tf_fh_cust_groupmember c, tf_fh_cust_group d ,td_m_staff b,td_m_depart a
 ...
 AND  c.vpmn_group_id IS not NULL and c.backmonth=:PARAM8 and d.backmonth=:PARAM8