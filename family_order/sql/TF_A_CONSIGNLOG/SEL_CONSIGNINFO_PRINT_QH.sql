select consign_id,acyc_id,bcyc_id,
 ...
 pay_fee_mode,remark,rsrv_tag1,return_tag, rsrv_number1,
 ...
 pay_fee_mode,remark,nvl(rsrv_tag1,'0') rsrv_tag1,nvl(return_tag,'0') return_tag,to_char(nvl(rsrv_number1,0)) rsrv_number1,
 ...
 order by consign_id ) where  rownum <= 1000