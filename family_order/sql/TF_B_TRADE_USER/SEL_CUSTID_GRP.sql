SELECT TO_CHAR(U.USER_ID) USER_ID,
       ...
       P.PRODUCT_ID,
       U.MODIFY_TAG
  FROM TF_B_TRADE_USER U, TF_B_TRADE_PRODUCT P, TF_B_TRADE A
 WHERE 1 = 1
   AND U.USER_ID = P.USER_ID
   AND A.ACCEPT_MONTH = U.ACCEPT_MONTH
   AND A.ACCEPT_MONTH = P.ACCEPT_MONTH
   AND U.TRADE_ID = P.TRADE_ID
   AND U.TRADE_ID = A.TRADE_ID
   AND U.REMOVE_TAG = '0'
   AND U.MODIFY_TAG = '0'
