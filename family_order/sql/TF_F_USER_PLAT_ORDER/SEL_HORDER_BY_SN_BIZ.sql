SELECT a.partition_id,to_char(a.user_id) user_id,a.serial_number,a.biz_code,
 ...
 WHERE a.serial_number=:SERIAL_NUMBER
   ...
   AND (:BIZ_CODE is null or a.biz_code=:BIZ_CODE)
   AND (:START_DATE is null or a.start_date>=TO_DATE(:START_DATE, 'YYYY-MM-DD HH24:MI:SS'))
   AND (:END_DATE is null or a.start_date<=TO_DATE(:END_DATE, 'YYYY-MM-DD HH24:MI:SS'))
