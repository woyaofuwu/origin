select b.PARTITION_ID, to_char(b.USER_ID) USER_ID, to_char(b.USER_ID_A) USER_ID_A, a.PRODUCT_ID, a.PACKAGE_ID, b.SERVICE_ID, 
MAIN_TAG, to_char(b.INST_ID) INST_ID, to_char(b.CAMPN_ID) CAMPN_ID, to_char(b.START_DATE,'yyyy-mm-dd hh24:mi:ss') START_DATE, 
...
From tf_f_user_sale_active a ,tf_f_user_svc b
