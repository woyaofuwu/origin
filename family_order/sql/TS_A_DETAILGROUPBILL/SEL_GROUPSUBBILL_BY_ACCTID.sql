select acct_id ,user_id,serial_number,product_id,product_name,note_item_code,note_item ,
		sum(nvl(fee, 0)) FEE  ,
...
And acyc_id=:ACYC_ID 
GROUP BY acct_id ,user_id,serial_number,product_id,product_name,note_item_code,note_item 
