select PARTITION_ID, to_char(USER_ID) USER_ID, TRADE_TYPE_CODE, to_char(RELATION_TRADE_ID) RELATION_TRADE_ID,
        BRAND_CODE, BRAND_NO, VIP_ID, to_char(START_DATE,'yyyy-mm-dd hh24:mi:ss') START_DATE, to_char(END_DATE,'yyyy-mm-dd hh24:mi:ss') END_DATE, 
