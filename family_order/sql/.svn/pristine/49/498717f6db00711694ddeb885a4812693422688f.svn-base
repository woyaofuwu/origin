...
FROM
(select to_char(a.serial_number) manager_tel,to_char(a.vip_manager_name) manager_name,b.group_id,to_char(b.rsrv_str6) prevalue1,to_char(b.rsrv_str7) prevalue2 
from tf_f_managerstaff a,tf_f_cust_group b 
where b.cust_id = :CUST_ID
and a.VIP_MANAGER_ID = b.cust_manager_id)