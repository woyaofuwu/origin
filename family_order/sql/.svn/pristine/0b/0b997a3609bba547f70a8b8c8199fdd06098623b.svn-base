SELECT RECORD_ID, OPR_NUMB, MOBILE_NO, IMEI, PROVINCE_CODE, MATERIAL_CODE,
       CARD_NO, BATCH_TIME,
       TO_CHAR(ACTIVATE_TIME, 'yyyy-mm-dd hh:mi:ss') ACTIVATE_TIME, DEAL_FLAG,
       ...
       RSRV_FLAG4, RSRV_DATE1, RSRV_DATE2, RSRV_DATE3, RSRV_DATE4, '0' OPER_TYPE
  FROM TI_B_USRPACKAGEDATA_DOWN
 WHERE 1 = 1
   AND OPR_NUMB = :OPR_NUMB
   AND MOBILE_NO = :MOBILE_NO
   AND DEAL_FLAG = :DEAL_FLAG
   AND TO_CHAR(ACTIVATE_TIME, 'yyyy-mm-dd') = TO_CHAR(:ACTIVATE_TIME, 'yyyy-mm-dd')