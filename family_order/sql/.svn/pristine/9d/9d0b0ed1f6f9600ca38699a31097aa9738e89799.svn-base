...
SELECT TO_NUMBER(:TRADE_ID),TO_NUMBER(SUBSTR(:TRADE_ID,5,2)),user_id,service_id,serv_para1,serv_para2,serv_para3,serv_para4,serv_para5,serv_para6,serv_para7,serv_para8,'1',start_date,TO_DATE(:ACCEPT_DATE,'yyyy-mm-dd hh24:mi:ss')
