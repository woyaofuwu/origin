...
select to_number(:TRADE_ID),to_number(substr(:TRADE_ID,5,2)),:USER_ID,'1',discnt_code,'1',start_date,to_date(:END_DATE,'yyyy-mm-dd hh24:mi:ss')  from tf_f_user_discnt a
