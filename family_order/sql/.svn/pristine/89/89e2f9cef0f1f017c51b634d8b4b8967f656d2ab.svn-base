SELECT A.REPORT_TYPE_CODE,
  ...
  FROM (SELECT NVL(SUBSTR(T.SORT_RESULT_TYPE, 5, 2), '07') REPORT_TYPE_CODE,
               ...
               DECODE(coalesce(E.report_cust_province,t.report_cust_province), '898', 1, 0) LOCAL_SUM,
               DECODE(coalesce(E.report_cust_province,t.report_cust_province), '898', 0, 1) REMOTE_SUM
