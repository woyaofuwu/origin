INSERT INTO tf_b_trade_grpmbmp_sub(trade_id,modify_tag,partition_id,user_id,serial_number,biz_code,
biz_name,start_date,end_date,ec_user_id,ec_serial_number,rsrv_num1,rsrv_num2,rsrv_num3,rsrv_num4,
