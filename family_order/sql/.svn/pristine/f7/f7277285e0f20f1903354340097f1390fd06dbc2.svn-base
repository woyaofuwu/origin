...
WHERE 
PARTITION_ID = MOD(to_number(:USER_ID),10000) and USER_ID = to_number(:USER_ID) and PRODUCT_ID = :PRODUCT_ID and PACKAGE_ID = :PACKAGE_ID and DISCNT_GIFT_ID = :DISCNT_GIFT_ID and START_DATE = to_date(:START_DATE,'yyyy-mm-dd hh24:mi:ss')