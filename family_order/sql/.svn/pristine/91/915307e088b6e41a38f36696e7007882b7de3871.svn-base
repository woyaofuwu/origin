SELECT
CHNL_ID para_code1,CHNL_CODE para_code2,
CHNL_NAME para_code3,CHNL_KIND_ID para_code4, CHNL_LEVEL para_code5,
CITY_CODE para_code6, '' para_code7, '' para_code8, '' para_code9, '' para_code10,
...
'' start_date,'' end_date,'' eparchy_code,'' remark,'' update_staff_id,'' update_depart_id,'' update_time,'' subsys_code,0 param_attr,'' param_code,'' param_name
  FROM tf_chl_channel
 WHERE (CHNL_KIND_ID =:PARA_CODE1 or :PARA_CODE1 IS NULL or :PARA_CODE1='')
   AND CITY_CODE =:PARA_CODE2
   AND STATE = '0'
