SELECT to_char(add_months(trunc(SYSDATE,'MM'),1),'YYYY-MM-DD') para_code1,'' para_code2,'' para_code3,'' para_code4,'' para_code5,'' para_code6,'' para_code7,'' para_code8,'' para_code9,'' para_code10,
