...
to_char(rsrv_num5) rsrv_num5,'母VPMN' rsrv_str1,rsrv_str2,rsrv_str3,rsrv_str4,rsrv_str5,
...
WHERE  USER_ID=to_number(:USER_ID)
       ...
       and Remove_Tag <> '1'
UNION ALL
SELECT vpn.partition_id,to_char(user_id) user_id,vpn_name,vpn_no,to_char(vpn.user_id_a) user_id_a,group_area,
scp_code,vpmn_type,vpn_type,province,sub_state,func_tlags,feeindex,inter_feeindex,out_feeindex,
outgrp_feeindex,subgrp_feeindex,notdiscnt_feeindex,pre_ip_no,pre_ip_disc,othor_ip_disc,trans_no,
max_close_num,max_num_close,person_maxclose,max_outgrp_num,max_outgrp_max,max_inner_num,max_outnum,
max_users,max_linkman_num,max_telphonist_num,max_limit_users,
...
short_code_len,call_roam_type,bycall_roam_type,payitem_code,to_char(item_fee) item_fee,
to_char(usrgrp_id) usrgrp_id,to_char(open_date,'yyyy-mm-dd hh24:mi:ss') open_date,remove_tag,
to_char(remove_date,'yyyy-mm-dd hh24:mi:ss') remove_date,to_char(vpn.update_time,'yyyy-mm-dd hh24:mi:ss') update_time,
vpn.update_staff_id,vpn.update_depart_id,vpn.remark,vpn.rsrv_num1,vpn.rsrv_num2,vpn.rsrv_num3,to_char(vpn.rsrv_num4) rsrv_num4,
to_char(vpn.rsrv_num5) rsrv_num5,'子VPMN' rsrv_str1,vpn.rsrv_str2,vpn.rsrv_str3,vpn.rsrv_str4,vpn.rsrv_str5,
to_char(vpn.rsrv_date1,'yyyy-mm-dd hh24:mi:ss') rsrv_date1,to_char(vpn.rsrv_date2,'yyyy-mm-dd hh24:mi:ss') rsrv_date2,
to_char(vpn.rsrv_date3,'yyyy-mm-dd hh24:mi:ss') rsrv_date3,vpn.rsrv_tag1,vpn.rsrv_tag2,vpn.rsrv_tag3 
  FROM tf_f_user_vpn vpn,tf_f_relation_uu uu
WHERE  vpn.USER_ID=uu.user_id_b
       AND uu.user_id_a = to_number(:USER_ID)
       and vpn.PARTITION_ID=uu.partition_id
       AND uu.relation_type_code = '40'
       AND uu.end_date>SYSDATE
       and vpn.Remove_Tag <> '1'