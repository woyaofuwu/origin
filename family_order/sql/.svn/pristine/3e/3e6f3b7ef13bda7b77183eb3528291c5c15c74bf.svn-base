SELECT /*+ parallel(A,2)(B,2) full(A) */
 a.serial_number para_code1,
 a.trade_id para_code2,
 to_char(b.oldfee / 100, '99999990.99') para_code4,
 to_char((b.oldfee - b.fee) / 100, '99999990.99') para_code5,
 to_char(a.finish_date, 'yyyy-mm-dd hh24:mi:ss') para_code6,
 0 param_attr,
 a.remark para_code9,
 a.trade_type_code,
 a.trade_staff_id,
