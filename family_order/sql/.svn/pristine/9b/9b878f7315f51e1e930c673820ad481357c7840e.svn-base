...
rsrv_num1,rsrv_num2,rsrv_num3 
 ...
 WHERE stock_id=:STOCK_ID AND
   	sale_time>=TO_DATE(:RSRV_DATE1,'yyyy-mm-dd hh24:mi:ss') AND
	sale_time<=TO_DATE(:RSRV_DATE2,'yyyy-mm-dd hh24:mi:ss') AND
        (sale_staff_id=:SALE_STAFF_ID OR :SALE_STAFF_ID IS NULL)