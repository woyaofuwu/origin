INSERT INTO TF_F_USER_DISCNT
  ...
  SELECT MOD(TO_NUMBER(USER_ID), 10000),TO_CHAR(USER_ID) USER_ID,TO_CHAR(USER_ID_A) USER_ID_A,'800001',PACKAGE_ID,DISCNT_CODE,0,RELATION_TYPE_CODE,INST_ID,CAMPN_ID,START_DATE,END_DATE,sysdate,UPDATE_STAFF_ID,UPDATE_DEPART_ID,REMARK,RSRV_NUM1,RSRV_NUM2,RSRV_NUM3,RSRV_NUM4,RSRV_NUM5,RSRV_STR1,RSRV_STR2,RSRV_STR3,RSRV_STR4,RSRV_STR5,RSRV_DATE1,RSRV_DATE2,RSRV_DATE3,RSRV_TAG1,RSRV_TAG2,RSRV_TAG3
