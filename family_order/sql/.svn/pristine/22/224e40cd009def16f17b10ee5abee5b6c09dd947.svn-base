INSERT INTO TI_B_USER_MEB_CENPAY
      (SYNC_SEQUENCE, SYNC_DAY, MODIFY_TAG, TRADE_ID, PARTITION_ID, USER_ID,
       INST_ID, MP_GROUP_CUST_CODE, PAY_TYPE, OPER_TYPE, PRODUCT_OFFER_ID,
       SERIAL_NUMBER, LIMIT_FEE, ELEMENT_ID, START_DATE, END_DATE, UPDATE_TIME,
      ...
      SELECT :SYNC_SEQUENCE, :SYNC_DAY,
             ...
             B.PAY_TYPE, B.OPER_TYPE, B.PRODUCT_OFFER_ID, B.SERIAL_NUMBER,
             B.LIMIT_FEE, B.ELEMENT_ID, B.START_DATE, B.END_DATE, B.UPDATE_TIME,
