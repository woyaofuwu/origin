...
SELECT TO_NUMBER(:TRADE_ID),TO_NUMBER(SUBSTR(:TRADE_ID,5,2)),USER_ID,USER_ID_A,PACKAGE_ID,PRODUCT_ID,DISCNT_CODE,SPEC_TAG,RELATION_TYPE_CODE,INST_ID,CAMPN_ID,START_DATE,TO_DATE(:END_DATE,'YYYY-MM-DD HH24:MI:SS'),:MODIFY_TAG,SYSDATE,UPDATE_STAFF_ID,UPDATE_DEPART_ID,REMARK
