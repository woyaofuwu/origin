SELECT a.group_id para_code1,
       ...
       a.manager_staff_id para_code3,
       b.prod_explain para_code4,
       c.serial_number_b para_code5,
       '' para_code6,
       '' para_code7,
       '' para_code8,
       '' para_code9,
       ...
       '' param_code,
       '' param_name
  FROM tf_F_cust_group a, Tf_f_Cust_Product b,Tf_f_Relation_Uu c
   WHERE a.cust_id = b.cust_id
   AND b.product_id = '6100'
   AND b.rsrv_str5=c.user_id_a
   AND c.role_code_b = '2'
   AND a.group_id = :PARA_CODE1
