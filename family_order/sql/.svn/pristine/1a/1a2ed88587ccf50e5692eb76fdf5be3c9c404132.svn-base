INSERT INTO TI_B_RELATION_AA
        (SYNC_SEQUENCE, SYNC_DAY, MODIFY_TAG, TRADE_ID, PARTITION_ID, ACCT_ID_A,
         USER_ID_A, ACCT_ID_B, USER_ID_B, PAYITEM_CODE, RELATION_TYPE_CODE,
         ROLE_CODE_A, ROLE_CODE_B, ORDERNO, INST_ID, LIMIT_TYPE, LIMIT_VALUE,
         ACT_TAG, START_DATE, END_DATE, UPDATE_TIME, UPDATE_STAFF_ID,
        ...
        SELECT :SYNC_SEQUENCE, :SYNC_DAY,
               ...
               MOD(ACCT_ID_B, 10000), ACCT_ID_A, USER_ID_A, ACCT_ID_B, USER_ID_B,
               PAYITEM_CODE, RELATION_TYPE_CODE, ROLE_CODE_A, ROLE_CODE_B,
               ORDERNO, INST_ID, LIMIT_TYPE, LIMIT_VALUE, ACT_TAG, START_DATE,
