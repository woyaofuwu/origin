--IS_CACHE=Y
 ...
 WHERE (subsys_code=:SUBSYS_CODE
   ...
   AND (para_code5=:PARA_CODE4 or :PARA_CODE5 is null)
   AND (para_code6=:PARA_CODE4 or :PARA_CODE6 is null)
   AND (para_code7=:PARA_CODE4 or :PARA_CODE7 is null)
   AND (para_code8=:PARA_CODE4 or :PARA_CODE8 is null)
   AND (para_code9=:PARA_CODE4 or :PARA_CODE9 is null)
   AND (para_code10=:PARA_CODE4 or :PARA_CODE10 is null)
