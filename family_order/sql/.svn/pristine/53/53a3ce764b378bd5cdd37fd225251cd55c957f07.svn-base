select a.STATE CANCEL_TAG,decode(a.STATE,'0','已受理','1','已返销') STATE,a.SERIAL_NUMBER,a.CUST_NAME,a.VIP_NO,a.AIRDROME_NAME,a.PLANE_LINE,a.FOLLOW_NUM,a.RSRV_STR2,
       ...
       a.SERVICE_STAFF,TO_CHAR(a.SERVICE_DATE,'yyyy-mm-dd hh24:mi:ss') SERVICE_DATE,a.SERVICE_ID as trade_id,b.user_id from tf_b_vipairdrome_service a,tf_f_cust_vip b 
where 1=1 
