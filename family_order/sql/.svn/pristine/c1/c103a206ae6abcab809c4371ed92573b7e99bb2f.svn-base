...
para_code8 ,0 param_attr
 from tf_bh_trade a,tf_b_tradefee_sub b
where a.trade_id=b.trade_id
      AND :PARA_CODE4=a.trade_city_code 
      AND (a.trade_type_code=to_number(:PARA_CODE1) OR -1=to_number(:PARA_CODE1))
      AND a.trade_staff_id BETWEEN nvl(:PARA_CODE5,'00000000') AND nvl(:PARA_CODE6,'ZZZZZZZZ')
      ...
      AND a.cancel_tag='0'
      AND b.oldfee>b.fee 
  ORDER BY a.serial_number,a.trade_id