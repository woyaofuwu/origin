select 
SMS_BUSSEND_ID para_code1,
SERIAL_NUMBER para_code2,
RECV_SMSCODE para_code3,
RECV_OBJECT para_code4,
REP_CONTENT para_code5,
RECV_TIME para_code6,
REP_TIME para_code7, 
MONTHID para_code8,
...
AND REP_TIME >= to_date(:PARA_CODE2,'yyyy-mm-dd')
AND REP_TIME <= to_date(:PARA_CODE3,'yyyy-mm-dd') 
AND REP_CONTENT NOT LIKE '%密码%'
