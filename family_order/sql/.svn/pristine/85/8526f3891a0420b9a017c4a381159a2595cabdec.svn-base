...
USER_ID = TO_NUMBER(:USER_ID) AND PARTITION_ID = MOD(TO_NUMBER(:USER_ID),10000))  AND
       operate_time <= TO_DATE(:RECV_TIME_E, 'YYYY-MM-DD HH24:MI:SS') AND
       operate_time >=
       decode(:X_TAG,
              1,
