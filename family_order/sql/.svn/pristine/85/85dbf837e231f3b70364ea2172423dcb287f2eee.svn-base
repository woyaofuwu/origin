   ...
   AND EXISTS(
             SELECT 1 FROM td_s_commpara b 
              WHERE b.subsys_code='CSM'
                AND b.param_attr=3027
                AND sysdate BETWEEN b.start_date AND b.end_date
                AND b.param_code =a.sp_svc_id
                AND b.para_code1 =a.sp_id)