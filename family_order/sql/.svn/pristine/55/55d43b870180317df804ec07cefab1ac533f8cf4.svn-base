...
WHERE T.TRADE_ID=T1.TRADE_ID
    ...
    AND TO_DATE(:THIS_DATE,'yyyy-mm-dd hh24:mi:ss') BETWEEN T1.START_DATE AND T1.END_DATE
    AND TO_DATE(:THIS_DATE,'yyyy-mm-dd hh24:mi:ss') BETWEEN T2.START_DATE AND T2.END_DATE
