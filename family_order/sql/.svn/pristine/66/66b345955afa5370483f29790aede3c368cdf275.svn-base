...
UNION ALL
SELECT *
FROM tf_bhb_trade_detail_2006
WHERE trade_id=TO_NUMBER(:TRADE_ID)
AND accept_month = TO_NUMBER(SUBSTR(:TRADE_ID,5,2))
UNION ALL
SELECT *
FROM tf_bhb_trade_detail_2007
WHERE trade_id=TO_NUMBER(:TRADE_ID)
AND accept_month = TO_NUMBER(SUBSTR(:TRADE_ID,5,2))
UNION ALL
SELECT *
FROM tf_bhb_trade_detail_2008
WHERE trade_id=TO_NUMBER(:TRADE_ID)
AND accept_month = TO_NUMBER(SUBSTR(:TRADE_ID,5,2))
UNION ALL
SELECT *
FROM tf_bhb_trade_detail_2009
WHERE trade_id=TO_NUMBER(:TRADE_ID)
AND accept_month = TO_NUMBER(SUBSTR(:TRADE_ID,5,2))
UNION ALL
SELECT *
FROM tf_bhb_trade_detail_2010
WHERE trade_id=TO_NUMBER(:TRADE_ID)
AND accept_month = TO_NUMBER(SUBSTR(:TRADE_ID,5,2)))