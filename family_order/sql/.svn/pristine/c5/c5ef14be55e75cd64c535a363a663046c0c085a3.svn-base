SELECT vip_manager_id,vip_manager_name,
       ...
       polity,c.depart_name depart,work_bound,link_phone,
       a.serial_number,fax,a.email,home_phone,
       trait,hobby,train_record,work_story,appraise_tag,a.remark,a.update_staff_id,
       a.update_depart_id,to_char(a.update_time,'yyyy-mm-dd') update_time,
 ...
 WHERE a.vip_manager_name like '%'||:VIP_MANAGER_NAME||'%' 
 and a.vip_manager_id=b.staff_id 
