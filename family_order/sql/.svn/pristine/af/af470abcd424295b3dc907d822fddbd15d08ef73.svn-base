SELECT a.partition_id,to_char(user_id) user_id,a.rsrv_value_code,a.rsrv_value,a.rsrv_str1,a.rsrv_str2,a.rsrv_str3,a.rsrv_str4,a.rsrv_str5,a.rsrv_str6,a.rsrv_str7,a.rsrv_str8,a.rsrv_str9,a.rsrv_str10,to_char(a.start_date,'yyyy-mm-dd hh24:mi:ss') start_date,to_char(a.end_date,'yyyy-mm-dd hh24:mi:ss') end_date 
  FROM tf_f_user_other a
 WHERE a.partition_id=mod(TO_NUMBER(:USER_ID),10000)
   AND a.user_id=TO_NUMBER(:USER_ID)
   AND a.rsrv_value_code=:RSRV_VALUE_CODE
   and NOT EXISTS (select 1 from tf_b_trade_svc b
   ...
   and NOT EXISTS (select 1 from tf_f_user_svc d
               where a.USER_ID=d.USER_ID
               and a.RSRV_STR2=to_char(d.SERVICE_ID)
               and a.RSRV_STR1='2'
               and d.end_date>sysdate)
   and NOT EXISTS (select 1 from tf_f_user_discnt e
