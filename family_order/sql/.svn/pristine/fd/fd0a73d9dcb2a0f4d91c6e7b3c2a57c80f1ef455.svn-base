...
from tf_f_user partition(PAR_TF_F_USER_7) u, tf_f_customer c  Where u.cust_id = c.cust_id     
 ...
 and exists  (SELECT 1          
  FROM tf_F_user_product partition(PAR_TF_F_USER_PRODUCT_7) p          where p.user_id = u.user_id           
