SELECT  f_csb_getserialnumberNEW(a.acct_id) para_code1,:PARA_CODE1 para_code2,a.payitem_code para_code3,
	...
	FROM tf_a_payrelation a ,tf_f_user b,TF_F_CUSTOMER c
 WHERE a.user_id=:PARA_CODE2
         AND (a.acct_id!=:PARA_CODE3 OR a.acct_id=:PARA_CODE3)
