SELECT T.INFO_RECV_ID,
       ...
       T.REPORT_BRAND_CODE,
        coalesce(E.serv_request_type,t.serv_request_type) serv_request_type ,
       T.RECV_PROVINCE,
       ...
       T.TARGET_PROVINCE,
        coalesce(E.REPORT_TYPE_CODE,t.REPORT_TYPE_CODE) REPORT_TYPE_CODE ,
       T.RECV_CONTENT,
       T.IMPORTANT_LEVEL,
       T.STATE,
       DECODE(T.STATE,
 ...
 WHERE 1 = 1
   ...
   AND (SUBSTR(T.SORT_RESULT_TYPE, 9, 2) =
       SUBSTR(:CONTENT_TYPE_CODE, 3, 2) OR :CONTENT_TYPE_CODE IS NULL)
   ...
   AND (E.BADNESS_INFO_PROVINCE = :BADNESS_INFO_PROVINCE OR
       :BADNESS_INFO_PROVINCE IS NULL or t. badness_info_province=:BADNESS_INFO_PROVINCE )
   AND (E.REPORT_CUST_PROVINCE = :REPORT_CUST_PROVINCE OR
       :REPORT_CUST_PROVINCE IS NULL or t. REPORT_CUST_PROVINCE=:REPORT_CUST_PROVINCE )
