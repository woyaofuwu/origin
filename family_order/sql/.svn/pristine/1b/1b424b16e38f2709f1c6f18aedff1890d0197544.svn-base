SELECT to_char(TRADE_ID) TRADE_ID,
       ACCEPT_MONTH,
       PARTITION_ID,
       CUST_ID,PSPT_TYPE_CODE,PSPT_ID,
       ...
       WORK_NAME,WORK_KIND,WORK_ADDRESS,WORK_PHONE,WORK_POST_CODE,
       CALLING_TYPE_CODE,
       SUB_CALLING_TYPE_CODE,WORK_DEPART,JOB,
       CONTACT,CONTACT_PHONE,CONTACT_TYPE_CODE,CONTACT_FREQ,
       NATIONALITY_CODE,
       LOCAL_NATIVE_CODE,
       POPULATION,
       LANGUAGE_CODE,
       FOLK_CODE,RELIGION_CODE,JOB_TYPE_CODE,
       REVENUE_LEVEL_CODE,EDUCATE_DEGREE_CODE,
       EDUCATE_GRADE_CODE,GRADUATE_SCHOOL,
       SPECIALITY,
       CHARACTER_TYPE_CODE,
       HEALTH_STATE_CODE,
       MARRIAGE,
       WEBUSER_ID,WEB_PASSWD,
       COMMUNITY_ID,REMOVE_TAG,
