SELECT
distinct biz_state_code para_code1,
...
'' start_date,'' end_date,'' eparchy_code,'' remark,'' update_staff_id,'' update_depart_id,'' update_time,'' subsys_code,0 param_attr,'' param_code,'' param_name
 ...
 WHERE user_id=(select user_id from tf_f_user where serial_number=:PARA_CODE1 and remove_tag='0')
   AND sp_svc_id=:PARA_CODE2
   AND end_date > sysdate
   AND sp_id = :PARA_CODE3
