SELECT count(1) recordcount
 ...
 WHERE (:PARAM0 is null  or a.group_id =:PARAM0)
  AND (:PARAM1  is null  or a.accept_date >=to_date(:PARAM1,'yyyy-mm-dd'))
  AND (:PARAM2 is null or a.accept_date<=to_date(:PARAM2,'yyyy-mm-dd'))
