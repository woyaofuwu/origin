UPDATE tf_f_specific_discnt
   SET end_acyc_id=:END_ACYC_ID,rsrv_num5=TO_NUMBER(:RSRV_NUM5),rsrv_str2=:RSRV_STR2,remark=:REMARK,update_time=TO_DATE(:UPDATE_TIME, 'YYYY-MM-DD HH24:MI:SS'),update_depart_id=:UPDATE_DEPART_ID,update_staff_id=:UPDATE_STAFF_ID  
