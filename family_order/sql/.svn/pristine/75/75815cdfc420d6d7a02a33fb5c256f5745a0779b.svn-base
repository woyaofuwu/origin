SELECT b.serial_number_a para_code1,
 ...
 WHERE a.remove_tag='0'
   ...
   AND b.User_Id_a = (SELECT user_id_a FROM tf_f_relation_uu WHERE serial_number_b=:PARA_CODE1 AND relation_type_code='51' AND SYSDATE BETWEEN start_date AND end_date)
   AND c.service_id=75
