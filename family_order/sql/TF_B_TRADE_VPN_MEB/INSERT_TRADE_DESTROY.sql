...
v.vpn_type, v.ext_func_tlags, v.open_date, '1', to_date(:REMOVE_DATE,'yyyy-mm-dd hh24:mi:ss'),
'2', to_date(:UPDATE_TIME,'yyyy-mm-dd hh24:mi:ss'), :UPDATE_STAFF_ID, :UPDATE_DEPART_ID, v.remark,
