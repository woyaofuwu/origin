SELECT a.staff_id,
       ...
       a.clct_day,
       NVL(f_sys_getcodename('trade_type_code',a.trade_type_code,NULL,NULL),a.trade_type_code)||'※'||NVL(f_sys_getcodename('foregift_code',a.fee_type_code,NULL,NULL),a.fee_type_code) fee_type ,
