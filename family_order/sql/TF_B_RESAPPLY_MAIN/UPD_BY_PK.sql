UPDATE tf_b_resapply_main
   SET apply_date=TO_DATE(:APPLY_DATE, 'YYYY-MM-DD HH24:MI:SS'),apply_reason=:APPLY_REASON,apply_status=:APPLY_STATUS,priority=:PRIORITY,audit_state_code=:AUDIT_STATE_CODE,cancel_reason=:CANCEL_REASON,remark=:REMARK,rsrv_str1=:RSRV_STR1  
