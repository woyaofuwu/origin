...
And to_char(start_date,'yyyy-mm-dd') = to_char(TO_date(:START_DATE, 'yyyy-mm-dd hh24:mi:ss'),'yyyy-mm-dd')
And end_date >= Sysdate
And Not Exists(
    Select 1 From td_s_commpara c Where c.subsys_code='CSM' And c.param_attr=1007
           And c.param_code=:PRODUCT_ID And Sysdate Between c.start_date And c.end_date
    )