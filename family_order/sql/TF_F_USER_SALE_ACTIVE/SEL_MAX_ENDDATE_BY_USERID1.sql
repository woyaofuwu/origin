select nvl(to_char(max(end_date), 'yyyy-mm-dd hh24:mi:ss'),
           '1990-12-12 21:21:21') end_date,
       nvl(to_char(max(rsrv_date2), 'yyyy-mm-dd hh24:mi:ss'),
           nvl(to_char(max(end_date), 'yyyy-mm-dd hh24:mi:ss'),
           '1990-12-12 21:21:21')) rsrv_date2
