...
and (accept_date+0 >= TRUNC(TO_DATE(:START_DATE, 'YYYY-MM-DD HH24:MI:SS')) OR :START_DATE IS NULL)
and (accept_date+0 <TRUNC(TO_DATE(:FINISH_DATE, 'YYYY-MM-DD HH24:MI:SS'))+1 OR :FINISH_DATE IS NULL)
