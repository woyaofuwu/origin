SELECT a.id, a.bill_id, a.id_type,a.partition_id,a.effect_item_code,a.act_mode,
...
a.adjust_depart_id,a.adjust_staff_id,a.adjust_eparchy_code
...
AND ( a.update_time >= to_date(:START_DATE,'yyyy-mm-dd hh24:mi:ss') OR :START_DATE IS NULL ) 
AND ( a.update_time <= to_date(:END_DATE,'yyyy-mm-dd hh24:mi:ss') OR :END_DATE IS NULL)