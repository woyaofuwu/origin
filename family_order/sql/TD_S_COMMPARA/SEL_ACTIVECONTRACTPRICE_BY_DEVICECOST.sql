...
And a.param_attr=1741
And a.param_code=to_number(:PARAM_CODE)
And (to_number(:DEVICE_COST) >= to_number(a.para_code4) And to_number(:DEVICE_COST) < to_number(a.para_code5))
