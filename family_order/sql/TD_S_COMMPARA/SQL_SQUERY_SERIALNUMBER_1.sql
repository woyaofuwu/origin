SELECT a.trade_id para_code1,'' para_code2,'' para_code3,
       ...
       to_char(a.CANCEL_DATE,'yyyy-mm-dd hh24:mi:ss') para_code7,
...
,NULL) para_code17,f_sys_getcodename('depart_id',CANCEL_DEPART_ID,NULL
,NULL) para_code18,a.CANCEL_STAFF_ID para_code19,f_sys_getcodename('staff_id',CANCEL_STAFF_ID,NULL,NULL) para_code20,
       a.CANCEL_DEPART_ID para_code21,'' para_code22,'' para_code23,'' para_code24,'' para_code25,
...
where a.serial_number=:SERIAL_NUMBER
  and a.CANCEL_DATE>trunc(TO_DATE(:ACCEPT_DATE,'YYYY-MM-DD HH24:MI:SS'))
  AND a.CANCEL_DATE<trunc(TO_DATE(:ACCEPT_DATE,'YYYY-MM-DD HH24:MI:SS'))+1
  ...
  and ((a.cancel_tag='1')AND(a.EXEC_TIME>a.FINISH_DATE))