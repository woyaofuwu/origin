SELECT distinct a.subscribe_id para_code1,'' para_code2,
'' para_code3,
...
'' start_date,'' end_date,'' eparchy_code,'' remark,'' update_staff_id,'' update_depart_id,'' update_time,'' subsys_code,0 param_attr,'' param_code,'' param_name
 ...
 WHERE a. rsrv_str1=:PARA_CODE1
     AND a.accept_date>trunc(sysdate,'mm')-1/24/3600
     AND  a.accept_date<TRUNC(ADD_MONTHS(SYSDATE,1), 'mm')
