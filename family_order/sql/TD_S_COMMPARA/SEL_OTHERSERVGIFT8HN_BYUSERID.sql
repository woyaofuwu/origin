...
to_char(user_id) PARA_CODE1,service_mode PARA_CODE2,rsrv_str1 PARA_CODE3,
rsrv_str2 PARA_CODE4,PROCESS_INFO PARA_CODE5,
...
AND service_mode=:PARA_CODE2
AND rsrv_str1 in ('8','9')
AND process_tag='0'
