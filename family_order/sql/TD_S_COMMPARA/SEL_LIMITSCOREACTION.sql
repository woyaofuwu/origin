--IS_CACHE=Y
SELECT TO_CHAR(action_code) para_code1,action_name para_code2,TO_CHAR(score) para_code3,TO_CHAR(NVL(reward_limit,0)) para_code4,TO_CHAR(NVL(action_limit,-1)) para_code5,remark para_code6,
...
AND score<=TO_NUMBER(:PARA_CODE1)
AND (brand_code is null or brand_code=:PARA_CODE3)
