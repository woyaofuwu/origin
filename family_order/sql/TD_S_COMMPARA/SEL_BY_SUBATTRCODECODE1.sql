--IS_CACHE=Y
SELECT 		subsys_code,param_attr,param_code,param_name,para_code1,para_code2,
			para_code3,para_code4,para_code5,para_code6,para_code7,para_code8,
...
WHERE       subsys_code=:SUBSYS_CODE
      ...
      AND  ( para_code1=:PARA_CODE1 or para_code1='-1')
      AND   (sysdate BETWEEN start_date AND end_date)
      AND   (eparchy_code=:EPARCHY_CODE or eparchy_code='ZZZZ')
      order by PARA_CODE1 desc , EPARCHY_CODE