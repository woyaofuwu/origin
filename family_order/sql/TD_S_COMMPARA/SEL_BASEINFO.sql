...
b.rsrv_value para_code6, '' para_code7, '' para_code8, '' para_code9, '' para_code10,
...
FROM tf_bh_trade a,tf_b_trade_other b,td_a_acycpara c,td_a_acycpara d
WHERE a.trade_id=b.trade_id
AND cancel_tag<'2'
AND a.trade_id=TO_NUMBER(:PARA_CODE1)
AND a.accept_month = TO_NUMBER(SUBSTR(:PARA_CODE1,5,2))
AND b.rsrv_value_code='BASE'
...
'' ,'' ,'' ,'' ,'' ,
'' ,'' ,'' ,'' ,'' ,'' ,'' ,'' ,0 ,'' ,''
FROM tf_b_trade a,tf_b_trade_other b,td_a_acycpara c,td_a_acycpara d
WHERE a.trade_id=b.trade_id
AND cancel_tag<'2'
AND a.trade_id=TO_NUMBER(:PARA_CODE1)
AND a.accept_month = TO_NUMBER(SUBSTR(:PARA_CODE1,5,2))
