...
WHERE a.olcom_work_id =  b.olcom_work_id
AND b.trade_id = TO_NUMBER(:PARA_CODE1)
AND a.param_code = 'PKGFEETYPE') para_code2,
(SELECT a.param_value
FROM ti_c_olcomcommonquery a,ti_c_olcomwork b
WHERE a.olcom_work_id =  b.olcom_work_id
AND b.trade_id = TO_NUMBER(:PARA_CODE1)
AND a.param_code = 'GROUPNO') para_code3,
...
WHERE a.olcom_work_id =  b.olcom_work_id
AND b.trade_id = TO_NUMBER(:PARA_CODE1)
AND a.param_code = 'ACCOUNTSTATE') para_code4,
(SELECT a.param_value
FROM ti_c_olcomcommonquery a,ti_c_olcomwork b
WHERE a.olcom_work_id =  b.olcom_work_id
AND b.trade_id = TO_NUMBER(:PARA_CODE1)
AND a.param_code = 'ACCOUNTSTOP') para_code5,
(SELECT a.param_value
FROM ti_c_olcomcommonquery a,ti_c_olcomwork b
WHERE a.olcom_work_id =  b.olcom_work_id
AND b.trade_id = TO_NUMBER(:PARA_CODE1)
AND a.param_code = 'CALLSERVICESTOP') para_code6,
(SELECT a.param_value
FROM ti_c_olcomcommonquery a,ti_c_olcomwork b
WHERE a.olcom_work_id =  b.olcom_work_id
AND b.trade_id = TO_NUMBER(:PARA_CODE1)
AND a.param_code = 'ACCOUNTLEFT') para_code7,
