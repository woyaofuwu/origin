--IS_CACHE=Y
SELECT max(para_value4) para_code1,'' para_code2,'' para_code3,
...
FROM td_m_res_commpara
 WHERE para_attr = :PARA_CODE1 
   AND para_value3 = :PARA_CODE2
   AND para_value2 = :PARA_CODE3    
   AND para_value4 like :PARA_CODE4||'%' 
