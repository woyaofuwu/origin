--IS_CACHE=Y
SELECT city_code para_code1, area_code para_code2, city_name para_code3, prov_code para_code4, '' para_code5,
...
'' start_date,'' end_date,'' eparchy_code,'' remark,'' update_staff_id,'' update_depart_id,'' update_time,'' subsys_code,0 param_attr,'' param_code,'' param_name
 ...
 WHERE prov_code = :PARA_CODE1
   ...
   AND (eparchy_code IS NULL OR eparchy_code IS NOT NULL)