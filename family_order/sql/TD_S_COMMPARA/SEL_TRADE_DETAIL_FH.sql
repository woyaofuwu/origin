SELECT a.trade_id para_code1,'' para_code2,'' para_code3,
       ...
       a.trade_type_code para_code11,'' para_code12,a.cust_id para_code13,b.CANCEL_TAG para_code14,'0' para_code15,
...
FROM TF_Bh_TRADE a,TS_A_AUDITRESULT_DETAIL b
...
AND b.TRADE_DEPART_ID = :TRADE_DEPART_ID 
AND b.TRADE_STAFF_ID = :TRADE_STAFF_ID
AND a.TRADE_TYPE_CODE= :TRADE_TYPE_CODE
AND (a.cancel_tag='0'or ((a.cancel_tag='1')AND(a.EXEC_TIME>a.FINISH_DATE)))
