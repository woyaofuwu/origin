Select PARTITION_ID,
       ...
       RSRV_TAG2,
       RSRV_TAG3
  From TF_F_USER_SALE_GOODS T
 WHERE RELATION_TRADE_ID = TO_NUMBER(:RELATION_TRADE_ID)
   AND EXISTS
 (SELECT 1
          FROM TD_S_COMMPARA C
         WHERE C.SUBSYS_CODE = 'CSM'
           AND C.PARAM_ATTR = 8515
           AND C.PARAM_CODE = 'CANCEL_SALEGOODS'
           AND C.PARA_CODE1 = T.PRODUCT_ID
