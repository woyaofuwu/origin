...
function queryClearList(obj){
	...
	$.ajax.submit("","queryReportClear", "&ACCEPT_START="+acceptState+"&ACCEPT_END="+acceptEnd+"&IBSYSID="+ibsysId+"&SUB_TYPE_OPEN="+subTypeOpen,'QueryResultPart', function(data){
			$.endPageLoading();
			hidePopup(obj);
