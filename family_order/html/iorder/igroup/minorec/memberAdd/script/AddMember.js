...
function setWideNetData(tableData, rowsData, offerData)
{
    ...
    $.each(tableData, function(index, value) {
        var newMB = $.DataMap({
            ...
            WIDE_PRODUCT_ID: $("#WIDE_PRODUCT_ID").val(),
            WIDE_PRODUCT_NAME: $("#WIDE_PRODUCT_ID").text(),
            ...
            SELECTED_ELEMENTS: publicAttrInfo.toString(),
            RSRV_STR1: "WIDENET",
...
function afterSetDetailAddress(){
    ...
    var offerData = new Wade.DataMap($("#offer7341").text());
    ...
    if ("" != productTypeName && null !=productTypeName && undefined != productTypeName && productTypeName != openType){
    ...
    var param = "&WIDE_PRODUCT_TYPE="+openType+"&GROUP_ID="+groupId+"&SERIAL_NUMBER="+serialNumber+
                "&DETAIL_ADDRESS_LIST="+detailAddressList+"&DETAIL_ADDRESS_LIST1="+dataset;

    $.ajax.submit("", "queryWidenetTable", param, pateAll, function(data){
        $.endPageLoading();
