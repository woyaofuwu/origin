...
function backElecSelect(){
    ...
    //applyFrame.redirect("igroup.minorec.MinorecSpeedinessChgApply", "", "&PhoneInit=true", "iorder");
    elecFrame.redirect("igroup.minorec.MinorecSpeedinessChgApply", "", "&PhoneInit=true", "iorder");
    //applyFrame.init();
