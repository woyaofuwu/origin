function openOfferPopupItem(el)
{
	...
	var pram = "&EC_COMMON_INFO_DATA="+encodeURIComponent(ecCommonInfoData.toString())+"&EC_OFFER_DATA="+encodeURIComponent(ecOfferData.toString())+"&MEB_OFFER_DATA="+encodeURIComponent(memberOfferData.toString())+"&OFFER_MEMBER_DATA="+encodeURIComponent(offerMemberInfo.toString());
