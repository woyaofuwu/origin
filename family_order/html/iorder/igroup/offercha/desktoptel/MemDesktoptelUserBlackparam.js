var blackTaber = new Wade.DatasetList();
function initPageParam_120010122814(){
	...
	$.each(blackTaber,function(index,data) {
...
//	 var rowData = $.table.get("ZyhtTable").getRowData();
	 ...
	 $("#BIZ_CODE").val(data.get("BIZ_CODE"));
}
function checkSub(obj){
	$("#SERIAL_NUMBER").val("");
	$("#BIZ_CODE").val("");
	//提交参数
	$("#pam_BLACK_LIST").val(ZyhtTable.getData());
	if(!submitOfferCha())
		return false;
    backPopup(obj);
}