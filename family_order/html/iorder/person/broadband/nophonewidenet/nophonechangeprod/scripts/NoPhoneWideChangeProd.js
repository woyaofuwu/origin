...
//				$.insertHtml('beforeend',nextBrandArea,brandName);
				...
				$("#NEW_PRODUCT").css("display","");
				var selectedText = PRODUCT_ID_NOPHONE.selectedText;
		...
		beforeSubmit:function()
		{
			...
			var changeSubmitData = selectedElements.getSubmitData();			
			var strIsOneSnManyWide = $("#IS_ONESN_MANYWIDE").val();//是否一机多宽
			var oneSnFlag=false;
			changeSubmitData.each(function (item) {
