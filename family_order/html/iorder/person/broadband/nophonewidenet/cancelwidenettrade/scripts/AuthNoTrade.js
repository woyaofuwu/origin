(function($){
	$.extend({authNoTrade:{
		...
		submitCancelTrade:function()
		{
	    	...
	    	MessageBox.confirm("告警提示","系统将提交受理数据信息，您总共需要给用户退费"+$("#backFee").text()+"元，确认要继续吗？",function(re){
	    		if(re=="ok"){
	    ...
	    afterSubmit:function(data){
	    	...
	    	MessageBox.success("成功提示","业务取消成功!",function(btn){
	    		$.redirect.toPage("iorder","broadband.widenet.CancelNoPhoneWideUserCreateTradeNew","onInitTrade",'');
	    		debugger;
	    	});
	    }
	}});
