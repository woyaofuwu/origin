...
//              $(obj).prop("checked", true);
                ...
                ajaxSubmit(null,"queryTradeBackFee",params,"",function(data){
                    $.endPageLoading();
                    $("#FIRSTFEE_value").html('<span id="FIRSTFEE" name="FIRSTFEE">'+data.get(0,"FIRSTFEE")+'</span>');
                    $("#TWOFEE_value").html('<span id="TWOFEE" name="TWOFEE">'+data.get(0,"TWOFEE")+'</span>');
                    $("#THREEFEE_value").html('<span id="THREEFEE" name="THREEFEE">'+data.get(0,"THREEFEE")+'</span>');
        ...
        clearFeeInfo:function(){
            $("#FIRSTFEE_value").html('<span id="FIRSTFEE" name="FIRSTFEE">0</span>');
            $("#TWOFEE_value").html('<span id="TWOFEE" name="TWOFEE">0</span>');
            $("#THREEFEE_value").html('<span id="THREEFEE" name="THREEFEE">0</span>');
