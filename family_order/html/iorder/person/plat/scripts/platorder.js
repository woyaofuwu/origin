if (typeof(PlatOrder) == "undefined") {
    window["PlatOrder"] = function () {
    };
    var platOrder = new PlatOrder();
}
(function () {
    $.extend(PlatOrder.prototype, {
        afterSubmitSerialNumber: function (data) {
            ...
            if((href.indexOf("isHot")>-1 || href.indexOf("isRec")>-1) && href.indexOf("offerCode")>-1) {
                var startIndex = href.indexOf("offerCode")+10;
                var endIndex = href.length;
                var serviceId = href.substr(startIndex,endIndex);
