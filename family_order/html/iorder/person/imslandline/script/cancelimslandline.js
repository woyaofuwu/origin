(function($){
	$.extend($.BmFrame,{
		initPage:function()
		{
//			window["CancelTradeTable"] = new Wade.Table("CancelTradeTable", {
//				fixedMode:true
//			});
        },
        queryTradeInfo:function(aColName,aId){
        	...
        	popupPage("基本信息","imslandline.TradeFrameNew","queryTradeInfo",params,"iorder","c_popup c_popup-half  c_popup-half-hasBg",null,null);
        },
 	    refreshTable:function(){
//  		$("#CancelTradeTable tbody").html("");
