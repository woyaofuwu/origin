...
//			console.info(data);
//			console.info("error：" + errorSet);
//			console.info("confirm：" + confirmSet);
//			console.info("warn：" + warnSet);
			//错误提示
