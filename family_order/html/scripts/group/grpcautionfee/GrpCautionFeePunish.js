...
function queryGrpCustInfo(){
	...
	$.ajax.submit('AddDelPart', 'getGrpCustInfos', null, 'grpcustRefreshPart,fuckYidongPart', 
	function(data){
		$.endPageLoading();
	},
...
function clearGrpCautionFee()
{
	...
	$("#fuck_DEPOSIT_FEE").html('');
	$("#fuck_DEPOSIT_TYPE").html('');
	$("#fuck_STAFF_ID").html('');
	$("#fuck_INSERT_TIME").html('');
}
