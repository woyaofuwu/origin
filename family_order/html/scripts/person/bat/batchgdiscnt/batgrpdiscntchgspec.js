if(typeof(BatGrpDiscntChgSpec)=="undefined"){
	window["BatGrpDiscntChgSpec"]=function(){
		
	};
	var batgrpdiscntchgspec = new BatGrpDiscntChgSpec();
}

(function(){
	$.extend(BatGrpDiscntChgSpec.prototype,{
