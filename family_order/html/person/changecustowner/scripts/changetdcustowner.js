...
function refreshPartAtferAuth(data)
{
	...
	$.ajax.submit('', 'queryUserBuisInfo', param, 'OldInfoPart,UserDiscntInfoPart,UserSvcInfoPart,HiddenPart,newCustPart,newAcctPart', function(callBackData){
