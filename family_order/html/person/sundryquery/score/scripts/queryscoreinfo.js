...
function getCommInfo()
{
	...
	{
		$.ajax.submit('QueryNumberPart', 'getCommInfo', null, 'QueryCommInfoPart,HintPart,refreshArea,refreshArea2,refreshArea3,refreshArea4', function(){
