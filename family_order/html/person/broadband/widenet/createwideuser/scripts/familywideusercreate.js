			...
			changeIMSSaleActive :function ()
			{
				...
				if (null != imsSaleActiveId && '' != imsSaleActiveId)
				{
					if (null != IMS_SALE_ACTIVE_LIST)
					{
						...
						{
							if (imsSaleActiveId == IMS_SALE_ACTIVE_LIST.items[i].get('PARA_CODE5'))
							{
								imsSaleActiveProductId = IMS_SALE_ACTIVE_LIST.items[i].get("PARA_CODE4");
							}
						}
					}
