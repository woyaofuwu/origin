...
function queryUncheckInfos() {
    ...
    $.ajax.submit('QueryCondPart', 'queryUncheckInfos', null, 'MonitorInfoPart,TipInfoPart', function(data){
		$.endPageLoading();
	},
...
function checkMonitorInfo() {
	...
	$.ajax.submit("QueryCondPart", "checkMonitorInfo", param, "MonitorInfoPart", function (data) {
		$.endPageLoading();
		$.showSucMessage("审核成功!");
	}, function (error_code, error_info, detail) {
		$.endPageLoading();
