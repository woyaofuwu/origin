...
function queryWhiteInfos() {
    ...
    $.ajax.submit('QueryCondPart', 'queryWhiteInfos', null, 'MonitorInfoPart', function(data){
		$.endPageLoading();
...
function delWhiteUser() {
	...
	var param = "&SERIAL_NUMBER_LIST=" + values;
	
	$.beginPageLoading("业务受理中..");
    $.ajax.submit('QueryCondPart', 'delWhiteUser', param, 'MonitorInfoPart', function(data){
		$.endPageLoading();
	},
	function(error_code,error_info,detail){
		$.endPageLoading();
