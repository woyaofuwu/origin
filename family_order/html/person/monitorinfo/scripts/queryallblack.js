...
function queryBlackInfos() {
    ...
    $.ajax.submit('QueryCondPart', 'queryBlackInfos', null, 'MonitorInfoPart', function(data){
		$.endPageLoading();
...
function delBlackUser() {
    ...
    $.ajax.submit('QueryCondPart', 'delBlackUser', param, 'MonitorInfoPart', function(data){
		$.endPageLoading();
	},
	function(error_code,error_info,detail){
		$.endPageLoading();
