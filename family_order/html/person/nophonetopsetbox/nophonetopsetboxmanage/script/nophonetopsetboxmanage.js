...
function checkTerminal(){
	...
	$.ajax.submit('topSetBoxInfoPart', 'checkTerminal', "&SERIAL_NUMBER=" + serialNumber, 'terminalPart',
			function(data) {
				$.endPageLoading();
			}, function(error_code, error_info, derror) {
				$.endPageLoading();
